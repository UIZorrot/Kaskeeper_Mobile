...
/* harmony export */ });
/* unused harmony exports prepare_eth_payload, sign_eth_payload, send_kaspa_with_dapp_evm_payload */
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36212);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21321);
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19706);
...
async function sign_eth_payload(unsignedTx, privateKey) {
  try {
    // 验证私钥
    ...
    // 签名交易
    const signedTx = await wallet.signTransaction(unsignedTx);
    const signedTxBytes = ethers.getBytes(signedTx); // 转换为字节数组
...
async function send_kaspa_with_dapp_evm_payload(ethPayload, networkId, privateKeyArg, kaspaAddress, priorityFeeValue) {
  try {
    // 2. 构造 Kaspa 交易
    ...
    await RPC.disconnect();
    await RPC.connect();
    const privateKey = new PrivateKey(privateKeyArg.replace('0x', '')); // 去掉 0x
    const publicKey = privateKey.toPublicKey();
    const address = publicKey.toAddress(networkId);
    let kaspaToAddr;
    try {
      kaspaToAddr = new Address(kaspaAddress);
    } catch {
      throw new Error('Invalid Kaspa recipient address');
    }
    const {
...
// UNUSED EXPORTS: abs, bigIntMulDiv, bigIntMulDiv2, bigintCeilDiv, ceilDiv, div, ellipsisOverflowedText, floorDiv, formatDate, formatDecimalPlaces, getOriginName, getUITypeName, hashCode, hex2Text, isApp, isEqualTo, isGreaterThanOrEqual, isLessThan, isLessThanOrEqualTo, isNegative, isPositive, isZero, minBigint, minus, mod, mulDiv, neg, plus, rest_api_url, solveQuadraticEquation, toDecimalPlaces, useHover, useSelectOption
...
function AccountContextProvider(_ref) {
  ...
  const fetchKrc20Tokens = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(async () => {
    ...
    setKrc20Tokens((_jsonData$result = jsonData.result) === null || _jsonData$result === void 0 ? void 0 : _jsonData$result.map(item => ({
      ...item,
      isToken: true
    })));
    setLoading(false);
  ...
  }, [krc20Tokens, loading, handleActiveToken]);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(AccountContext.Provider, {
    value: value,
    children: children
  });
}
...
function Header(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
      className: "flex justify-between items-center p-4 space-x-2",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
        className: "space-x-2",
        children: [LeftComponent, onBack && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
          onClick: e => {
            onBack();
          },
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Icon__WEBPACK_IMPORTED_MODULE_2__/* .Icon */ .I, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_ant_design_icons__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
              style: {
                fontSize: 16,
                color: '#0A2463'
              }
...
/* harmony import */ var _background_krc20_l2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3146);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_background_krc20_l2__WEBPACK_IMPORTED_MODULE_1__]);
_background_krc20_l2__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function useCurrentKeyring() {
  ...
  const keyringsState = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.cloneDeep)(originalKeyringsState);
  keyringsState.current.accounts.forEach(async item => {
    const privateKey = await wallet.getPrivateKeyAny(item);
    const result = await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_1__/* .eth_address */ .Zt)(`0x${privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex}`);
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(19706);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_keyrings_hooks__WEBPACK_IMPORTED_MODULE_4__, _background_krc20_l2__WEBPACK_IMPORTED_MODULE_8__]);
([_keyrings_hooks__WEBPACK_IMPORTED_MODULE_4__, _background_krc20_l2__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function useAccountAddressL2() {
  const currentAccount = useCurrentAccount();
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .useWallet */ .vT)();
  const [addressL2, setAddressL2] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
const AUTO_LOCK_TIMEOUT = 5 * 60 * 1000; // 5分钟，单位毫秒
...
// EXTERNAL MODULE: ./src/background/service/index.ts + 17 modules
var service = __webpack_require__(24924);
// EXTERNAL MODULE: ./src/shared/constant/index.ts
var constant = __webpack_require__(77093);
// EXTERNAL MODULE: ./src/shared/types.ts
var types = __webpack_require__(59577);
...
class WalletController extends base {
  constructor() {
    ...
    this.createKeyringWithPrivateKey = async (data, addressType, alianName) => {
      ...
      const keyring = this.displayedKeyringToWalletKeyring(displayedKeyring, service/* keyringService */.zn.keyrings.length - 1);
    ...
    this.createKeyringWithMnemonics = async function (mnemonic, hdPath, passphrase, addressType, activeIndexes) {
      ...
      const displayedKeyring = await service/* keyringService */.zn.displayForKeyring(originKeyring, addressType, service/* keyringService */.zn.keyrings.length - 1);
      const keyring = _this.displayedKeyringToWalletKeyring(displayedKeyring, service/* keyringService */.zn.keyrings.length - 1);
    ...
    this.createTmpKeyringWithMnemonics = async function (mnemonic, hdPath, passphrase, addressType) {
      ...
      return _this.displayedKeyringToWalletKeyring(displayedKeyring, -1, false);
    };
    ...
    this.displayedKeyringToWalletKeyring = function (displayedKeyring, index) {
...
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24924);
...
const CreateHDWalletScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(1527), __webpack_require__.e(7669), __webpack_require__.e(6137), __webpack_require__.e(903), __webpack_require__.e(170)]).then(__webpack_require__.bind(__webpack_require__, 84841)));
...
const ApprovalScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(1207), __webpack_require__.e(2711), __webpack_require__.e(7459), __webpack_require__.e(497), __webpack_require__.e(1043), __webpack_require__.e(7579), __webpack_require__.e(8458)]).then(__webpack_require__.bind(__webpack_require__, 9965)));
...
const ActivitiesScrren = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(3099), __webpack_require__.e(4504), __webpack_require__.e(3238)]).then(__webpack_require__.bind(__webpack_require__, 73238)));
...
const WalletTabScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1527), __webpack_require__.e(1207), __webpack_require__.e(7459), __webpack_require__.e(3784), __webpack_require__.e(8567)]).then(__webpack_require__.bind(__webpack_require__, 4784)));
...
const ChangePasswordScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(7669), __webpack_require__.e(2685)]).then(__webpack_require__.bind(__webpack_require__, 12685)));
...
const ExportMnemonicsScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(1527), __webpack_require__.e(6137), __webpack_require__.e(4673)]).then(__webpack_require__.bind(__webpack_require__, 24673)));
const ExportPrivateKeyScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(1527), __webpack_require__.e(6137), __webpack_require__.e(8466)]).then(__webpack_require__.bind(__webpack_require__, 98466)));
...
const ToolScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(1217), __webpack_require__.e(3586)]).then(__webpack_require__.bind(__webpack_require__, 83586)));
const ActivityTab = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(3099), __webpack_require__.e(4504), __webpack_require__.e(4283)]).then(__webpack_require__.bind(__webpack_require__, 34283)));
const SelectToken = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(1527), __webpack_require__.e(2384)]).then(__webpack_require__.bind(__webpack_require__, 52384)));
const DeployScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(1817), __webpack_require__.e(1043), __webpack_require__.e(7761)]).then(__webpack_require__.bind(__webpack_require__, 97761)));
const MintScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(877), __webpack_require__.e(1043), __webpack_require__.e(6868)]).then(__webpack_require__.bind(__webpack_require__, 36868)));
const TokenScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(3099), __webpack_require__.e(5925)]).then(__webpack_require__.bind(__webpack_require__, 45925)));
const UTXOTab = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4504), __webpack_require__.e(1217), __webpack_require__.e(4996)]).then(__webpack_require__.bind(__webpack_require__, 24996)));
...
const TxConfirmScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(1207), __webpack_require__.e(2711), __webpack_require__.e(7459), __webpack_require__.e(497), __webpack_require__.e(1043), __webpack_require__.e(7579), __webpack_require__.e(7627)]).then(__webpack_require__.bind(__webpack_require__, 84536)));
const TxCreateScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1527), __webpack_require__.e(1207), __webpack_require__.e(2711), __webpack_require__.e(7036), __webpack_require__.e(1043), __webpack_require__.e(5152)]).then(__webpack_require__.bind(__webpack_require__, 36946)));
...
function useNavigate() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((routKey, state) => {
...
/******/ __webpack_require__.O(0, [9198], () => (__webpack_exec__(60369)));
