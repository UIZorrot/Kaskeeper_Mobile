...
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(21952);
/* harmony import */ var kaspa_wasm__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(45989);
...
function TxSuccessScreen() {
  ...
  const inputAmount = (0,react__WEBPACK_IMPORTED_MODULE_6__.useMemo)(() => {
    if (!rawtx.amountSompi) {
      const result = JSON.parse(rawtx);
      const inputAmountSompi = result.amountSompi;
      return (0,_ui_utils__WEBPACK_IMPORTED_MODULE_5__/* .sompiToAmount */ ._m)(inputAmountSompi);
    } else {
      return (0,_ui_utils__WEBPACK_IMPORTED_MODULE_5__/* .sompiToAmount */ ._m)(rawtx.amountSompi);
    }
  }, []);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Layout */ .PE, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Content */ .UC, {
      style: {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Column */ .VP, {
        ...
        mt: "xxl",
        gap: "xl",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Row */ .fI, {
          justifyCenter: true,
          mt: "xxl",
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Column */ .VP, {
        justifyCenter: true,
        mt: "md",
        gap: "xl",
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Footer */ .wi, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Row */ .fI, {
        ...
        onClick: () => {
          const result = JSON.parse(rawtx);
          if (result && result.relayer === 'L2') {
            const baseUrlL2 = network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_11__.NetworkType.Mainnet ? `${_shared_constant__WEBPACK_IMPORTED_MODULE_8__/* .OPENAPI_URL_MAINNET_L2 */ .Zm}/tx/${txid}` : `${_shared_constant__WEBPACK_IMPORTED_MODULE_8__/* .OPENAPI_URL_TESTNET_L2 */ .YL}/tx/${txid}`;
            window.open(baseUrlL2, '_blank');
          } else {
            if (network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_11__.NetworkType.Mainnet) {
              window.open(`${blockstreamUrl}/transaction/${txid}`);
            } else {
              window.open(`https://explorer-tn10.kaspa.org/txs/${txid}`);
            }
          }
        },
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_0__/* .Button */ .$n, {
