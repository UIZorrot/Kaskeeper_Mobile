...
/* harmony import */ var _mui_icons_material_CheckCircleOutline__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(83603);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(76660);
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(37656);
/* harmony import */ var _mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(75776);
/* harmony import */ var _mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(87136);
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(92792);
/* harmony import */ var _mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(70884);
...
/* harmony import */ var formik__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(96522);
...
/* harmony import */ var _ui_context_RPCStatus__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(20084);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(2488);
...
const StyledButton = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .cp)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Button */ .q)(_ref => {
  let {
    theme
  } = _ref;
  return {
...
function Deploy() {
  ...
  const handleDeploy = async () => {
    ...
    const networkName = currentNetworkType === kaspa_wasm__WEBPACK_IMPORTED_MODULE_19__.NetworkType.Mainnet ? 'mainnet' : currentNetworkType === kaspa_wasm__WEBPACK_IMPORTED_MODULE_19__.NetworkType.Testnet ? 'testnet-10' : 'devnet';
    let result;
    if (isIssue) {
  ...
  const {
    ...
    errors,
    handleSubmit
  } = (0,formik__WEBPACK_IMPORTED_MODULE_20__/* .useFormik */ .KO)({
    initialValues: {
      ticker: '',
      maxSupply: 100000000,
      decimals: 8,
  ...
  const {
    rpcConnectStatus
  } = (0,_ui_context_RPCStatus__WEBPACK_IMPORTED_MODULE_16__/* .useRPCStatusContext */ .U)();
  const checkTickerValid = (0,react__WEBPACK_IMPORTED_MODULE_14__.useCallback)(async () => {
    ...
    try {
      ...
      let result;
      if (currentNetworkType == kaspa_wasm__WEBPACK_IMPORTED_MODULE_19__.NetworkType.Mainnet) {
      ...
      console.log('checkTickerValid error', error);
    } finally {
      setLoading(false);
    }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ ._W, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Header */ .ek, {
      title: "Deploy Krc20",
      onBack: () => navigate('ToolScreen', null, true),
      parentName: "ToolScreen",
      RightComponent: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .NodeStatus */ .s9, {})
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Content */ .kP, {
      classname: "!px-0 !pb-4",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .c, {
        className: "space-y-4 !px-4 flex-1 !overflow-y-auto",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
          variant: "body2",
          color: "textSecondary",
          children: "It takes 1 KAS as commission and 1000 KAS as gasfee to deploy."
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .c, {
          className: "space-y-1",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            children: isIssue ? 'Name' : 'Ticker'
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .c, {
            type: "text",
            name: "ticker",
            ...
            onBlur: handleBlur,
            endAdornment: tickerValid ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_icons_material_CheckCircleOutline__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .c, {
              color: "primary"
            }) : loading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .c, {
              color: "primary",
              size: 20
            }) : 'Deployed',
            error: !rpcConnectStatus || Boolean(values.ticker && !tickerValid || errors.ticker)
          }), rpcConnectStatus ? errors.ticker ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
            children: errors.ticker
          }) : null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
          ...
          }), errors.maxSupply ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
          ...
          }), errors.decimals ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
          ...
          }), errors.perMint ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
          ...
          }), errors.preMintAmount ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            children: "Issue Mode: "
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_26__/* ["default"] */ .c, {
            value: isIssue,
          ...
          }), errors.fee ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
            color: "error.main",
            className: "pl-0",
            children: errors.fee
          }) : null]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .c, {
          className: "!mt-1",
        ...
        size: "medium",
        className: "!mx-4",
        disabled: !rpcConnectStatus || disabled || sending,
        onClick: () => handleSubmit(),
        endIcon: sending ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .c, {
          size: 20,
          color: "inherit"
        }) : null,
        children: btnText
...
const validationSchema = yup__WEBPACK_IMPORTED_MODULE_15__/* .object */ .kt({
  ticker: yup__WEBPACK_IMPORTED_MODULE_15__/* .string */ .Qb().min(4, 'Min length 4').max(6, 'max 6').required('Need Ticker name'),
