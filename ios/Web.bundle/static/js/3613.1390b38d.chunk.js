...
/* harmony import */ var antd_lib_spin__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(96383);
...
/* harmony import */ var _mui_icons_material_ErrorOutline__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(16317);
/* harmony import */ var _mui_icons_material_OpenInNew__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(98818);
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(8239);
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(87164);
/* harmony import */ var kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(45989);
...
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(13108);
...
const StyledButton = (0,_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Ay)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Button */ .$n)(_ref => {
  let {
    theme
  } = _ref;
  return {
...
// 自定义卡片样式
const StyledCard = (0,_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Ay)(_mui_material__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .A)(_ref2 => {
  let {
    theme
  } = _ref2;
  return {
...
const EmptyState = _ref3 => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .A, {
    sx: {
      display: 'flex',
      flexDirection: 'column',
      alignItems: 'center',
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_icons_material_ErrorOutline__WEBPACK_IMPORTED_MODULE_20__/* ["default"] */ .A, {
      sx: {
        fontSize: 48,
        color: '#C0C7D8',
        mb: 2
      }
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, {
      sx: {
        fontWeight: 500,
        mb: 2,
        color: '#0A2463',
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Button */ .$n, {
      variant: "outlined",
      color: "primary",
      size: "small",
      onClick: () => refresh(),
...
function ActivitiesScrren() {
  ...
  const getL2TokenList = (0,react__WEBPACK_IMPORTED_MODULE_8__.useCallback)(async () => {
    ...
    try {
      if (!addressL2) return;
      const baseUrl = network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__.NetworkType.Mainnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_MAINNET_L2 */ .Zm : network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__.NetworkType.Testnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_TESTNET_L2 */ .YL : _shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_DEVNET_L2 */ .B9;
  ...
  const handleClick = () => {
    ...
    const baseUrl = network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__.NetworkType.Mainnet ? `https://kas.fyi/addresses/${address}?page=1` : `https://explorer-tn10.kaspa.org/addresses/${address}?page=1`;
    const baseUrlL2 = network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__.NetworkType.Mainnet ? `${_shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_MAINNET_L2 */ .Zm}/address/${addressL2}` : `${_shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_TESTNET_L2 */ .YL}/address/${addressL2}`;
    const url = activeKey === 'l2Token' ? baseUrlL2 : baseUrl;
    (0,_ui_utils__WEBPACK_IMPORTED_MODULE_15__/* .openUrlLink */ .aj)(url, '_blank');
  };
  ...
  const handleCardClick = (type, txid) => {
    ...
    let url = '';
    if (type === 'l1') {
      url = network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__.NetworkType.Mainnet ? `https://kas.fyi/transaction/${txid}` : `https://explorer-tn10.kaspa.org/txs/${txid}`;
    } else {
      url = network === kaspa_wasm__WEBPACK_IMPORTED_MODULE_22__.NetworkType.Mainnet ? `${_shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_MAINNET_L2 */ .Zm}/tx/${txid}` : `${_shared_constant__WEBPACK_IMPORTED_MODULE_13__/* .OPENAPI_URL_TESTNET_L2 */ .YL}/tx/${txid}`;
    }
    (0,_ui_utils__WEBPACK_IMPORTED_MODULE_15__/* .openUrlLink */ .aj)(url, '_blank');
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Layout */ .PE, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Header */ .Y9, {
      onBack: () => navigate('MainScreen'),
      title: "Activities"
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ui_components_TabPaper__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, {
      tabs: tabsItem,
      activeKey: activeKey,
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_ui_components_Styled_Content__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A, {
      className: "flex-1 overflow-y-auto !py-0 !mt-4",
      children: [currentLayer === 'L1' && activeKey === 'native' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(antd_lib_spin__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, {
        spinning: loading,
        children: fetchListData.length ? fetchListData.map((item, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(StyledCard, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .A, {
            sx: {
              padding: 2,
              paddingBottom: 0,
              paddingLeft: '10px'
            },
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .A, {
              display: "flex",
              alignItems: "center",
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .A, {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("img", {
                  ...
                  height: 18,
                  alt: ""
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .A, {
                  style: {
                    marginLeft: '12px'
                  },
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, {
                    sx: {
                      fontSize: '14px',
                      fontWeight: 500,
                      color: '#0A2463'
                ...
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, {
                  variant: "body2",
                  sx: {
                    fontSize: '0.8rem',
                    color: 'rgba(10, 36, 99, 0.65)',
        ...
        }, index)) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .A, {
          sx: {
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
      ...
      }), currentLayer === 'L2' && activeKey === 'native' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(antd_lib_spin__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, {
        spinning: loading,
        children: l2NativeActivites.length ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .Ay, {
          container: true,
          spacing: 2.5,
          children: l2NativeActivites.map((item, index) => {
            var _item$from, _item$from2;
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .Ay, {
              item: true,
              xs: 12,
              style: {
                paddingTop: '12px'
        ...
        }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .A, {
          sx: {
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
      ...
      }), currentLayer === 'L1' && activeKey === 'krc20' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(antd_lib_spin__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, {
        spinning: krc20Loading,
        children: krc20List.length ? krc20List.map((item, index) => {
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ui_components_Styled_Krc20Item__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .A, {
            item: item
          }, index);
        })
      ...
      }), currentLayer === 'L2' && activeKey === 'l2Token' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(antd_lib_spin__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, {
        spinning: loading,
        children: erc20List.length ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .Ay, {
          container: true,
          spacing: 2.5,
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(StyledButton, {
        ...
        variant: "contained",
        size: "medium",
        endIcon: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_mui_icons_material_OpenInNew__WEBPACK_IMPORTED_MODULE_26__/* ["default"] */ .A, {
          sx: {
            color: '#222'
          }
        }),
