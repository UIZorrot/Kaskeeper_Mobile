...
function ChooseToke() {
  ...
  const tokens = [nativeTokenItem, ...(currentLayer === 'L2' ? [] : krc20Tokens)];
  const filteredTokens = (0,react__WEBPACK_IMPORTED_MODULE_7__.useMemo)(() => {
    ...
    if (!lowerCaseKeyword) {
      ...
      return tokens.filter(item => {
        var _item$tick, _item$name;
        return (item === null || item === void 0 ? void 0 : (_item$tick = item.tick) === null || _item$tick === void 0 ? void 0 : _item$tick.toLowerCase().includes(lowerCaseKeyword)) || (item === null || item === void 0 ? void 0 : (_item$name = item.name) === null || _item$name === void 0 ? void 0 : _item$name.toLowerCase().includes(lowerCaseKeyword));
      });
    }
  }, [tokens, keyword]);
