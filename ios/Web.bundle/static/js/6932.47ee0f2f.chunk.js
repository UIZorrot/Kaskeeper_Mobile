"use strict";
(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[6932],{
...
var _rcDrawer = _interopRequireDefault(__webpack_require__(46052));
...
// EXTERNAL MODULE: ./node_modules/.pnpm/rc-util@5.38.1_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-util/es/Dom/canUseDom.js
var Dom_canUseDom = __webpack_require__(31175);
...
var es_warning = __webpack_require__(75808);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/Context.js

var OrderContext = /*#__PURE__*/react.createContext(null);
/* harmony default export */ const Context = (OrderContext);
// EXTERNAL MODULE: ./node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js
var arrayLikeToArray = __webpack_require__(20160);
;// CONCATENATED MODULE: ./node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/arrayWithoutHoles.js

function _arrayWithoutHoles(r) {
  if (Array.isArray(r)) return (0,arrayLikeToArray/* default */.c)(r);
}

;// CONCATENATED MODULE: ./node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/iterableToArray.js
function _iterableToArray(r) {
  if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r);
}

// EXTERNAL MODULE: ./node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/unsupportedIterableToArray.js
var unsupportedIterableToArray = __webpack_require__(65824);
;// CONCATENATED MODULE: ./node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/nonIterableSpread.js
function _nonIterableSpread() {
  throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
}

;// CONCATENATED MODULE: ./node_modules/.pnpm/@babel+runtime@7.26.0/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js




function _toConsumableArray(r) {
  return _arrayWithoutHoles(r) || _iterableToArray(r) || (0,unsupportedIterableToArray/* default */.c)(r) || _nonIterableSpread();
}
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/useDom.js
...
function useDom(render, debug) {
  var _React$useState = react.useState(function () {
    ...
    _React$useState2 = (0,esm_slicedToArray/* default */.c)(_React$useState, 1),
  ...
  var _React$useState3 = react.useState(EMPTY_LIST),
    _React$useState4 = (0,esm_slicedToArray/* default */.c)(_React$useState3, 2),
...
// EXTERNAL MODULE: ./node_modules/.pnpm/rc-util@5.38.1_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-util/es/Dom/dynamicCSS.js
var dynamicCSS = __webpack_require__(63936);
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-util@5.38.1_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-util/es/getScrollBarSize.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/util.js
/**
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/useScrollLocker.js
...
function useScrollLocker(lock) {
  ...
  (0,useLayoutEffect/* default */.c)(function () {
    if (mergedLock) {
      ...
      (0,dynamicCSS/* updateCSS */.sr)("\nhtml body {\n  overflow-y: hidden;\n  ".concat(isOverflow ? "width: calc(100% - ".concat(scrollbarSize, "px);") : '', "\n}"), id);
    } else {
      (0,dynamicCSS/* removeCSS */.m8)(id);
    }
    return function () {
      (0,dynamicCSS/* removeCSS */.m8)(id);
    };
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/mock.js
var inline = false;
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/Portal.js
...
var getPortalContainer = function getPortalContainer(getContainer) {
  ...
  if (!(0,Dom_canUseDom/* default */.c)() || !getContainer) {
    return null;
  }
...
var Portal = /*#__PURE__*/react.forwardRef(function (props, ref) {
  ...
  var _useDom = useDom(mergedRender && !innerContainer, debug),
    _useDom2 = (0,esm_slicedToArray/* default */.c)(_useDom, 2),
    defaultContainer = _useDom2[0],
    queueCreate = _useDom2[1];
  var mergedContainer = innerContainer !== null && innerContainer !== void 0 ? innerContainer : defaultContainer;

  // ========================= Locker ==========================
  useScrollLocker(autoLock && open && (0,Dom_canUseDom/* default */.c)() && (mergedContainer === defaultContainer || mergedContainer === document.body));

  // =========================== Ref ===========================
  var childRef = null;
  if (children && (0,es_ref/* supportRef */.QD)(children) && ref) {
    var _ref = children;
    childRef = _ref.ref;
  }
  var mergedRef = (0,es_ref/* useComposeRef */.BG)(childRef, ref);

  // ========================= Render ==========================
  // Do not render when nothing need render
  // When innerContainer is `undefined`, it may not ready since user use ref in the same render
  if (!mergedRender || !(0,Dom_canUseDom/* default */.c)() || innerContainer === undefined) {
    return null;
  }
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@rc-component+portal@1.1.2_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@rc-component/portal/es/index.js
...
var rc_motion_es = __webpack_require__(16692);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-util@5.38.1_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-util/es/pickAttrs.js
...
function pickAttrs(props) {
  ...
  if (ariaOnly === false) {
    ...
    mergedConfig = (0,objectSpread2/* default */.c)({}, ariaOnly);
  }
  var attrs = {};
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-drawer@6.3.0_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-drawer/es/context.js

var DrawerContext = /*#__PURE__*/react.createContext(null);
/* harmony default export */ const context = (DrawerContext);
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-drawer@6.3.0_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-drawer/es/DrawerPanel.js
...
var DrawerPanel = function DrawerPanel(props) {
  ...
  // =============================== Render ===============================
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", (0,esm_extends/* default */.c)({
    id: id,
    className: classnames_default()("".concat(prefixCls, "-content"), className),
    style: (0,objectSpread2/* default */.c)({}, style),
    "aria-modal": "true",
    role: "dialog",
    ref: containerRef
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-drawer@6.3.0_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-drawer/es/util.js


function parseWidthHeight(value) {
  if (typeof value === 'string' && String(Number(value)) === value) {
    (0,es_warning/* default */.cp)(false, 'Invalid value type of `width` or `height` which should be number type instead.');
    return Number(value);
  }
  return value;
}
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-drawer@6.3.0_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-drawer/es/DrawerPopup.js
...
function DrawerPopup(props, ref) {
  ...
  var onPanelKeyDown = function onPanelKeyDown(event) {
    ...
    switch (keyCode) {
      // Tab active
      case KeyCode/* default */.c.TAB:
        {
          if (keyCode === KeyCode/* default */.c.TAB) {
  ...
  // ============================ Mask ============================
  var maskNode = mask && /*#__PURE__*/react.createElement(rc_motion_es["default"], (0,esm_extends/* default */.c)({
    key: "mask"
  }, maskMotion, {
    visible: open
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      style: (0,objectSpread2/* default */.c)((0,objectSpread2/* default */.c)({}, motionMaskStyle), maskStyle),
  ...
  var panelNode = /*#__PURE__*/react.createElement(rc_motion_es["default"], (0,esm_extends/* default */.c)({
    key: "panel"
  }, motionProps, {
    visible: open,
    ...
    return /*#__PURE__*/react.createElement("div", (0,esm_extends/* default */.c)({
      ...
      style: (0,objectSpread2/* default */.c)((0,objectSpread2/* default */.c)((0,objectSpread2/* default */.c)({}, wrapperStyle), motionStyle), contentWrapperStyle)
    }, pickAttrs(props, {
      data: true
    })), /*#__PURE__*/react.createElement(es_DrawerPanel, (0,esm_extends/* default */.c)({
      id: id,
  ...
  // =========================== Render ===========================
  var containerStyle = (0,objectSpread2/* default */.c)({}, rootStyle);
  if (zIndex) {
  ...
  return /*#__PURE__*/react.createElement(context.Provider, {
    ...
    className: classnames_default()(prefixCls, "".concat(prefixCls, "-").concat(placement), rootClassName, (_classNames = {}, (0,defineProperty/* default */.c)(_classNames, "".concat(prefixCls, "-open"), open), (0,defineProperty/* default */.c)(_classNames, "".concat(prefixCls, "-inline"), inline), _classNames)),
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-drawer@6.3.0_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-drawer/es/Drawer.js
...
var Drawer = function Drawer(props) {
  ...
  var drawerPopupProps = (0,objectSpread2/* default */.c)((0,objectSpread2/* default */.c)({}, props), {}, {
    open: mergedOpen,
    prefixCls: prefixCls,
    placement: placement,
    autoFocus: autoFocus,
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/rc-drawer@6.3.0_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/rc-drawer/es/index.js
