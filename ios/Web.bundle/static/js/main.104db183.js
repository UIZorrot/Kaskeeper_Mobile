...
/* harmony export */   Zt: () => (/* reexport safe */ _L2Ethers__WEBPACK_IMPORTED_MODULE_7__.Zt),
/* harmony export */   sg: () => (/* binding */ send_kaspa_with_dapp_payload),
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41442);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(99770);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(95642);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(82083);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(22724);
/* harmony import */ var kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45989);
/* harmony import */ var _L2Ethers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(67623);
...
async function prepare_eth_payload(privateKey, toAddress, amountEth) {
  try {
    ...
    // 验证接收地址
    if (!ethers__WEBPACK_IMPORTED_MODULE_2__/* .isAddress */ .PW(toAddress)) {
      throw new Error('Invalid recipient address');
    }

    // 验证金额
    const amount = ethers__WEBPACK_IMPORTED_MODULE_3__/* .parseEther */ .g5(amountEth);
    if (amount <= 0n) {
      throw new Error('Amount must be greater than 0');
    }

    // 创建 provider 和 wallet
    const provider = new ethers__WEBPACK_IMPORTED_MODULE_4__/* .JsonRpcProvider */ .FR(rpcUrl);
    const wallet = new ethers__WEBPACK_IMPORTED_MODULE_5__/* .Wallet */ .u(privateKey, provider);
...
async function send_eth_transaction(toAddress, amountInEther, privateKey) {
  try {
    ...
    if (!ethers__WEBPACK_IMPORTED_MODULE_2__/* .isAddress */ .PW(wallet.address)) {
      throw new Error('Invalid from address');
    }

    // Convert amount to wei
    const amount = ethers__WEBPACK_IMPORTED_MODULE_3__/* .parseEther */ .g5(amountInEther);
  ...
  try {
    ...
    console.log({
      ...
      outputs: [{
        ...
        amount: (0,kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.kaspaToSompi)(amount)
      }],
      priorityFee: (0,kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.kaspaToSompi)(priorityFeeValue.toString()),
      changeAddress: address.toString(),
      networkId,
...
async function prepare_eth_erc20_payload(privateKey, tokenContractAddress, toAddress, amount) {
  try {
    ...
    // 验证代币合约地址
    if (!ethers__WEBPACK_IMPORTED_MODULE_2__/* .isAddress */ .PW(tokenContractAddress)) {
      throw new Error('Invalid token contract address');
    }

    // 验证金额
    const amountBigInt = ethers__WEBPACK_IMPORTED_MODULE_3__/* .parseUnits */ .XS(amount, 18); // 假设代币精度为18，可动态获取
    if (amountBigInt <= 0n) {
      throw new Error('Amount must be greater than 0');
    }
    ...
    const tokenContract = new ethers__WEBPACK_IMPORTED_MODULE_6__/* .Contract */ .NZ(tokenContractAddress, erc20Abi, wallet);
...
async function send_erc20_transaction(toAddress, amountInTokens, privateKey, contractAddress) {
  try {
    ...
    if (!ethers__WEBPACK_IMPORTED_MODULE_2__/* .isAddress */ .PW(contractAddress)) {
    ...
    const contract = new ethers__WEBPACK_IMPORTED_MODULE_6__/* .Contract */ .NZ(contractAddress, erc20Abi, wallet);

    // Get token decimals
    const decimals = await contract.decimals();

    // Convert amount to token units
    const amount = ethers__WEBPACK_IMPORTED_MODULE_3__/* .parseUnits */ .XS(amountInTokens, decimals);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $0: () => (/* binding */ get_kns_list),
...
/* harmony export */   qI: () => (/* binding */ getBalanceByAddress),
...
const get_kns_list = (network, params) => {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(url + '/api/v1/assets', {
    params
  });
};
const getBalanceByAddress = async (network, address) => {
  const temp_url = network === _shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Mainnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_MAINNET */ ._7 + "/addresses/" + address + "/balance" : _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_TESTNET */ .lu + "/addresses/" + address + "/balance";
  return axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(temp_url);
};
...
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(87164);
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(50329);
...
function Header(props) {
  ...
  const CenterComponent = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (children) {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_4__/* .Text */ .EY, {
        text: title,
        preset: "regular-bold",
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
      className: "flex justify-between items-center p-4 space-x-2",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
        className: "space-x-2",
        children: [LeftComponent, onBack && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
          onClick: e => {
            // onBack();
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Icon__WEBPACK_IMPORTED_MODULE_2__/* .Icon */ .I, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_ant_design_icons__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
              style: {
                fontSize: 16,
                color: '#0A2463'
              }
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Row__WEBPACK_IMPORTED_MODULE_3__/* .Row */ .f, {
        itemsCenter: true,
        children: CenterComponent
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Row__WEBPACK_IMPORTED_MODULE_3__/* .Row */ .f, {
        full: true,
        justifyEnd: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Column__WEBPACK_IMPORTED_MODULE_1__/* .Column */ .V, {
...
/* harmony import */ var _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(71120);
...
/* harmony export */ });
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36212);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82083);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31191);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41442);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(77649);
...
function eth_address(privateKeyArg) {
  try {
    ...
    // 验证私钥格式（必须是64个字符的十六进制字符串，以0x开头）
    if (!ethers__WEBPACK_IMPORTED_MODULE_0__/* .isHexString */ .Lo(privateKeyArg) || privateKeyArg.length !== 66) {
      throw new Error('Invalid private key format. Must be 64 characters hex string starting with 0x');
    }

    // 创建钱包实例
    const wallet = new ethers__WEBPACK_IMPORTED_MODULE_1__/* .Wallet */ .u(privateKeyArg);

    // 如果需要公钥，可以通过 SigningKey 计算
    const signingKey = new ethers__WEBPACK_IMPORTED_MODULE_2__/* .SigningKey */ .h(privateKeyArg);
    const publicKey = signingKey.publicKey;
    return {
      privateKey: wallet.privateKey,
      address: wallet.address,
...
async function signMessage(message, privateKeyArg) {
  try {
    ...
    // 验证私钥
    if (!ethers__WEBPACK_IMPORTED_MODULE_0__/* .isHexString */ .Lo(`0x${privateKey}`) || privateKey.length !== 64) {
      throw new Error('Invalid private key format. Must be 64 characters hex string starting with 0x');
    }

    // 创建 wallet
    const wallet = new ethers__WEBPACK_IMPORTED_MODULE_1__/* .Wallet */ .u(privateKey);
...
async function verifyMessage(message, signature, expectedAddress) {
  try {
    // 验证签名格式
    if (!ethers__WEBPACK_IMPORTED_MODULE_0__/* .isHexString */ .Lo(signature) || signature.length !== 132) {
      throw new Error('Invalid signature format. Must be 65 bytes hex string (130 characters + 0x)');
    }

    // 验证地址格式
    if (!ethers__WEBPACK_IMPORTED_MODULE_3__/* .isAddress */ .PW(expectedAddress)) {
      throw new Error('Invalid Ethereum address');
    }

    // 恢复签名对应的地址
    const recoveredAddress = ethers__WEBPACK_IMPORTED_MODULE_4__/* .verifyMessage */ .l(message, signature);
...
var service = __webpack_require__(51902);
// EXTERNAL MODULE: ./src/shared/constant/index.ts
var constant = __webpack_require__(77093);
// EXTERNAL MODULE: ./src/shared/types.ts
var types = __webpack_require__(59577);
// EXTERNAL MODULE: ./src/shared/utils/index.ts + 3 modules
var utils = __webpack_require__(17712);
// EXTERNAL MODULE: ./dependency/kaspa-core-dev/kaspa.js
var kaspa = __webpack_require__(45989);
...
var L2Ethers = __webpack_require__(67623);
...
class WalletController extends base {
  constructor() {
    ...
    super(...arguments);
    _this = this;
    this.openapi = service/* openapiService */.at;
    /* wallet */
    this.boot = password => service/* keyringService */.zn.boot(password);
    this.isBooted = () => service/* keyringService */.zn.isBooted();
    this.getApproval = service/* notificationService */.lY.getApproval;
    this.resolveApproval = service/* notificationService */.lY.resolveApproval;
    this.rejectApproval = service/* notificationService */.lY.rejectApproval;
    this.hasVault = async () => service/* keyringService */.zn.hasVault();
    this.verifyPassword = password => service/* keyringService */.zn.verifyPassword(password);
    this.changePassword = (password, newPassword) => service/* keyringService */.zn.changePassword(password, newPassword);
    this.initAlianNames = async () => {
      service/* preferenceService */.t3.changeInitAlianNameStatus();
      const contacts = this.listContact();
      const keyrings = await service/* keyringService */.zn.getAllDisplayedKeyrings();
      keyrings.forEach(v => {
        v.accounts.forEach((w, index) => {
          this.updateAlianName(w.pubkey, `${constant/* BRAND_ALIAN_TYPE_TEXT */.LI[v.type]} ${index + 1}`);
        });
      });
    ...
    this.subscribeUtxosChanged = async () => {
      const currentAccount = service/* preferenceService */.t3.getCurrentAccount();
      if (currentAccount !== null && currentAccount !== void 0 && currentAccount.address) {
        await service/* openapiService */.at.subscribeUtxosChanged(currentAccount.address);
      }
    };
    this.isReady = () => {
      if (service/* contactBookService */.jX.store) {
        return true;
      } else {
        return false;
      }
    ...
    this.unlock = async password => {
      const alianNameInited = service/* preferenceService */.t3.getInitAlianNameStatus();
      const alianNames = service/* contactBookService */.jX.listAlias();
      await service/* keyringService */.zn.submitPassword(password);
      service/* sessionService */.mB.broadcastEvent('unlock');
      if (!alianNameInited && alianNames.length === 0) {
        this.initAlianNames();
      }
    };
    this.isUnlocked = async () => {
      return service/* keyringService */.zn.memStore.getState().isUnlocked;
    };
    this.lockWallet = async () => {
      await service/* keyringService */.zn.setLocked();
      service/* sessionService */.mB.broadcastEvent('accountsChanged', []);
      service/* sessionService */.mB.broadcastEvent('lock');
      this.disconnectRpc();
    };
    this.setPopupOpen = isOpen => {
      service/* preferenceService */.t3.setPopupOpen(isOpen);
    };
    this.getAddressBalance = async address => {
      const data = await service/* openapiService */.at.getAddressBalance(address);
      service/* preferenceService */.t3.updateAddressBalance(address, data);
      return data;
    };
    this.getAddressesBalance = async addresses => {
      const data = await service/* openapiService */.at.getAddressesBalance(addresses);
      for (let i = 0; i < addresses.length; i++) {
        service/* preferenceService */.t3.updateAddressBalance(addresses[i], data[i]);
      }
      return data;
    };
    this.getMultiAddressAssets = async addresses => {
      return service/* openapiService */.at.getMultiAddressAssets(addresses);
    };
    this.findGroupAssets = async groups => {
      const scannedGroup = await service/* openapiService */.at.findGroupAssets(groups);
      return scannedGroup;
    };
    this.getAddressCacheBalance = address => {
      ...
      return service/* preferenceService */.t3.getAddressBalance(address) || defaultBalance;
    };
    // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
    ...
    this.getAddressCacheHistory = address => {
      if (!address) return [];
      return service/* preferenceService */.t3.getAddressHistory(address);
    };
    this.getExternalLinkAck = () => {
      service/* preferenceService */.t3.getExternalLinkAck();
    };
    this.setExternalLinkAck = ack => {
      service/* preferenceService */.t3.setExternalLinkAck(ack);
    };
    this.getLocale = () => {
      return service/* preferenceService */.t3.getLocale();
    };
    this.setLocale = locale => {
      service/* preferenceService */.t3.setLocale(locale);
    };
    this.getCurrency = () => {
      return service/* preferenceService */.t3.getCurrency();
    };
    this.setCurrency = currency => {
      service/* preferenceService */.t3.setCurrency(currency);
    };
    /* keyrings */
    this.clearKeyrings = () => service/* keyringService */.zn.clearKeyrings();
    this.getPrivateKey = async (password, _ref) => {
      ...
      await this.verifyPassword(password);
      const keyring = await service/* keyringService */.zn.getKeyringForAccount(pubkey, type);
    ...
    this.getMnemonics = async (password, keyring) => {
      await this.verifyPassword(password);
      const originKeyring = service/* keyringService */.zn.keyrings[keyring.index];
    ...
    this.createKeyringWithPrivateKey = async (data, addressType, alianName) => {
      ...
      let originKeyring;
      try {
        originKeyring = await service/* keyringService */.zn.importPrivateKey(data, addressType);
      } catch (e) {
        console.log(e);
        throw e;
      }
      ...
      const displayedKeyring = await service/* keyringService */.zn.displayForKeyring(originKeyring, addressType, service/* keyringService */.zn.keyrings.length - 1);
      const keyring = await this.displayedKeyringToWalletKeyring(displayedKeyring, service/* keyringService */.zn.keyrings.length - 1);
      for (const j in keyring.accounts) {
        ...
        const l2Info = await (0,L2Ethers/* eth_address */.Zt)(`0x${privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex}`);
    ...
    this.getPreMnemonics = function () {
      let wordCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 12;
      return service/* keyringService */.zn.getPreMnemonics(wordCount);
    };
    this.generatePreMnemonic = function () {
      let wordCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 12;
      return service/* keyringService */.zn.generatePreMnemonic(wordCount);
    };
    this.removePreMnemonics = () => service/* keyringService */.zn.removePreMnemonics();
    this.createKeyringWithMnemonics = async function (mnemonic, hdPath, passphrase, addressType, activeIndexes) {
      let activeChangeIndexes = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
      const originKeyring = await service/* keyringService */.zn.createKeyringWithMnemonics(mnemonic, hdPath, passphrase, addressType,
      // accountCount,
      // startIndex
      activeIndexes, activeChangeIndexes);
      service/* keyringService */.zn.removePreMnemonics();
      const displayedKeyring = await service/* keyringService */.zn.displayForKeyring(originKeyring, addressType, service/* keyringService */.zn.keyrings.length - 1);
      const keyring = await _this.displayedKeyringToWalletKeyring(displayedKeyring, service/* keyringService */.zn.keyrings.length - 1);
      for (const j in keyring.accounts) {
      ...
      service/* preferenceService */.t3.setShowSafeNotice(false);
    };
    this.createTmpKeyringWithMnemonics = async function (mnemonic, hdPath, passphrase, addressType) {
      ...
      const originKeyring = service/* keyringService */.zn.createTmpKeyring('HD Key Tree', {
        mnemonic,
        activeIndexes,
      ...
      const displayedKeyring = await service/* keyringService */.zn.displayForKeyring(originKeyring, addressType, -1);
    ...
    this.createTmpKeyringWithMnemonicsWithAddressDiscovery = async function (mnemonic, hdPath, passphrase, addressType) {
      ...
      for (let i = 0;; i = i + accountCount) {
        ...
        const dtype_arr = [];
        const index_arr = [];
        const networkType = service/* preferenceService */.t3.getNetworkType();
        receiveAddressObjArr.forEach(a => {
          const address = service/* keyringService */.zn.publicKeyToAddress(a.address, addressType, networkType);
    ...
    this.discoverAddressesWithBalance = async function (keyring) {
      ...
      const oKeyring = service/* keyringService */.zn.keyrings[keyring.index];
      ...
      for (let i = 0; i < address_arr.length;) {
        ...
        if (idDuplicated) {
          ...
          await service/* keyringService */.zn.addNewAccount(oKeyring, dtype_arr[i], index);
          i++;
        }
      }
    ...
    this.compoundUtxos = async accounts => {
      ...
      const entries = await service/* openapiService */.at.getKASUtxos(addresses);
      const keyring = await this.getCurrentKeyring();
      if (!keyring) throw new Error('no current keyring');
      const _keyring = service/* keyringService */.zn.keyrings[keyring.index];
      if (!entries.length) {
        throw new Error(`No UTXOs found for address ${addresses}`);
      } else {
        // entries.sort((a, b) => a.amount > b.amount || -(a.amount < b.amount));
        try {
          const networkId = service/* openapiService */.at.getNetworkId();
          const generator = new kaspa.Generator({
            entries,
            outputs: [],
          ...
          while (pending = await generator.next()) {
            ...
            const preSubmitPending = await service/* keyringService */.zn.signTransaction(_keyring, pending, toSignInputs);
            // submit
            const txid = await service/* openapiService */.at.submitTransaction(preSubmitPending);
            return txid;
          }
        } catch (e) {
          console.log(e);
    ...
    this.createTmpKeyringWithPrivateKey = async (privateKey, addressType) => {
      const originKeyring = service/* keyringService */.zn.createTmpKeyring(constant/* KEYRING_TYPE */.rK.SimpleKeyring, [privateKey]);
      const displayedKeyring = await service/* keyringService */.zn.displayForKeyring(originKeyring, addressType, -1);
      service/* preferenceService */.t3.setShowSafeNotice(false);
    ...
    this.removeKeyring = async keyring => {
      await service/* keyringService */.zn.removeKeyring(keyring.index);
    ...
    this.getKeyringByType = type => {
      return service/* keyringService */.zn.getKeyringByType(type);
    };
    this.deriveNewAccountFromMnemonic = async (keyring, alianName) => {
      const _keyring = service/* keyringService */.zn.keyrings[keyring.index];
      const result = await service/* keyringService */.zn.addNewAccount(_keyring);
    ...
    this.getAccountsCount = async () => {
      const accounts = await service/* keyringService */.zn.getAccounts();
      return accounts.filter(x => x).length;
    };
    this.changeKeyring = function (keyring) {
      let accountIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
      service/* preferenceService */.t3.setCurrentKeyringIndex(keyring.index);
      ...
      service/* preferenceService */.t3.setCurrentAccount(account);
      const flag = service/* preferenceService */.t3.getAddressFlag(account.address);
      service/* openapiService */.at.setClientAddress(account.address, flag);
    };
    this.getAllAddresses = (keyring, index) => {
      ...
      if (keyring.type === constant/* KEYRING_TYPE */.rK.HdKeyring) {
        const pathPubkey = {};
        constant/* ADDRESS_TYPES */.Ld.filter(v => v.displayIndex >= 0).forEach(v => {
          ...
          const address = service/* keyringService */.zn.publicKeyToAddress(pubkey, v.value, networkType);
          addresses.push(address);
        });
      } else {
        constant/* ADDRESS_TYPES */.Ld.filter(v => v.displayIndex >= 0 && v.isKaswareLegacy === false).forEach(v => {
    ...
    this.changeAddressType = async addressType => {
      ...
      const currentKeyringIndex = service/* preferenceService */.t3.getCurrentKeyringIndex();
      await service/* keyringService */.zn.changeAddressType(currentKeyringIndex, addressType);
      const keyring = await this.getCurrentKeyring();
      if (!keyring) throw new Error('no current keyring');
    ...
    this.signTransaction = async (type, from, psbt, inputs) => {
      const keyring = await service/* keyringService */.zn.getKeyringForAccount(from, type);
      return service/* keyringService */.zn.signTransaction(keyring, psbt, inputs);
    };
    ...
    this.signPsbt = async (psbt, toSignInputs, autoFinalized) => {
      ...
      psbt = await service/* keyringService */.zn.signTransaction(_keyring, psbt, toSignInputs);
      if (autoFinalized) {
    ...
    this.signMessage = async text => {
      const account = service/* preferenceService */.t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      return service/* keyringService */.zn.signMessage(account.pubkey, text);
    };
    this.verifyMessage = async (text, signature) => {
      const account = service/* preferenceService */.t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      return service/* keyringService */.zn.verifyMessage(account.pubkey, text, signature);
    };
    this.signMessageL2 = async text => {
      ...
      return await (0,L2Ethers/* signMessage */.lT)(text, `0x${privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex}`);
    };
    this.verifyMessageL2 = async (text, signature) => {
      const account = service/* preferenceService */.t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      return await (0,L2Ethers/* verifyMessage */.Ee)(text, signature, account.addressL2);
    };
    // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
    ...
    this.requestKeyring = function (type, methodName, keyringId) {
      ...
      if (keyringId !== null && keyringId !== undefined) {
        ...
        try {
          ...
          const Keyring = service/* keyringService */.zn.getKeyringClassForType(type);
          keyring = new Keyring();
        }
      }
    ...
    this._getKeyringByType = type => {
      const keyring = service/* keyringService */.zn.getKeyringsByType(type)[0];
      if (keyring) {
        return keyring;
      }
    ...
    this.addContact = data => {
      service/* contactBookService */.jX.addContact(data);
    };
    this.updateContact = data => {
      service/* contactBookService */.jX.updateContact(data);
    };
    this.removeContact = address => {
      service/* contactBookService */.jX.removeContact(address);
    };
    this.listContact = function () {
      let includeAlias = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      const list = service/* contactBookService */.jX.listContacts();
      if (includeAlias) {
        return list;
      } else {
    ...
    this.getContactsByMap = () => {
      return service/* contactBookService */.jX.getContactsByMap();
    };
    this.getContactByAddress = address => {
      return service/* contactBookService */.jX.getContactByAddress(address);
    };
    this.addERC20Token = data => {
      service/* erc20ListService */.Ut.updateERC20List(data);
    };
    this.getERC20ListByAddress = address => {
      console.log('getERC20ListByAddress', address);
      return service/* erc20ListService */.Ut.getERC20ListByAddress(address);
    };
    this._generateAlianName = (type, index) => {
      const alianName = `${constant/* BRAND_ALIAN_TYPE_TEXT */.LI[type]} ${index}`;
      return alianName;
    };
    ...
    this.getHighlightWalletList = () => {
      return service/* preferenceService */.t3.getWalletSavedList();
    };
    this.updateHighlightWalletList = list => {
      return service/* preferenceService */.t3.updateWalletSavedList(list);
    };
    this.getAlianName = pubkey => {
      var _contactBookService$g;
      const contactName = (_contactBookService$g = service/* contactBookService */.jX.getContactByAddress(pubkey)) === null || _contactBookService$g === void 0 ? void 0 : _contactBookService$g.name;
      return contactName;
    };
    this.updateAlianName = (pubkey, name) => {
      service/* contactBookService */.jX.updateAlias({
        name,
        address: pubkey
      });
    };
    this.getAllAlianName = () => {
      return service/* contactBookService */.jX.listAlias();
    };
    this.getInitAlianNameStatus = () => {
      return service/* preferenceService */.t3.getInitAlianNameStatus();
    };
    this.updateInitAlianNameStatus = () => {
      service/* preferenceService */.t3.changeInitAlianNameStatus();
    };
    this.getIsFirstOpen = () => {
      return service/* preferenceService */.t3.getIsFirstOpen();
    };
    this.updateIsFirstOpen = () => {
      return service/* preferenceService */.t3.updateIsFirstOpen();
    };
    this.listChainAssets = async pubkeyAddress => {
      const balance = await service/* openapiService */.at.getAddressBalance(pubkeyAddress);
      const assets = [{
        name: constant/* COIN_NAME */._Z,
        symbol: constant/* COIN_SYMBOL */.Rc,
    ...
    this.getRpcLinks = () => {
      const rpcLinks = service/* preferenceService */.t3.getRpcLinks();
      return rpcLinks;
    };
    this.getRpcStatus = () => {
      const status = service/* openapiService */.at.getRpcStatus();
      return status;
    };
    this.setNetworkType = async networkType => {
      console.log('setNetworkType', networkType);
      service/* preferenceService */.t3.setNetworkType(networkType);
      const rpcLinks = service/* preferenceService */.t3.getRpcLinks();
      if (networkType === types/* NetworkType */.z1.Mainnet) {
        this.openapi.setHost(constant/* OPENAPI_URL_MAINNET */._7);
        this.openapi.setNetworkId('mainnet');
        this.openapi.setRpcHost(rpcLinks[0].url);
      } else if (networkType === types/* NetworkType */.z1.Testnet) {
        this.openapi.setHost(constant/* OPENAPI_URL_TESTNET */.lu);
        this.openapi.setNetworkId('testnet-10');
        this.openapi.setRpcHost(rpcLinks[1].url);
      } else if (networkType === types/* NetworkType */.z1.Devnet) {
        this.openapi.setHost(constant/* OPENAPI_URL_DEVNET */._k);
        this.openapi.setNetworkId('devnet');
        this.openapi.setRpcHost(rpcLinks[2].url);
      }
      const network = this.getNetworkName();
      service/* sessionService */.mB.broadcastEvent('networkChanged', {
        network
      });
      const currentAccount = await this.getCurrentAccount();
      const keyring = await this.getCurrentKeyring();
    ...
    this.setRpcLinks = async rpcLinks => {
      service/* preferenceService */.t3.setRpcLinks(rpcLinks);
    };
    this.getNetworkName = () => {
      const networkType = service/* preferenceService */.t3.getNetworkType();
      return constant/* NETWORK_TYPES */.rg[networkType].name;
    };
    this.getKASUtxos = async () => {
      const account = service/* preferenceService */.t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      const utxos = await service/* openapiService */.at.getKASUtxos([account.address]);

      // if (openapiService.addressFlag == 1) {
      //   utxos = utxos.filter((v) => (v as any).height !== 4194303);
      // }

      const kasUtxos = (0,utils/* getKaspaUTXOWithoutBigint */.A0)(utxos);
      return kasUtxos;
    };
    this.getTxActivities = async () => {
      const account = service/* preferenceService */.t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      const trans = await service/* openapiService */.at.getTxActivities(account.address);
      return trans;
    };
    ...
    this.sendKAS = async _ref3 => {
      ...
      try {
        ...
        // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
        const generator = await service/* openapiService */.at.createGenerator(sourceAddress, destinationAddress, changeAddress, moneySompi);
        const summary = await generator.estimate();
    ...
    this.sendAllKAS = async _ref4 => {
      ...
      const total = await service/* openapiService */.at.getAddressBalanceOfKas(sourceAddress);
    ...
    this.pushTx = async rawtx => {
      ...
      const entries = await service/* openapiService */.at.getKASUtxos([sourceAddress]);
      if (!entries.length) {
        ...
        try {
          ...
          if (Number(total) == money) {
            ...
            generator = await service/* openapiService */.at.createGenerator(sourceAddress, destinationAddress, changeAddress, moneySompi, priorityFee);
          } else {
            const changeAddress = sourceAddress;
    ...
    this.displayedKeyringToWalletKeyring = async function (displayedKeyring, index) {
      ...
      for (let j = 0; j < displayedKeyring.accounts.length; j++) {
        ...
        const address = service/* keyringService */.zn.publicKeyToAddress(pubkey, addressType, networkType);
        const accountKey = key + '#' + j;
        const defaultName = _this.getAlianName(pubkey) || _this._generateAlianName(type, j + 1);
        const alianName = service/* preferenceService */.t3.getAccountAlianName(accountKey, defaultName);
        const flag = service/* preferenceService */.t3.getAddressFlag(address);
        const pubkeyL2 = '';
        const addressL2 = '';
        accounts.push({
          type,
      ...
      const hdPath = type === constant/* KEYRING_TYPE */.rK.HdKeyring ? displayedKeyring.keyring.hdPath : '';
      const alianName = service/* preferenceService */.t3.getKeyringAlianName(key, initName ? `${constant/* KEYRING_TYPES */.us[type].alianName} ${index + 1}` : '');
      const keyring = {
        index,
        key,
        type,
    ...
    this.getKeyrings = async () => {
      const displayedKeyrings = await service/* keyringService */.zn.getAllDisplayedKeyrings();
      const keyrings = [];
      for (let index = 0; index < displayedKeyrings.length; index++) {
        const displayedKeyring = displayedKeyrings[index];
        if (displayedKeyring.type !== constant/* KEYRING_TYPE */.rK.Empty) {
    ...
    this.getCurrentKeyring = async () => {
      let currentKeyringIndex = service/* preferenceService */.t3.getCurrentKeyringIndex();
      const displayedKeyrings = await service/* keyringService */.zn.getAllDisplayedKeyrings();
      ...
      if (!displayedKeyrings[currentKeyringIndex] || displayedKeyrings[currentKeyringIndex].type === constant/* KEYRING_TYPE */.rK.Empty || !displayedKeyrings[currentKeyringIndex].accounts[0]) {
        for (let i = 0; i < displayedKeyrings.length; i++) {
          if (displayedKeyrings[i].type !== constant/* KEYRING_TYPE */.rK.Empty) {
            currentKeyringIndex = i;
            service/* preferenceService */.t3.setCurrentKeyringIndex(currentKeyringIndex);
            break;
          }
        }
      }
    ...
    this.getCurrentAccount = async () => {
      ...
      if (currentAccount) {
        currentAccount.flag = service/* preferenceService */.t3.getAddressFlag(currentAccount.address);
        service/* openapiService */.at.setClientAddress(currentAccount.address, currentAccount.flag);
      }
      return currentAccount;
    };
    this.getEditingKeyring = async () => {
      const editingKeyringIndex = service/* preferenceService */.t3.getEditingKeyringIndex();
      const displayedKeyrings = await service/* keyringService */.zn.getAllDisplayedKeyrings();
    ...
    this.setEditingKeyring = async index => {
      service/* preferenceService */.t3.setEditingKeyringIndex(index);
    };
    this.getEditingAccount = async () => {
      const account = service/* preferenceService */.t3.getEditingAccount();
      return account;
    };
    this.setEditingAccount = async account => {
      service/* preferenceService */.t3.setEditingAccount(account);
    };
    this.getAppSummary = async () => {
      const appTab = service/* preferenceService */.t3.getAppTab();
      try {
        const data = await service/* openapiService */.at.getAppSummary();
        ...
        service/* preferenceService */.t3.setAppSummary(data);
        return data;
      } catch (e) {
    ...
    this.readTab = async () => {
      return service/* preferenceService */.t3.setReadTabTime(Date.now());
    };
    this.readApp = async appid => {
      return service/* preferenceService */.t3.setReadAppTime(appid, Date.now());
    };
    this.getAddressUtxo = async address => {
      const data = await service/* openapiService */.at.getKASUtxos([address]);
      return data;
    };
    this.getConnectedSite = service/* permissionService */.ps.getConnectedSite;
    this.getSite = service/* permissionService */.ps.getSite;
    this.getConnectedSites = service/* permissionService */.ps.getConnectedSites;
    this.setRecentConnectedSites = sites => {
      service/* permissionService */.ps.setRecentConnectedSites(sites);
    };
    this.getRecentConnectedSites = () => {
      return service/* permissionService */.ps.getRecentConnectedSites();
    };
    this.getCurrentSite = tabId => {
      const {
        ...
        name,
        icon
      } = service/* sessionService */.mB.getSession(tabId) || {};
      if (!origin) {
        return null;
      }
      const site = service/* permissionService */.ps.getSite(origin);
      if (site) {
        return site;
      }
      return {
        ...
        name,
        icon,
        chain: constant/* CHAINS_ENUM */.DN.KAS,
        isConnected: false,
        isSigned: false,
        isTop: false
      };
    ...
    this.getCurrentConnectedSite = tabId => {
      ...
      return service/* permissionService */.ps.getWithoutUpdate(origin);
    };
    this.setSite = data => {
      service/* permissionService */.ps.setSite(data);
      if (data.isConnected) {
        const network = this.getNetworkName();
        service/* sessionService */.mB.broadcastEvent('networkChanged', {
          network
    ...
    this.updateConnectSite = (origin, data) => {
      service/* permissionService */.ps.updateConnectSite(origin, data);
      const network = this.getNetworkName();
      service/* sessionService */.mB.broadcastEvent('networkChanged', {
        network
      }, data.origin);
    ...
    this.removeAllRecentConnectedSites = () => {
      const sites = service/* permissionService */.ps.getRecentConnectedSites().filter(item => !item.isTop);
      sites.forEach(item => {
        this.removeConnectedSite(item.origin);
      });
    };
    this.removeConnectedSite = origin => {
      service/* sessionService */.mB.broadcastEvent('accountsChanged', [], origin);
      service/* permissionService */.ps.removeConnectedSite(origin);
    };
    this.setKeyringAlianName = (keyring, name) => {
      service/* preferenceService */.t3.setKeyringAlianName(keyring.key, name);
      keyring.alianName = name;
      return keyring;
    };
    this.setAccountAlianName = (account, name) => {
      service/* preferenceService */.t3.setAccountAlianName(account.key, name);
      account.alianName = name;
      return account;
    };
    this.addAddressFlag = (account, flag) => {
      account.flag = service/* preferenceService */.t3.addAddressFlag(account.address, flag);
      service/* openapiService */.at.setClientAddress(account.address, account.flag);
      return account;
    };
    this.removeAddressFlag = (account, flag) => {
      account.flag = service/* preferenceService */.t3.removeAddressFlag(account.address, flag);
      service/* openapiService */.at.setClientAddress(account.address, account.flag);
      return account;
    };
    this.getFeeSummary = async () => {
      return service/* openapiService */.at.getFeeSummary();
    };
    this.decodePsbt = psbtHex => {
      return service/* openapiService */.at.decodePsbt(psbtHex);
    };
    this.createMoonpayUrl = address => {
      return service/* openapiService */.at.createMoonpayUrl(address);
    };
    this.getWalletConfig = () => {
      return service/* openapiService */.at.getWalletConfig();
    };
    this.getSkippedVersion = () => {
      return service/* preferenceService */.t3.getSkippedVersion();
    };
    this.setSkippedVersion = version => {
      return service/* preferenceService */.t3.setSkippedVersion(version);
    };
    this.checkWebsite = website => {
      return service/* openapiService */.at.checkWebsite(website);
    };
    // it's used for ori. ---from shawn
    this.getAddressSummary = async address => {
      const data = await service/* openapiService */.at.getAddressSummary(address);
      // preferenceService.updateAddressBalance(address, data);
      return data;
    };
    this.getShowSafeNotice = () => {
      return service/* preferenceService */.t3.getShowSafeNotice();
    };
    this.setShowSafeNotice = show => {
      return service/* preferenceService */.t3.setShowSafeNotice(show);
    };
    this.getVersionDetail = version => {
      return service/* openapiService */.at.getVersionDetail(version);
    };
    ...
    this.openDeployKrc20View = async () => {
      return await service/* openapiService */.at.openDeployKrc20View();
    };
    this.openMintKrc20View = async () => {
      return await service/* openapiService */.at.openMintKrc20View();
    };
    // setLayerType = async (layerType: string) => {
    //   return await preferenceService.setLayerType(layerType);
    // }
    this.getLayer = () => {
      const layer = service/* preferenceService */.t3.getLayer();
      return layer;
    };
    this.setLayer = type => {
      service/* preferenceService */.t3.setLayer(type);
      service/* sessionService */.mB.broadcastEvent('layerChanged', {
        layer: type
      });
    };
    this.getBalanceByAddress = async sourceAddress => {
      const accountBalance = await service/* openapiService */.at.getAddressBalance(sourceAddress);
...
const CreateAccountScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 1117).then(__webpack_require__.bind(__webpack_require__, 61117)));
...
const ApprovalScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(111), __webpack_require__.e(6445), __webpack_require__.e(8581), __webpack_require__.e(7459), __webpack_require__.e(7700), __webpack_require__.e(1288), __webpack_require__.e(7579), __webpack_require__.e(8458)]).then(__webpack_require__.bind(__webpack_require__, 9965)));
...
const DeployScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(862), __webpack_require__.e(4433), __webpack_require__.e(1288), __webpack_require__.e(7761)]).then(__webpack_require__.bind(__webpack_require__, 97761)));
const MintScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(5892), __webpack_require__.e(1288), __webpack_require__.e(6868)]).then(__webpack_require__.bind(__webpack_require__, 36868)));
const ChownScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(862), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(7581)]).then(__webpack_require__.bind(__webpack_require__, 27337)));
const BlacklistIssueScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(862), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(1362)]).then(__webpack_require__.bind(__webpack_require__, 97910)));
const IssueScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(862), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(5167)]).then(__webpack_require__.bind(__webpack_require__, 51911)));
const BurnScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(862), __webpack_require__.e(1288), __webpack_require__.e(2557)]).then(__webpack_require__.bind(__webpack_require__, 15943)));
...
const KNSScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 7784).then(__webpack_require__.bind(__webpack_require__, 37784)));
...
const TxConfirmScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(111), __webpack_require__.e(6445), __webpack_require__.e(8581), __webpack_require__.e(7459), __webpack_require__.e(7700), __webpack_require__.e(1288), __webpack_require__.e(7579), __webpack_require__.e(7627)]).then(__webpack_require__.bind(__webpack_require__, 84536)));
