"use strict";
(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[6299],{
...
/* harmony export */ });
/* harmony import */ var antd_lib_tabs_style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15509);
...
/* harmony import */ var antd_lib_tabs__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(80899);
/* harmony import */ var antd_lib_spin_style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(55809);
...
/* harmony import */ var antd_lib_spin__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(96383);
/* harmony import */ var antd_lib_drawer_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(71652);
...
/* harmony import */ var antd_lib_drawer__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(85266);
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(87164);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(14073);
/* harmony import */ var _mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(73357);
/* harmony import */ var _mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(6757);
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(95642);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(99770);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(41442);
...
/* harmony import */ var _background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(28454);
...
function TxCreateScreen() {
  const {
    state
  } = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_34__/* .useLocation */ .zy)();
  const {
    t
  ...
  const getGasPrice = async amount => {
    ...
    if (_inputAmount > 0) {
      try {
        ...
        const provider = new ethers__WEBPACK_IMPORTED_MODULE_36__/* .JsonRpcProvider */ .FR(rpc);
        const valueInWei = ethers__WEBPACK_IMPORTED_MODULE_37__/* .parseEther */ .g5(_inputAmount.toString());
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const isTestnetAddress = currentLayer === 'L2' && address.startsWith('0x') && ethers__WEBPACK_IMPORTED_MODULE_38__/* .isAddress */ .PW(address) || currentLayer === 'L1' && kaspaAddressPattern.test(address);
    const isMainnetAddress = currentLayer === 'L2' && address.startsWith('0x') && ethers__WEBPACK_IMPORTED_MODULE_38__/* .isAddress */ .PW(address) || currentLayer === 'L1' && kaspaAddressPattern.test(address);
    const isDevAddress = currentLayer === 'L2' && address.startsWith('0x') && ethers__WEBPACK_IMPORTED_MODULE_38__/* .isAddress */ .PW(address) || currentLayer === 'L1' && kaspaAddressPattern.test(address);
    ...
    if (!(activeToken !== null && activeToken !== void 0 && activeToken.isToken) && currentLayer === 'L2') {
      ...
      if ((0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .isGreaterThan */ .yJ)(tokenAmount, (0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .parseTokenBalance */ .Ff)(activeToken.balance, activeToken.decimals || 8))) {
  ...
  const handleTransferKrc20 = async () => {
    ...
    if (activeToken.mod === 'issue') {
      // issue mode
      result = await (0,_background_krc20_krc20action__WEBPACK_IMPORTED_MODULE_5__/* .krc20_trans_issue */ .cc)(privateKey.hex, networkName, activeToken.ca, txFee * (feeRate <= 0 ? 1 : feeRate), toInfo.address, (0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .parseUnits */ .XS)(tokenAmount, activeToken === null || activeToken === void 0 ? void 0 : activeToken.dec));
      console.log('send krc20 result', result);
    } else {
      // 普通模式
      result = await (0,_background_krc20_krc20action__WEBPACK_IMPORTED_MODULE_5__/* .krc20_trans */ .ok)(privateKey.hex, networkName, activeToken.tick, txFee * (feeRate <= 0 ? 1 : feeRate), toInfo.address, (0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .parseUnits */ .XS)(tokenAmount, activeToken === null || activeToken === void 0 ? void 0 : activeToken.dec));
    }
  ...
  const handleTransferErc20 = async () => {
    ...
    try {
      if (relayerType === 'L1') {
        const res = await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_6__/* .send_erc20_with_evm_payload */ .Nt)(networkId, `0x${privateKey.hex}`, address, txFee, toInfo.address, tokenAmount,
        ...
        const res = await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_6__/* .send_erc20_transaction */ .P5)(toInfo.address, tokenAmount, `0x${privateKey.hex}`, activeToken.contractAddress);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(antd_lib_spin__WEBPACK_IMPORTED_MODULE_39__/* ["default"] */ .A, {
    spinning: loading,
    tip: "Loading...",
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Layout */ .PE, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Header */ .Y9, {
        onBack: () => navigate('MainScreen'),
        title: `${t('Send')} ${activeToken ? activeToken.tick : `${currentLayer === 'L2' ? 'e' : ''}KAS`}`,
        RightComponent: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .NodeStatus */ .zI, {})
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components_Styled_Content__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .A, {
        className: "!h-auto flex-1 !justify-start overflow-y-auto px-4 !pb-0",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
          className: "flex justify-items-end items-center space-x-3",
          children: [networkType !== 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components_LayerSwapOut__WEBPACK_IMPORTED_MODULE_14__/* .LayerSwapOut */ .z, {
            callback: handleLayerSwapOut
          }), currentLayer === 'L2' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
            style: {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              text: t(`Use Relayer`)
            })
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
          className: "space-y-2",
          style: {
            marginTop: 8
          },
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components_Styled_TokenItem__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .A, {
          ...
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
            text: t('Recipient'),
            preset: "regular",
            color: "text",
            style: {
          ...
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
            justifyBetween: true,
            style: {
              marginTop: 4,
              position: 'relative'
            },
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
              full: true,
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Input */ .pd, {
                id: "address-input",
                preset: "address",
            ...
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Button */ .$n, {
          ...
          }), currentLayer === 'L1' && !!toInfo.address && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components_KnsDomain__WEBPACK_IMPORTED_MODULE_32__/* ["default"] */ .A, {
            networkType: networkType,
            address: toInfo.address
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
            mt: "lg",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                text: t('Balance'),
                color: "text_minor"
              }), activeToken ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_41__/* ["default"] */ .A, {
                style: {
                  color: '#0A2463'
                },
                children: (0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .formatNumber */ .ZV)(activeToken.balance, activeToken.dec)
              }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.Fragment, {
                children: showSafeBalance || currentLayer === 'L2' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
            ...
            }), !(activeToken !== null && activeToken !== void 0 && activeToken.isToken) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.Fragment, {
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
                justifyBetween: true,
                itemsCenter: true,
                style: {
                  minHeight: 30
              ...
              }), showSafeBalance && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
                justifyBetween: true,
                itemsCenter: true,
                style: {
                  minHeight: 30
            ...
            }) : null, !(activeToken !== null && activeToken !== void 0 && activeToken.isToken) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
              className: "space-y-2",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components_Input__WEBPACK_IMPORTED_MODULE_13__/* .KasAmountInput */ .uj, {
                preset: "amount",
              ...
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
                style: {
                  margin: '10px 0 0 0'
                },
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(SubInputAmount, {
                  inputAmountType: inputAmountType,
              ...
              className: "",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_42__/* ["default"] */ .A, {
                value: tokenAmount,
                onChange: e => {
                  // const reg = new RegExp(`^\\d*(\\.\\d{0,${activeToken.decimals || 8}})?$`)
                  const reg = new RegExp(`^\\d*(\\.\\d{0,4})?$`);
                  if ((0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .isNumeric */ .kf)(e.target.value) && reg.test(e.target.value)) {
          ...
          }), error && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
            text: error,
            color: "error"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
            justifyCenter: true,
            mt: "xl",
            children: [txFee > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              color: "textDim",
              text: `${t('TX Fee:')} ${txFee} ${currentLayer === 'L2' ? 'e' : ''}KAS`,
              textCenter: true
            }), currentLayer !== 'L2' && txFee > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
              mt: "lg",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              ...
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components_FeeRateBar__WEBPACK_IMPORTED_MODULE_12__/* .FeeRateBar */ .q, {
                feeRate: feeRate,
                onChange: val => {
                  setFeeRate(val);
                }
        ...
        variant: "body2",
        color: "textSecondary",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Button */ .$n, {
          ...
          endIcon: sending ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_43__/* ["default"] */ .A, {
            size: 20,
            color: "inherit"
          }) : null,
          fullWidth: true,
      ...
      }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_41__/* ["default"] */ .A, {
        px: '16px',
        my: '16px',
        align: "center",
        variant: "body2",
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Button */ .$n, {
          ...
          onClick: e => {
            if (currentLayer === 'L2') {
              ...
              if (Number((0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .sompiToAmount */ ._m)(feeRate * Number((0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .amountToSompi */ .UC)(txFee.toString())))) + Number(inputAmount) > Number(accountBalance.amount)) return tools.toastError('Insufficient balance');
              setSending(true);
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(SelectAddressDrawer, {
        drawerVisible: drawerVisible,
        onClose: () => setDrawerVisible(false),
        handleAddrInput: handleAddrInput
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(antd_lib_drawer__WEBPACK_IMPORTED_MODULE_44__/* ["default"] */ .A, {
        placement: 'bottom',
        closable: false,
        onClose: () => setFeeDrawerVisible(false),
        open: feeDrawerVisible,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
          mt: "lg",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
            text: `${t('Priority Fee Rate')} ( ${t('Optional')} )`,
            color: "textDim"
            ...
            text: `${t('Priority Fee:')} ${(0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .sompiToAmount */ ._m)(feeRate * Number((0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .amountToSompi */ .UC)(txFee.toString())))} ${currentLayer === 'L2' ? 'e' : ''}KAS`,
            textCenter: true
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
            mt: "xxl",
            full: true
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Button */ .$n, {
            disabled: disabled,
...
const SelectAddressDrawer = _ref2 => {
  ...
  const tabItems = [{
    key: 'recent',
    label: 'Recent',
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(RecentTab, {
      handleAddrInput: handleAddrInput
    })
  }, {
    key: 'contacts',
    label: 'Contacts',
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(ContactsTab, {
      handleAddrInput: handleAddrInput
    })
    // disabled: true,
  }, {
    key: 'my_account',
    label: 'My account',
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(MyAccountTab, {
      handleAddrInput: handleAddrInput
    })
  }];
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(antd_lib_drawer__WEBPACK_IMPORTED_MODULE_44__/* ["default"] */ .A, {
    placement: 'bottom',
    closable: false,
    onClose: onClose,
    open: drawerVisible,
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(antd_lib_tabs__WEBPACK_IMPORTED_MODULE_45__["default"], {
      size: 'small',
      defaultActiveKey: "0",
      items: tabItems,
      onTabClick: key => {
  ...
  if (kasPrice > 0 && (0,_ui_utils__WEBPACK_IMPORTED_MODULE_27__/* .isNumeric */ .kf)(inputAmount)) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Icon */ .In, {
          icon: "send",
        ...
        }), inputAmountType == 'kas' && kasPrice > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
          text: `$${(0,bignumber_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(Number(inputAmount) * Number(kasPrice)).toFixed(6)}`,
          color: hover ? 'text' : 'white_minor'
        }), inputAmountType == 'usd' && kasPrice > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
...
function RecentTab(_ref4) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    const fetchTransactions = async () => {
      ...
      try {
        ...
        if (currentLayer === 'L1') {
          if (activeToken) {
            const networkName = currentNetworkType === _shared_types__WEBPACK_IMPORTED_MODULE_8__/* .NetworkType */ .z1.Mainnet ? 'mainnet' : currentNetworkType === _shared_types__WEBPACK_IMPORTED_MODULE_8__/* .NetworkType */ .z1.Testnet ? 'testnet-10' : '';
            const data = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_31__/* .fetch_krc20_oplist */ .ip)(networkName, address, activeToken.tick);
            list = data.map(item => {
        ...
        if (currentLayer === 'L2') {
          ...
          if (activeToken) {
            const res = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_31__/* .fetch_erc20 */ .kk)(currentNetworkType, addressL2, activeToken.contractAddress);
  ...
  if (transactionInfos && transactionInfos.length > 0) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)("div", {
      children: transactionInfos.map(e => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Card */ .Zp, {
        mt: "md",
        style: {
        ...
        classname: "hover",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .fI, {
          full: true,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
            full: true,
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              ...
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Column */ .VP, {
    ...
    if (loading) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.Fragment, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
          className: "text-center py-7",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_43__/* ["default"] */ .A, {
            size: 20,
            color: "inherit"
          })
        })
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components_Empty__WEBPACK_IMPORTED_MODULE_11__/* .Empty */ .S, {});
    }
  }
}
  ...
  if (items.length == 0) {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)("div", {
      children: items.map(account => {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(AddressTypeCard, {
          name: account.name,
...
function AddressTypeCard(_ref7) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_33__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_9__/* .Card */ .Zp, {
    classname: "hover",
    justifyBetween: true,
    mt: "md",
    onClick: async () => {
