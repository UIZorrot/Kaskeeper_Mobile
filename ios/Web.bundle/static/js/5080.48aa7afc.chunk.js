"use strict";
(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[5080],{
...
/* harmony import */ var _ui_components_AddressTypeCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22310);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_ui_components__WEBPACK_IMPORTED_MODULE_2__, _ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_5__, _ui_state_keyrings_hooks__WEBPACK_IMPORTED_MODULE_6__, _MainRoute__WEBPACK_IMPORTED_MODULE_8__]);
([_ui_components__WEBPACK_IMPORTED_MODULE_2__, _ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_5__, _ui_state_keyrings_hooks__WEBPACK_IMPORTED_MODULE_6__, _MainRoute__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function AddressTypeScreen() {
  ...
  const account = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_5__/* .useCurrentAccount */ .YL)();
  const {
    t
  ...
  const loadAddresses = async () => {
    ...
    for (let i = 0; i < _res.length; i++) {
      ...
      self.addressAssets[address] = {
        total_kas: (0,_ui_utils__WEBPACK_IMPORTED_MODULE_7__/* .sompiToAmount */ ._m)(balance.totalSompi),
        sompi
      };
    }
  ...
  const addressTypes = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (currentKeyring.type === _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.HdKeyring) {
      ...
      return _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .ADDRESS_TYPES */ .Ld.filter(v => v.displayIndex >= 0 && v.isKaswareLegacy != true).sort((a, b) => a.displayIndex - b.displayIndex);
    }
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Header */ .Y9, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Column */ .VP, {
        children: addressTypes.map((item, index) => {
          ...
          if (currentKeyring.type === _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.SimpleKeyring) {
            name = `${item.name}`;
          }
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_ui_components_AddressTypeCard__WEBPACK_IMPORTED_MODULE_4__/* .AddressTypeCard */ .r, {
            label: name,
            address: address,
            assets: assets,
