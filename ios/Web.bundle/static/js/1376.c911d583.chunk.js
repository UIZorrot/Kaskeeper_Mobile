"use strict";
(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[1376],{
...
/* harmony export */   "default": () => (/* binding */ NetworkTypeScreen)
/* harmony export */ });
...
/* harmony import */ var _ui_images_common_checkCircleFilled_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9428);
/* harmony import */ var _ui_images_common_checkCircleFilledSelected_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(56124);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2488);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_ui_components__WEBPACK_IMPORTED_MODULE_1__, _ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_3__, _MainRoute__WEBPACK_IMPORTED_MODULE_5__]);
([_ui_components__WEBPACK_IMPORTED_MODULE_1__, _ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_3__, _MainRoute__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function NetworkTypeScreen() {
  const networkType = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useNetworkType */ .qS)();
  const currentRpcLinks = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useRpcLinks */ .Wq)();
  const changeNetworkType = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useChangeNetworkTypeCallback */ .eo)();
  ...
  const changeLayerType = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useChangeLayerTypeCallback */ .kz)();
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ ._W, {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Header */ .ek, {
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Content */ .kP, {
      style: {
        padding: '16px',
        overflowY: 'auto',
        gap: 'inherit'
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Column */ .ou, {
        ...
        children: currentRpcLinks && currentRpcLinks.length > 0 && currentRpcLinks.map((item, index) => item.value !== _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .U5.Simnet ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Card */ .M1, {
          style: {
            backgroundColor: item.value === networkType ? '#E6FCF6' : 'rgba(10, 36, 99, 0.03)',
            borderRadius: 12,
            marginTop: 12,
            border: item.value === networkType ? '1px solid #04DFA6' : '1px solid transparent',
            padding: '16px',
            transition: 'all 0.3s',
            gap: 'inherit'
          },
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Row */ .WA, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Row */ .WA, {
              full: true,
              onClick: async () => {
                if (item.value === networkType) return;
                try {
                  await changeNetworkType(item.value);
                  // 如果切换到主网且当前是L2。需要把L2 => L1
                  if (item.value === _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .U5.Mainnet && currentLayer === _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .LayerType */ .Y1.L2) {
                    await changeLayerType(_shared_types__WEBPACK_IMPORTED_MODULE_0__/* .LayerType */ .Y1.L1);
                  }
                } catch (error) {
                  tools.toastError(t('Network type change failed'));
                }
                await reloadAccounts();
                navigate('MainScreen');
                // navigate('TxCreateScreen');
                tools.toastSuccess(t('Network type changed'));
              },
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Column */ .ou, {
                style: {
                  width: 24
                ...
                children: item.value === networkType ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Icon */ .GW, {
                  color: "green",
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("img", {
                    src: _ui_images_common_checkCircleFilledSelected_svg__WEBPACK_IMPORTED_MODULE_7__,
                    width: 18,
                    height: 18,
                    alt: ""
                  })
                  ...
                  color: "green",
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("img", {
                    src: _ui_images_common_checkCircleFilled_svg__WEBPACK_IMPORTED_MODULE_6__,
                    width: 18,
                    height: 18,
                    alt: ""
                  })
            ...
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Column */ .ou, {
              selfItemsCenter: true,
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Icon */ .GW, {
                onClick: e => {
                  e.stopPropagation();
                  navigate('EditNetworkUrlScreen', {
                    item
                  });
                },
                style: {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ant_design_icons__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .c, {
                  style: {
                    fontSize: 16,
                    color: '#666'
                  }
