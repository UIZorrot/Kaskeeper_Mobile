"use strict";
(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[2711],{
...
var _EllipsisOutlined = _interopRequireDefault(__webpack_require__(33433));
...
var _objectSpread2 = _interopRequireDefault(__webpack_require__(12897));
var React = _interopRequireWildcard(__webpack_require__(96540));
var _PlusOutlined = _interopRequireDefault(__webpack_require__(93198));
var _AntdIcon = _interopRequireDefault(__webpack_require__(3827));
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != _typeof(e) && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
// GENERATE BY ./scripts/generate.ts
...
/***/ ((module, exports, __webpack_require__) => {
  ...
  var _PlusOutlined = _interopRequireDefault(__webpack_require__(6319));
...
var rc_trigger_es = __webpack_require__(38744);
...
function Dropdown(props, ref) {
  var _props$arrow = props.arrow,
      ...
      otherProps = (0,objectWithoutProperties/* default */.A)(props, Dropdown_excluded);
  ...
  return /*#__PURE__*/react.createElement(rc_trigger_es/* default */.A, (0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({
...
function InternalItem(props, ref) {
  var prefixCls = props.prefixCls,
    ...
    restProps = (0,objectWithoutProperties/* default */.A)(props, Item_excluded);
...
function Overflow(props, ref) {
  ...
  return isResponsive ? /*#__PURE__*/react.createElement(rc_resize_observer_es["default"], {
...
var LEFT = KeyCode/* default */.A.LEFT,
  ...
  useAccessibility_ESC = KeyCode/* default */.A.ESC,
...
function getOffset(mode, isRootLevel, isRtl, which) {
  ...
  var inline = (_inline = {}, (0,defineProperty/* default */.A)(_inline, UP, prev), (0,defineProperty/* default */.A)(_inline, DOWN, next), _inline);
  var horizontal = (_horizontal = {}, (0,defineProperty/* default */.A)(_horizontal, LEFT, isRtl ? next : prev), (0,defineProperty/* default */.A)(_horizontal, RIGHT, isRtl ? prev : next), (0,defineProperty/* default */.A)(_horizontal, DOWN, children), (0,defineProperty/* default */.A)(_horizontal, ENTER, children), _horizontal);
  var vertical = (_vertical = {}, (0,defineProperty/* default */.A)(_vertical, UP, prev), (0,defineProperty/* default */.A)(_vertical, DOWN, next), (0,defineProperty/* default */.A)(_vertical, ENTER, children), (0,defineProperty/* default */.A)(_vertical, useAccessibility_ESC, parent), (0,defineProperty/* default */.A)(_vertical, LEFT, isRtl ? children : parent), (0,defineProperty/* default */.A)(_vertical, RIGHT, isRtl ? parent : children), _vertical);
  var offsets = {
    inline: inline,
...
var InternalMenuItem = /*#__PURE__*/react.forwardRef(function (props, ref) {
  ...
  var renderNode = /*#__PURE__*/react.createElement(LegacyMenuItem, (0,esm_extends/* default */.A)({
    ...
    className: classnames_default()(itemCls, (_classNames = {}, (0,defineProperty/* default */.A)(_classNames, "".concat(itemCls, "-active"), active), (0,defineProperty/* default */.A)(_classNames, "".concat(itemCls, "-selected"), selected), (0,defineProperty/* default */.A)(_classNames, "".concat(itemCls, "-disabled"), mergedDisabled), _classNames), className),
  ...
  return (list || []).map(function (opt, index) {
    if (opt && (0,esm_typeof/* default */.A)(opt) === 'object') {
      ...
      if (children || type === 'group') {
        if (type === 'group') {
          // Group
          return /*#__PURE__*/react.createElement(MenuItemGroup, (0,esm_extends/* default */.A)({
            key: mergedKey
          }, restProps, {
            title: label
        ...
        // Sub Menu
        return /*#__PURE__*/react.createElement(SubMenu, (0,esm_extends/* default */.A)({
          key: mergedKey
        }, restProps, {
          title: label
        }), convertItemsToNodes(children));
      ...
      // MenuItem & Divider
      if (type === 'divider') {
        return /*#__PURE__*/react.createElement(Divider, (0,esm_extends/* default */.A)({
          key: mergedKey
        }, restProps));
      }
      return /*#__PURE__*/react.createElement(es_MenuItem, (0,esm_extends/* default */.A)({
        key: mergedKey
      }, restProps), label);
    }
    return null;
...
function PopupTrigger(_ref) {
  ...
  var placement = rtl ? (0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({}, placementsRtl), builtinPlacements) : (0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({}, placements_placements), builtinPlacements);
...
var InternalSubMenu = function InternalSubMenu(props) {
  ...
  var listNode = /*#__PURE__*/react.createElement(rc_overflow_es.Item, (0,esm_extends/* default */.A)({
    ...
    component: "li",
    style: style,
    className: classnames_default()(subMenuPrefixCls, "".concat(subMenuPrefixCls, "-").concat(mode), className, (_classNames = {}, (0,defineProperty/* default */.A)(_classNames, "".concat(subMenuPrefixCls, "-open"), open), (0,defineProperty/* default */.A)(_classNames, "".concat(subMenuPrefixCls, "-active"), mergedActive), (0,defineProperty/* default */.A)(_classNames, "".concat(subMenuPrefixCls, "-selected"), childrenSelected), (0,defineProperty/* default */.A)(_classNames, "".concat(subMenuPrefixCls, "-disabled"), mergedDisabled), _classNames)),
...
var Menu = /*#__PURE__*/react.forwardRef(function (props, ref) {
  ...
  var container = /*#__PURE__*/react.createElement(rc_overflow_es, (0,esm_extends/* default */.A)({
    ...
    className: classnames_default()(prefixCls, "".concat(prefixCls, "-root"), "".concat(prefixCls, "-").concat(internalMode), className, (_classNames = {}, (0,defineProperty/* default */.A)(_classNames, "".concat(prefixCls, "-inline-collapsed"), internalInlineCollapsed), (0,defineProperty/* default */.A)(_classNames, "".concat(prefixCls, "-rtl"), isRtl), _classNames), rootClassName),
    dir: direction,
    style: style,
    role: "menu",
    tabIndex: tabIndex,
...
var InternalMenuItemGroup = function InternalMenuItemGroup(_ref) {
  var className = _ref.className,
    ...
    children = _ref.children,
    restProps = (0,objectWithoutProperties/* default */.A)(_ref, MenuItemGroup_excluded);
  var _React$useContext = react.useContext(MenuContext),
    prefixCls = _React$useContext.prefixCls;
...
function MenuItemGroup(_ref2) {
  var children = _ref2.children,
    props = (0,objectWithoutProperties/* default */.A)(_ref2, MenuItemGroup_excluded2);
  ...
  return /*#__PURE__*/react.createElement(InternalMenuItemGroup, (0,omit/* default */.A)(props, ['warnKey']), childList);
}
    ...
    var tabNavBarProps = (0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({}, restProps), {}, {
      ...
      panes: tabs.map(function (_ref2) {
        var label = _ref2.label,
          key = _ref2.key,
          restTabProps = (0,objectWithoutProperties/* default */.A)(_ref2, Wrapper_excluded2);
...
var _EllipsisOutlined = _interopRequireDefault(__webpack_require__(85887));
var _PlusOutlined = _interopRequireDefault(__webpack_require__(25248));
var _classnames = _interopRequireDefault(__webpack_require__(46942));
var _rcTabs = _interopRequireDefault(__webpack_require__(25825));
var React = _interopRequireWildcard(__webpack_require__(96540));
...
/***/ ((module, exports, __webpack_require__) => {
  ...
  var _EllipsisOutlined = _interopRequireDefault(__webpack_require__(4844));
