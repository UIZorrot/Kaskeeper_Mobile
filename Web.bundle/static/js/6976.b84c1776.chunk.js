"use strict";
(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[6976],{
...
/* harmony import */ var antd_lib_spin__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(67472);
...
/* harmony import */ var _ui_components_Empty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(64540);
/* harmony import */ var _ui_components_Styled_Content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(87748);
/* harmony import */ var _ui_components_Styled_Krc20Item__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(51676);
/* harmony import */ var _ui_context_AccountContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(23932);
/* harmony import */ var _ui_pages_MainRoute__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(77980);
...
/* harmony import */ var _ui_state_transactions_hooks__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(37660);
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(48818);
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(37656);
/* harmony import */ var _mui_material_Typography__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(70884);
/* harmony import */ var kaspa_wasm__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(21704);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(92469);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(96651);
/* harmony import */ var _ui_components_TabPaper__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(62656);
...
function Token() {
  const navigate = (0,_ui_pages_MainRoute__WEBPACK_IMPORTED_MODULE_7__/* .useNavigate */ .i)();
  const {
    activeToken
  } = (0,_ui_context_AccountContext__WEBPACK_IMPORTED_MODULE_6__/* .useAccountContext */ .wB)();
  const [activeTab, setActiveTab] = (0,react__WEBPACK_IMPORTED_MODULE_13__.useState)();
  const currentAddressTxs = (0,_ui_state_transactions_hooks__WEBPACK_IMPORTED_MODULE_10__/* .useCurrentAddressTxs */ .wz)();
  const currentTokenTxs = currentAddressTxs.filter(item => item.tick === activeToken.tick);
  const network = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_9__/* .useNetworkType */ .qS)(); // 获取网络类型，NetworkType枚举
  const account = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_8__/* .useAccountAddress */ .mA)();
  ...
  const currentLayer = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_9__/* .useLayerType */ .wl)();
  const addressL2 = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_8__/* .useAccountAddressL2 */ .gt)();
  const krc20list = (0,react__WEBPACK_IMPORTED_MODULE_13__.useCallback)(async () => {
    setLoading(true);
    try {
      const list = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_1__/* .fetch_krc20_oplist */ .mq)(networkName, account, activeToken.mod === 'issue' ? activeToken.ca : activeToken.tick);
  ...
  const getERC20List = (0,react__WEBPACK_IMPORTED_MODULE_13__.useCallback)(async () => {
    ...
    setLoading(true);
    try {
      const res = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_1__/* .fetch_erc20 */ .UF)(network, addressL2, activeToken.contractAddress);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Layout */ ._W, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_2__/* .Header */ .ek, {
      title: "Token Details",
      onBack: () => navigate('MainScreen')
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_ui_components_Styled_Content__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .c, {
      className: "!h-[auto] !pt-0",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .c, {
        className: "space-y-4",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .c, {
          variant: "h5",
          align: "center",
          fontWeight: 700,
          children: [(0,_ui_utils__WEBPACK_IMPORTED_MODULE_11__/* .formatNumber */ .iy)(activeToken === null || activeToken === void 0 ? void 0 : activeToken.balance, activeToken === null || activeToken === void 0 ? void 0 : activeToken.dec), activeToken.tick || activeToken.symbol]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .c, {
          className: "grid grid-cols-1 gap-2",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_ui_components_TabPaper__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .c, {
            tabs: [{
              key: 'receive',
              label: 'Receive'
            }, {
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(antd_lib_spin__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .c, {
          spinning: loading,
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .c, {
            variant: "h5",
            children: "Recent"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .c, {
            children: !(0,lodash__WEBPACK_IMPORTED_MODULE_12__.isEmpty)(fetchListData) ? fetchListData.map((item, index) => {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_ui_components_Styled_Krc20Item__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .c, {
                item: item
              }, index);
            }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_ui_components_Empty__WEBPACK_IMPORTED_MODULE_3__/* .Empty */ .c, {
              className: "mt-4"
            })
          })]
        })]
