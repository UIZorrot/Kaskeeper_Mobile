(self["webpackChunkKaspaWallet"] = self["webpackChunkKaspaWallet"] || []).push([[8792],{
...
/* harmony export */   w: () => (/* binding */ Footer)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _BaseView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66916);
...
function Footer(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_BaseView__WEBPACK_IMPORTED_MODULE_1__/* .BaseView */ .P, {
    style: $style,
    ...rest
  });
}
...
/* harmony export */ });
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73357);
...
const Loading = () => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A, {
      size: 40
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   G: () => (/* binding */ fontSizes)
/* harmony export */ });
const fontSizes = {
  xxxl: 48,
  xxl: 24,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $I: () => (/* binding */ send_kaspa_with_dapp_evm_payload),
/* harmony export */   Ee: () => (/* binding */ verifyMessage),
/* harmony export */   IF: () => (/* binding */ send_eth_transaction),
/* harmony export */   Nt: () => (/* binding */ send_erc20_with_evm_payload),
/* harmony export */   P5: () => (/* binding */ send_erc20_transaction),
/* harmony export */   Zt: () => (/* binding */ eth_address),
/* harmony export */   lT: () => (/* binding */ signMessage),
/* harmony export */   tz: () => (/* binding */ send_kaspa_with_evm_payload)
/* harmony export */ });
/* unused harmony exports prepare_eth_payload, sign_eth_trans_payload, prepare_eth_erc20_payload */
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36212);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(82083);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31191);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(41442);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(99770);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(95642);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(22724);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(77649);
...
function eth_address(privateKeyArg) {
  try {
    ...
    if (!ethers__WEBPACK_IMPORTED_MODULE_1__/* .isHexString */ .Lo(privateKeyArg) || privateKeyArg.length !== 66) {
      throw new Error('Invalid private key format. Must be 64 characters hex string starting with 0x');
    }

    // 创建钱包实例
    const wallet = new ethers__WEBPACK_IMPORTED_MODULE_2__/* .Wallet */ .u(privateKeyArg);

    // 如果需要公钥，可以通过 SigningKey 计算
    const signingKey = new ethers__WEBPACK_IMPORTED_MODULE_3__/* .SigningKey */ .h(privateKeyArg);
...
async function prepare_eth_payload(privateKey, toAddress, amountEth) {
  try {
    // 验证私钥
    if (!ethers__WEBPACK_IMPORTED_MODULE_1__/* .isHexString */ .Lo(privateKey) || privateKey.length !== 66) {
      throw new Error('Invalid private key format. Must be 64 characters hex string starting with 0x');
    }

    // 验证接收地址
    if (!ethers__WEBPACK_IMPORTED_MODULE_4__/* .isAddress */ .PW(toAddress)) {
      throw new Error('Invalid recipient address');
    }

    // 验证金额
    const amount = ethers__WEBPACK_IMPORTED_MODULE_5__/* .parseEther */ .g5(amountEth);
    if (amount <= 0n) {
      throw new Error('Amount must be greater than 0');
    }

    // 创建 provider 和 wallet
    const provider = new ethers__WEBPACK_IMPORTED_MODULE_6__/* .JsonRpcProvider */ .FR(rpcUrl);
    ...
    // 设置 gas 限制
    const gasLimitBigInt = BigInt("21000");
    ...
    const signedTxBytes = ethers__WEBPACK_IMPORTED_MODULE_1__/* .getBytes */ .q5(signedTx); // 转换为字节数组

    // 构造带前缀的 payload
    const payload = new Uint8Array([...new TextEncoder().encode('kasplex'),
    // 前缀 "kasplex"
    0x1,
    // 版本字节：0x0 (JSON) 或 0x1 (Binary)
    ...signedTxBytes // EVM 签名交易字节码
    ]);

    // 将 Uint8Array 转换为十六进制字符串
    return ethers__WEBPACK_IMPORTED_MODULE_1__/* .hexlify */ .c$(payload);
  } catch (error) {
    throw new Error(`Failed to prepare Ethereum transaction: ${error}`);
  }
}
...
async function send_kaspa_with_evm_payload(networkId, privateKeyArg, kaspaAddress, priorityFeeValue, ethToAddress, amountEth) {
  try {
    ...
    const ethPayload = ethers__WEBPACK_IMPORTED_MODULE_1__/* .getBytes */ .q5(ethSignedTx); // 转换为 Uint8Array，已包含 kasplex 和版本字节
    ...
    await RPC.connect();
    const privateKey = new kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.PrivateKey(privateKeyArg.replace('0x', '')); // 去掉 0x
    const publicKey = privateKey.toPublicKey();
    const address = publicKey.toAddress(networkId);
    let kaspaToAddr;
    try {
      kaspaToAddr = new kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.Address(kaspaAddress);
    } catch {
    ...
    throw new Error(`Failed to prepare Kaspa transaction with EVM payload: ${error}`);
  }
}
async function send_eth_transaction(toAddress, amountInEther, privateKey) {
  try {
    ...
    // Create wallet
    const wallet = new ethers__WEBPACK_IMPORTED_MODULE_2__/* .Wallet */ .u(privateKey, provider);
    console.log('Sender address:', wallet.address); // Debug sender

    // Validate address format
    if (!ethers__WEBPACK_IMPORTED_MODULE_4__/* .isAddress */ .PW(toAddress)) {
      throw new Error('Invalid recipient address');
    }
    if (!ethers__WEBPACK_IMPORTED_MODULE_4__/* .isAddress */ .PW(wallet.address)) {
      throw new Error('Invalid from address');
    }

    // Convert amount to wei
    const amount = ethers__WEBPACK_IMPORTED_MODULE_5__/* .parseEther */ .g5(amountInEther);
    console.log('amount:', amount); // Debug sender
    ...
    console.log('Signed transaction:', signedTx); // Debug signed tx
...
async function sign_eth_trans_payload(unsignedTx, privateKeyArg) {
  try {
    // const privateKey = new PrivateKey(privateKeyArg.replace('0x', '')); 
...
async function send_kaspa_with_dapp_evm_payload(unsignedTx, networkId, privateKeyArg, kaspaAddress, priorityFeeValue) {
  ...
  const ethPayload = ethers__WEBPACK_IMPORTED_MODULE_1__/* .getBytes */ .q5(ethSignedTx);
  try {
    // 2. 构造 Kaspa 交易
    const RPC = new kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.RpcClient({
      resolver: new kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.Resolver(),
...
async function prepare_eth_erc20_payload(privateKey, tokenContractAddress, toAddress, amount) {
  try {
    ...
    // 验证代币合约地址
    if (!ethers__WEBPACK_IMPORTED_MODULE_4__/* .isAddress */ .PW(tokenContractAddress)) {
      throw new Error('Invalid token contract address');
    }

    // 验证金额
    const amountBigInt = ethers__WEBPACK_IMPORTED_MODULE_5__/* .parseUnits */ .XS(amount, 18); // 假设代币精度为18，可动态获取
    if (amountBigInt <= 0n) {
      throw new Error('Amount must be greater than 0');
    }
    ...
    const gasLimitBigInt = BigInt("60000"); // 合理估计，实际可通过 estimateGas 动态获取

    // ERC20 合约接口（只需要 transfer 函数的 ABI）
    const erc20Abi = ["function transfer(address to, uint256 amount) public returns (bool)"];
    const tokenContract = new ethers__WEBPACK_IMPORTED_MODULE_7__/* .Contract */ .NZ(tokenContractAddress, erc20Abi, wallet);

    // 构建 transfer 函数的 data
    const data = tokenContract.interface.encodeFunctionData("transfer", [toAddress, amountBigInt]);

    // 构建未签名的交易对象
    const unsignedTx = {
      type: 0,
      // 使用 EIP-1559 交易类型（更现代）
    ...
    throw new Error(`Failed to prepare ERC20 transaction: ${error}`);
  }
}
...
async function send_erc20_transaction(toAddress, amountInTokens, privateKey, contractAddress) {
  try {
    ...
    if (!ethers__WEBPACK_IMPORTED_MODULE_4__/* .isAddress */ .PW(contractAddress)) {
      throw new Error('Invalid contract address');
    }

    // ABI for ERC20 transfer function
    const erc20Abi = ['function transfer(address to, uint256 amount) public returns (bool)', 'function decimals() public view returns (uint8)'];

    // Create contract instance
    const contract = new ethers__WEBPACK_IMPORTED_MODULE_7__/* .Contract */ .NZ(contractAddress, erc20Abi, wallet);

    // Get token decimals
    const decimals = await contract.decimals();

    // Convert amount to token units
    const amount = ethers__WEBPACK_IMPORTED_MODULE_5__/* .parseUnits */ .XS(amountInTokens, decimals);
...
async function signMessage(message, privateKeyArg) {
  try {
    ...
    // 验证私钥
    if (!ethers__WEBPACK_IMPORTED_MODULE_1__/* .isHexString */ .Lo(`0x${privateKey}`) || privateKey.length !== 64) {
      throw new Error('Invalid private key format. Must be 64 characters hex string starting with 0x');
    }

    // 创建 wallet
    const wallet = new ethers__WEBPACK_IMPORTED_MODULE_2__/* .Wallet */ .u(privateKey);
...
async function verifyMessage(message, signature, expectedAddress) {
  try {
    // 验证签名格式
    if (!ethers__WEBPACK_IMPORTED_MODULE_1__/* .isHexString */ .Lo(signature) || signature.length !== 132) {
      throw new Error('Invalid signature format. Must be 65 bytes hex string (130 characters + 0x)');
    }

    // 验证地址格式
    if (!ethers__WEBPACK_IMPORTED_MODULE_4__/* .isAddress */ .PW(expectedAddress)) {
      throw new Error('Invalid Ethereum address');
    }

    // 恢复签名对应的地址
    const recoveredAddress = ethers__WEBPACK_IMPORTED_MODULE_8__/* .verifyMessage */ .l(message, signature);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   G: () => (/* binding */ updateVersion)
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30038);


// fired once when the app reloads but before the app renders
// allows any updates to be applied to store data loaded from localStorage
const updateVersion = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__/* .createAction */ .VP)('global/updateVersion');
...
__webpack_require__.d(__webpack_exports__, {
  kn: () => (/* binding */ extensionIsInTab),
  bw: () => (/* binding */ getCurrentTab),
  _A: () => (/* binding */ openExtensionInTab),
  VI: () => (/* binding */ useExtensionIsInTab),
  pI: () => (/* binding */ useOpenExtensionInTab)
});
...
var constant = __webpack_require__(77093);
;// ./src/background/webapi/browser.ts
...
async function browserTabsCreate(params) {
  if (constant/* MANIFEST_VERSION */.hh === 'mv2') {
    return new Promise((resolve, reject) => {
...
const openExtensionInTab = async path => {
  const url = webapi_browser.runtime.getURL(`index.html${path || ''}`);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5005);
/* harmony import */ var _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74680);
/* harmony import */ var _mui_material_Button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(86990);
...
const $baseViewStyle = {
  ...
  cursor: 'pointer',
  alignSelf: 'stretch',
  paddingLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.small,
  paddingRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.small
};
const $viewPresets = {
  default: Object.assign({}, $baseViewStyle, {
    backgroundColor: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.black_dark
  }),
  primary: Object.assign({}, $baseViewStyle, {
    backgroundColor: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.aqua,
    height: '40px'
  }),
  danger: Object.assign({}, $baseViewStyle, {
    backgroundColor: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.red,
    height: '40px'
  }),
  bar: Object.assign({}, $baseViewStyle, {
    ...
    paddingTop: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.medium,
    paddingBottom: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.medium
  })
};
const $hoverViewPresets = {
  ...
  primary: {
    backgroundColor: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.aqua_dark
  },
  danger: {
    backgroundColor: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.red_dark
  },
  bar: {
    backgroundColor: '#383535'
  }
...
const $baseTextStyle = {
  ...
  zIndex: 2,
  //color: colors.white,
  paddingLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.tiny,
  paddingRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.tiny
};
const $textPresets = {
  default: $baseTextStyle,
  primary: Object.assign({}, $baseTextStyle, {
    color: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.black
  }),
  danger: Object.assign({}, $baseTextStyle, {
    color: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.white
  }),
...
const $rightAccessoryStyle = {
  marginLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.extraSmall,
  zIndex: 1
};
const $leftAccessoryStyle = {
  marginRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_2__/* .spacing */ .YK.extraSmall,
  zIndex: 1
};
...
function Button(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_mui_material_Button__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A, {
    variant: "contained",
    color: "primary",
    size: "large",
    ...props,
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var redux_localstorage_simple__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25338);
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(30038);
/* harmony import */ var _reduxjs_toolkit_query_react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(46802);
/* harmony import */ var _accounts_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(43182);
/* harmony import */ var _global_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4294);
/* harmony import */ var _global_reducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44241);
/* harmony import */ var _keyrings_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(89872);
/* harmony import */ var _settings_reducer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(11167);
/* harmony import */ var _transactions_reducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(51195);
...
const store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_7__/* .configureStore */ .U1)({
  reducer: {
    accounts: _accounts_reducer__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay,
    transactions: _transactions_reducer__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Ay,
    settings: _settings_reducer__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Ay,
    global: _global_reducer__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay,
    keyrings: _keyrings_reducer__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Ay
  },
  middleware: getDefaultMiddleware => getDefaultMiddleware({
    thunk: true
  }).concat((0,redux_localstorage_simple__WEBPACK_IMPORTED_MODULE_0__/* .save */ .UN)({
    states: PERSISTED_KEYS,
    namespace: 'kaspa-wallet'
  })),
  preloadedState: (0,redux_localstorage_simple__WEBPACK_IMPORTED_MODULE_0__/* .load */ .Hh)({
    states: PERSISTED_KEYS,
...
store.dispatch((0,_global_actions__WEBPACK_IMPORTED_MODULE_2__/* .updateVersion */ .G)());
(0,_reduxjs_toolkit_query_react__WEBPACK_IMPORTED_MODULE_8__/* .setupListeners */ .$k)(store.dispatch);
...
/* harmony import */ var _Image__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39818);
/* harmony import */ var _Row__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(51942);
/* harmony import */ var _Text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20577);
...
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30038);
...
const initialState = {
  locale: 'English',
  addressType: _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111,
  networkType: _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .z1.Mainnet,
  rpcLinks: _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .NETWORK_TYPES */ .rg,
  walletConfig: {
    version: '',
  ...
  skippedVersion: '',
  layerType: _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .LayerType */ .mb.L1
};
const slice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__/* .createSlice */ .Z0)({
  name: 'settings',
  initialState,
  reducers: {
  ...
  extraReducers: builder => {
    builder.addCase(_global_actions__WEBPACK_IMPORTED_MODULE_2__/* .updateVersion */ .G, state => {
      // todo
      if (!state.networkType) {
        state.networkType = _shared_types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .z1.Mainnet;
      }
    });
  }
});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  rh: () => (/* reexport */ WalletProvider),
  UC: () => (/* binding */ amountToSompi),
  lW: () => (/* binding */ copyToClipboard),
  ZV: () => (/* reexport */ parse/* formatNumber */.ZV),
  nR: () => (/* binding */ generateHdPath),
  dA: () => (/* binding */ getUiType),
  IU: () => (/* binding */ handleTransactions),
  q9: () => (/* binding */ handleTransactionsAddresses),
  yJ: () => (/* reexport */ mathUtils/* isGreaterThan */.yJ),
  kf: () => (/* reexport */ parse/* isNumeric */.kf),
  $m: () => (/* binding */ isValidAddress),
  IR: () => (/* binding */ isValidEthereumAddress),
  M$: () => (/* binding */ isValidWalletAddress),
  aj: () => (/* binding */ openUrlLink),
  Ff: () => (/* reexport */ parse/* parseTokenBalance */.Ff),
  XS: () => (/* reexport */ parse/* parseUnits */.XS),
  Dc: () => (/* binding */ shortAddress),
  sv: () => (/* binding */ shortDesc),
  yy: () => (/* binding */ sleep),
  _m: () => (/* binding */ sompiToAmount),
  jF: () => (/* binding */ sompiToKAS),
  Db: () => (/* binding */ sompiToKas),
  Hn: () => (/* reexport */ mathUtils/* times */.Hn),
  V9: () => (/* reexport */ useApproval),
  ac: () => (/* binding */ useLocationState),
  vT: () => (/* reexport */ useWallet),
  QK: () => (/* reexport */ useWalletRequest),
  u_: () => (/* binding */ validateERC20Token)
});
...
var parse = __webpack_require__(29530);
// EXTERNAL MODULE: ./src/ui/utils/mathUtils.ts
var mathUtils = __webpack_require__(34886);
...
function sompiToAmount(val) {
  ...
  const num = new bignumber/* default */.A(val);
...
const openUrlLink = function (url) {
  ...
  // if (isApp()) {
  //   const { NativeCallbacks } = window as any;
  //   // app
  //   const params = {
  //     action: 'openBrowser',
  //     payload: {
  ...
  //     },
  //   }
  //   return NativeCallbacks?.register(params);
  // }
...
const validateERC20Token = async (tokenAddress, networkType) => {
  const rpc = {
    [types/* NetworkType */.z1.Mainnet]: constant/* OPENAPI_RPC_MAINNET_L2 */.jy,
    [types/* NetworkType */.z1.Testnet]: constant/* OPENAPI_RPC_TESTNET_L2 */.Gj,
    [types/* NetworkType */.z1.Devnet]: constant/* OPENAPI_RPC_DEVNET_L2 */.nX
  }[networkType] || '';
  try {
    const baseUrl = networkType === types/* NetworkType */.z1.Mainnet ? constant/* OPENAPI_URL_MAINNET_L2 */.Zm : networkType === types/* NetworkType */.z1.Testnet ? constant/* OPENAPI_URL_TESTNET_L2 */.YL : constant/* OPENAPI_URL_DEVNET_L2 */.B9;
    const response = await fetch(`${baseUrl}/api/v2/tokens/${tokenAddress}`);
...
/* harmony import */ var localforage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73790);
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Dm: () => (/* binding */ useSafeBalance),
/* harmony export */   Eh: () => (/* binding */ useCurrentAddressTxs),
/* harmony export */   II: () => (/* binding */ useFetchUtxosCallback),
/* harmony export */   NC: () => (/* binding */ usePrepareSendKASCallback),
/* harmony export */   NK: () => (/* binding */ usePushKaspaTxCallback),
/* harmony export */   cU: () => (/* binding */ useFetchTxActivitiesCallback),
/* harmony export */   di: () => (/* binding */ useUtxos),
/* harmony export */   o2: () => (/* binding */ useKaspaTx)
/* harmony export */ });
...
/* harmony import */ var _accounts_hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(43658);
/* harmony import */ var _accounts_reducer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43182);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(75049);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(51195);
...
function useTransactionsState() {
  return (0,_hooks__WEBPACK_IMPORTED_MODULE_6__/* .useAppSelector */ .G)(state => state.transactions);
}
function useKaspaTx() {
...
function useCurrentAddressTxs() {
  const transactionsState = useTransactionsState();
  const fromAddress = (0,_accounts_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useAccountAddress */ .PJ)();
...
function usePrepareSendKASCallback() {
  const dispatch = (0,_hooks__WEBPACK_IMPORTED_MODULE_6__/* .useAppDispatch */ .j)();
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async _ref => {
    ...
    if (safeBalance < toAmount) {
      throw new Error(`Insufficient balance. Balance(${(0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sompiToAmount */ ._m)(safeBalance)} KAS) is lower than ${(0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sompiToAmount */ ._m)(toAmount)} KAS `);
    }
    if (!feeRate) {
    ...
    // psbtHex = '';
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .transactionsActions */ .$A.updateKaspaTx({
      rawtx,
      psbtHex,
      fromAddress,
      feeRate
...
function usePushKaspaTxCallback() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async rawtx => {
    ...
    try {
      ...
      await (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sleep */ .yy)(3); // Wait for transaction synchronization
      tools.showLoading(false);
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .transactionsActions */ .$A.updateKaspaTx({
        txid
      }));
      dispatch(_accounts_reducer__WEBPACK_IMPORTED_MODULE_5__/* .accountActions */ .$G.expireBalance());
      setTimeout(() => {
        dispatch(_accounts_reducer__WEBPACK_IMPORTED_MODULE_5__/* .accountActions */ .$G.expireBalance());
      }, 2000);
      setTimeout(() => {
...
function useFetchUtxosCallback() {
  const dispatch = (0,_hooks__WEBPACK_IMPORTED_MODULE_6__/* .useAppDispatch */ .j)();
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .useWallet */ .vT)();
  const account = (0,_accounts_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useCurrentAccount */ .YL)();
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
    const data = await wallet.getKASUtxos();
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .transactionsActions */ .$A.setUtxos(data));
...
function useFetchTxActivitiesCallback() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
    ...
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .transactionsActions */ .$A.setTxActivities(data));
    if (incomingTx) dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .transactionsActions */ .$A.setIncomingTx(false));
    // dispatch(transactionsActions.setKasUtxos(kasUtxosStr));
    return data;
  }, [wallet, account]);
}
function useSafeBalance() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    ...
    return (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sompiToAmount */ ._m)(sompi);
  }, [utxos]);
}
__webpack_async_result__();
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  T: () => (/* binding */ ActionComponentProvider),
  D: () => (/* binding */ useTools)
});
...
var spacing = __webpack_require__(74680);
...
function Loading(props) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      style: $baseViewStyle,
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(LoadingOutlined/* default */.A, {
        style: {
          fontSize: font/* fontSizes */.G.icon,
          color: colors/* colors */.T.orange
        }
      }), text && /*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.EY, {
        text: text,
        preset: "title",
        color: "orange"
      })]
...
const $viewPresets = {
  info: Object.assign({}, Toast_$baseViewStyle, {
    color: `${colors/* colors */.T.black_dark} !important`,
    background: '#FFF',
  ...
  success: Object.assign({}, Toast_$baseViewStyle, {
    color: `${colors/* colors */.T.green} !imporatnt`,
    background: '#FFF',
    boxShadow: '3px 3px 12px rgba(0,0,0, 0.2)',
    width: '90%',
    padding: '16px'
  ...
  error: Object.assign({}, Toast_$baseViewStyle, {
    color: `${colors/* colors */.T.danger} !important`,
    background: '#FFF',
    boxShadow: '3px 3px 12px rgba(0,0,0, 0.2)',
    width: '90%',
    padding: '16px'
  ...
  warning: Object.assign({}, Toast_$baseViewStyle, {
    color: `${colors/* colors */.T.warning} !important`,
    background: '#FFF',
    boxShadow: '3px 3px 12px rgba(0,0,0, 0.2)',
    width: '90%',
    padding: '16px'
...
;// ./src/ui/components/ActionComponent/index.tsx
/* eslint-disable no-unused-vars */
/* eslint-disable @typescript-eslint/no-unused-vars */
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  QB: () => (/* binding */ utils_Message),
  A0: () => (/* binding */ getKaspaUTXOWithoutBigint)
});
...
// EXTERNAL MODULE: ./src/shared/constant/index.ts
var constant = __webpack_require__(77093);
// EXTERNAL MODULE: ./node_modules/eth-rpc-errors/dist/index.js
var dist = __webpack_require__(12203);
  ...
  constructor() {
    ...
    this.request = data => {
      if (!this._requestIdPool.length) {
        throw dist/* ethErrors */.Ls.rpc.limitExceeded();
      }
    ...
    this._dispose = () => {
      for (const request of this._waitingMap.values()) {
        request.reject(dist/* ethErrors */.Ls.provider.userRejectedRequest());
      }
...
const chainsDict = (0,lodash.keyBy)(constant/* CHAINS */.rY, 'serverId');
...
const $textAreaStyle = {
  backgroundColor: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T.bg2,
  flexWrap: 'wrap',
  padding: 10,
  userSelect: 'text',
  maxHeight: 384,
  ...
  fontSize: _ui_theme_font__WEBPACK_IMPORTED_MODULE_2__/* .fontSizes */ .G.xs
};
function TextArea(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_BaseView__WEBPACK_IMPORTED_MODULE_3__/* .BaseView */ .P, {
    style: $style,
    ...rest,
    children: text
  });
...
var BaseView = __webpack_require__(66916);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./src/ui/components/Text/index.tsx
...
function Text(props) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(BaseView/* BaseView */.P, {
    style: $style,
    ...rest,
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   z: () => (/* binding */ NodeStatus)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(87164);
/* harmony import */ var _ui_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(72260);
/* harmony import */ var _ui_features_browser_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5579);
...
const NodeStatus = props => {
  ...
  const networkType = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_3__/* .useNetworkType */ .iP)();
  ...
  const [rpcStatus, setRpcStatus] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const run = async () => {
      const activeTab = await (0,_ui_features_browser_tabs__WEBPACK_IMPORTED_MODULE_2__/* .getCurrentTab */ .bw)();
      if (!activeTab) return;
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
    className: "space-y-6",
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
      className: "px-4 rounded-lg flex flex-col items-center space-y-6",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
        className: "flex items-center justify-center space-x-2",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
          sx: {
            width: '10px',
            height: '10px',
            borderRadius: '50%',
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Text */ .EY, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Text */ .EY, {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Um: () => (/* binding */ useAccountContext),
/* harmony export */   uz: () => (/* binding */ AccountContextProvider)
/* harmony export */ });
/* unused harmony export AccountContext */
/* harmony import */ var _ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43658);
/* harmony import */ var _ui_state_accounts_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(43182);
/* harmony import */ var _ui_state_hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(75049);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(96540);
/* harmony import */ var _state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(43168);
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13108);
/* harmony import */ var _background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(28454);
...
function AccountContextProvider(_ref) {
  ...
  const address = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__/* .useAccountAddress */ .PJ)();
  const network = (0,_state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useNetworkType */ .iP)();
  ...
  const dispatch = (0,_ui_state_hooks__WEBPACK_IMPORTED_MODULE_2__/* .useAppDispatch */ .j)();
  ...
  const addressL2 = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__/* .useAccountAddressL2 */ .N1)();
  const currentLayer = (0,_state_settings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useLayerType */ .pI)();
  const fetchKrc20Tokens = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(async () => {
    ...
    // networkType 0正式 1测试
    if (!networkType) {
      result = await fetch(`https://api.kasplex.org/v1/krc20/address/${address}/tokenlist`);
    } else {
      result = await fetch(`https://tn10api.kasplex.org/v1/krc20/address/${address}/tokenlist`);
    }
    ...
    const list = await Promise.all((_jsonData$result = jsonData.result) === null || _jsonData$result === void 0 ? void 0 : _jsonData$result.map(async item => {
      ...
      if (item.ca) {
        const issueInfo = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_6__/* .get_krc20_issue_info */ .lW)(networkType, item.ca);
      ...
      if (networkType === 1) {
        // 获取krc20的图标
        const iconInfo = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_6__/* .get_krc20_icon_url */ .Me)(data.tick); // 'TAURUS'
  ...
  const fetchErc20Tokens = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(async () => {
    ...
    // erc20 list
    try {
      // const res = await wallet.getERC20ListByAddress(addressL2)
      const res1 = await (0,_background_krc20_ActiveUTXO__WEBPACK_IMPORTED_MODULE_6__/* .get_erc20_list_by_address */ .GX)(network, addressL2);
      let unknownIndex = 0;
      const list = res1.data.items.map(item => {
        const {
          value,
          token
        } = item;
      ...
      // const list:any = await Promise.all(res.map(async (item:any) => {
      //   const balance = await getERCBalance(item.contractAddress, addressL2, network)
      //   return {
      //     ...item,
      //     dec: item.decimals,
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    ...
    fetch('https://api.kaspa.org/info/price').then(response => response.json()).then(data => {
      ...
      if (price && price > 0) dispatch(_ui_state_accounts_reducer__WEBPACK_IMPORTED_MODULE_1__/* .accountActions */ .$G.setKasPrice(price));
    });
  }, []);
...
/* harmony export */   GX: () => (/* binding */ get_erc20_list_by_address),
/* harmony export */   Me: () => (/* binding */ get_krc20_icon_url),
/* harmony export */   c5: () => (/* binding */ fetch_tx),
/* harmony export */   ip: () => (/* binding */ fetch_krc20_oplist),
/* harmony export */   kk: () => (/* binding */ fetch_erc20),
/* harmony export */   lW: () => (/* binding */ get_krc20_issue_info),
...
async function fetch_krc20_list(network, address) {
  ...
  try {
    const res = await axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${rest_api_url_krc20(network)}krc20/address/${address}/tokenlist`, {
      headers,
      withCredentials: true // 如果需要处理跨域请求
    });
...
async function fetch_krc20_oplist(network, address, tick) {
  ...
  try {
    const res = await axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${rest_api_url_krc20(network)}krc20/oplist?address=${address}&tick=${tick}`, {
      headers
      // withCredentials: true, // 如果需要处理跨域请求
    });
    return res.data.result; // 返回实际数据
...
async function fetch_erc20(networkType, address, tokenAddress) {
  const baseUrl = networkType === _shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Mainnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_MAINNET_L2 */ .Zm : networkType === _shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Testnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_TESTNET_L2 */ .YL : _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_DEVNET_L2 */ .B9;
  return axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${baseUrl}/api/v2/addresses/${address}/token-transfers`, {
    params: {
      token: tokenAddress,
      type: 'ERC-20',
...
async function get_erc20_list_by_address(networkType, address) {
  const baseUrl = networkType === _shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Mainnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_MAINNET_L2 */ .Zm : networkType === _shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Testnet ? _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_TESTNET_L2 */ .YL : _shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .OPENAPI_URL_DEVNET_L2 */ .B9;
  return axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${baseUrl}/api/v2/addresses/${address}/tokens`, {
    params: {
      type: 'ERC-20'
    }
  });
...
async function fetch_Activity(network, address, limit, offest) {
  ...
  try {
    const res = await axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${rest_api_url(network)}addresses/${address}/full-transactions?limit=${limit}&offset=${offest}`, {
      // headers,
      // withCredentials: true, // 如果需要处理跨域请求
    });
    return res.data; // 返回实际数据
...
async function fetch_tx(network, tx) {
  ...
  try {
    const res = await axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${rest_api_url(network)}transactions/${tx}`, {
      headers,
      withCredentials: true // 如果需要处理跨域请求
    });
    return res.data; // 返回实际数据
...
const get_krc20_issue_info = async (network, krc20_issue_ca) => {
  try {
    ...
    const res = await axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`${get_api_base_url_krc20(network)}krc20/token/${krc20_issue_ca}`, {
      // headers,
      // withCredentials: true, // 如果需要处理跨域请求
    });
...
const get_krc20_icon_url = async tick => {
  try {
    const res = await axios__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.get(`https://api-v2-do.kas.fyi/token/krc20/${tick}/info`);
    return res.data;
  } catch (error) {
    console.error(error);
    return {};
...
function get_api_base_url_krc20(network) {
  if (network === _shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Testnet) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ff: () => (/* binding */ parseTokenBalance),
/* harmony export */   XS: () => (/* binding */ parseUnits),
/* harmony export */   ZV: () => (/* binding */ formatNumber),
/* harmony export */   kf: () => (/* binding */ isNumeric)
/* harmony export */ });
/* unused harmony export rest_api_url */
/* harmony import */ var bignumber_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60346);
/* harmony import */ var _mathUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(34886);
...
function parseUnits(value, precision) {
  let roundingMode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.ROUND_DOWN;
  if (!isNumeric(value) || !precision) {
    return '0';
  }
  try {
    return new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A((0,_mathUtils__WEBPACK_IMPORTED_MODULE_1__/* .toDecimalPlaces */ .n2)(value, precision, roundingMode)).times(new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(10).pow(precision)).toFixed();
  } catch (error) {
...
function parseTokenBalance(value) {
  ...
  return new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value).div(new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(10).pow(decimals)).decimalPlaces(2, bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.ROUND_DOWN).toString();
}
function formatNumber(value) {
  ...
  try {
    const _value = new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value).div(new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(10).pow(decimals)).decimalPlaces(4, bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.ROUND_DOWN);
    let n = new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(_value).toFixed(4);
    const p = n.indexOf('.');
    const originalValue = new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value);
    const threshold = new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(1).dividedBy(new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(10).pow(precision));
    if (originalValue.lt(threshold)) {
      n = `<${threshold.toFixed(precision)}`;
    }
...
/* harmony import */ var _Column__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98505);
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43264);
...
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(50329);
...
function Header(props) {
  ...
  const navigate = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_7__/* .useNavigate */ .Zp)();
  const CenterComponent = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (children) {
      return children;
    } else if (title) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_4__/* .Text */ .EY, {
        text: title,
        preset: "regular-bold",
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
      className: "flex justify-between items-center p-4 space-x-2",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
        className: "space-x-2",
        children: [LeftComponent, onBack && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
          onClick: e => {
            // onBack();
            navigate(-1);
          },
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Icon__WEBPACK_IMPORTED_MODULE_2__/* .Icon */ .I, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_ant_design_icons__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, {
              style: {
                fontSize: 16,
                color: '#0A2463'
              }
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Row__WEBPACK_IMPORTED_MODULE_3__/* .Row */ .f, {
        itemsCenter: true,
        children: CenterComponent
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Row__WEBPACK_IMPORTED_MODULE_3__/* .Row */ .f, {
        full: true,
        justifyEnd: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Column__WEBPACK_IMPORTED_MODULE_1__/* .Column */ .V, {
...
/* harmony export */   Rd: () => (/* binding */ minus),
/* harmony export */   n2: () => (/* binding */ toDecimalPlaces),
/* harmony export */   yJ: () => (/* binding */ isGreaterThan)
/* harmony export */ });
...
/* harmony import */ var bignumber_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60346);
/* harmony import */ var _parse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29530);
...
function minus(value1, value2) {
  // if (import.meta.env.MODE === Env.production) {
  if (!(0,_parse__WEBPACK_IMPORTED_MODULE_1__/* .isNumeric */ .kf)(value1) || !(0,_parse__WEBPACK_IMPORTED_MODULE_1__/* .isNumeric */ .kf)(value2)) return '0';
  // }
  return new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value1).minus(value2).toString();
}
function times(value1, value2) {
  // if (import.meta.env.MODE === Env.production) {
  if (!(0,_parse__WEBPACK_IMPORTED_MODULE_1__/* .isNumeric */ .kf)(value1) || !(0,_parse__WEBPACK_IMPORTED_MODULE_1__/* .isNumeric */ .kf)(value2)) return '0';
  // }
  return new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value1).times(value2).toString();
}
...
function isGreaterThan(value1, value2) {
  if (!(0,_parse__WEBPACK_IMPORTED_MODULE_1__/* .isNumeric */ .kf)(value1) || !(0,_parse__WEBPACK_IMPORTED_MODULE_1__/* .isNumeric */ .kf)(value2)) return false;
  return new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value1).gt(value2);
}
...
function toDecimalPlaces(value) {
  ...
  let roundingMode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.ROUND_DOWN;
  try {
    const num = new bignumber_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(value).toFixed(precision, roundingMode);
    return num;
  } catch (e) {
    return String(value || '-');
  }
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C3: () => (/* binding */ useKeyrings),
/* harmony export */   KZ: () => (/* binding */ useCurrentKeyring)
/* harmony export */ });
/* unused harmony export useKeyringsState */
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75049);
...
function useKeyringsState() {
  return (0,_hooks__WEBPACK_IMPORTED_MODULE_0__/* .useAppSelector */ .G)(state => state.keyrings);
}
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74680);
/* harmony import */ var _BaseView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(66916);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74848);
...
const $baseViewStyle = {
  display: 'flex',
  flexDirection: 'row',
  gap: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.md,
  alignItems: 'center',
  justifyContent: 'center',
  borderRadius: 5
};
const $viewPresets = {
  auto: Object.assign({}, $baseViewStyle, {
    paddingTop: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.lg,
    paddingBottom: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.lg,
    paddingLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.lg,
    paddingRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.lg,
    minHeight: 50
  }),
  style1: Object.assign({}, $baseViewStyle, {
    height: '75px',
    paddingTop: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.sm,
    paddingBottom: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.sm,
    paddingLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.lg,
    paddingRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.lg
  }),
  ...
  style3: Object.assign({}, $baseViewStyle, {
    paddingTop: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.xs,
    paddingBottom: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.xs,
    paddingLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.sm,
    paddingRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ.sm
  })
};
function Card(props) {
  const {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_BaseView__WEBPACK_IMPORTED_MODULE_2__/* .BaseView */ .P, {
    style: $style,
    ...rest
  });
}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _: () => (/* binding */ Image)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
...
function Image(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("img", {
    ...
    style: Object.assign({}, $imageStyleOverride, {
      width: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_1__/* .fontSizes */ .G.icon,
      height: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_1__/* .fontSizes */ .G.icon
    })
  });
}
...
function Grid(props) {
  ...
  const $style = Object.assign({}, $gridStyle, $styleOverride, gap ? {
    gap: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_1__/* .spacingGap */ .IQ[gap]
  } : {}, columns ? {
...
const $viewPresets = {
  large: Object.assign({}, $contentStyle, {
    alignItems: 'stretch',
    padding: spacing/* spacing */.YK.large,
    paddingTop: 0
  }),
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  oM: () => (/* binding */ useBlockstreamUrl),
  AU: () => (/* binding */ useChangeLayerTypeCallback),
  FM: () => (/* binding */ useChangeLocaleCallback),
  Xj: () => (/* binding */ useChangeNetworkTypeCallback),
  FJ: () => (/* binding */ useChangeRpcLinksCallback),
  pI: () => (/* binding */ useLayerType),
  Ym: () => (/* binding */ useLocale),
  iP: () => (/* binding */ useNetworkType),
  YD: () => (/* binding */ useRpcLinks),
  E2: () => (/* binding */ useSkipVersionCallback),
  kd: () => (/* binding */ useVersionInfo),
  pF: () => (/* binding */ useWalletConfig)
});

// UNUSED EXPORTS: useAddressType, useKaswareWebsite, useSettingsState, useTxIdUrl

// EXTERNAL MODULE: ./node_modules/compare-versions/index.mjs
var compare_versions = __webpack_require__(83362);
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
// EXTERNAL MODULE: ./src/shared/constant/index.ts
var constant = __webpack_require__(77093);
...
var context = __webpack_require__(65414);
// EXTERNAL MODULE: ./build/_raw/_locales/en/messages.json
var messages = __webpack_require__(48812);
...
i18next/* default.use */.Ay.use(context/* initReactI18next */.r9) // passes i18n down to react-i18next
.init({
  fallbackLng: 'en',
...
const addResourceBundle = async locale => {
  if (i18next/* default */.Ay.hasResourceBundle(locale, I18N_NS)) return;
  const bundle = await fetchLocale(locale);
  i18next/* default */.Ay.addResourceBundle(locale, 'translations', bundle);
};
addResourceBundle('en');
i18next/* default */.Ay.on('languageChanged', function (lng) {
  addResourceBundle(lng);
});
/* harmony default export */ const i18n = (i18next/* default */.Ay);
// EXTERNAL MODULE: ./src/ui/state/hooks.ts
var hooks = __webpack_require__(75049);
// EXTERNAL MODULE: ./src/ui/state/settings/reducer.ts
var reducer = __webpack_require__(11167);
...
function useSettingsState() {
  return (0,hooks/* useAppSelector */.G)(state => state.settings);
}
function useLocale() {
...
function useChangeLocaleCallback() {
  const dispatch = (0,hooks/* useAppDispatch */.j)();
  const wallet = (0,utils/* useWallet */.vT)();
  return (0,react.useCallback)(async locale => {
    await wallet.setLocale(locale);
    await addResourceBundle(locale);
    i18n.changeLanguage(locale);
    dispatch(reducer/* settingsActions */.dr.updateSettings({
      locale
    }));
...
function useBlockstreamUrl() {
  ...
  if (currentLayer === 'L1') {
    if (networkType === types/* NetworkType */.z1.Mainnet) {
  ...
  if (currentLayer === 'L2') {
    if (networkType === types/* NetworkType */.z1.Mainnet) {
      return constant/* OPENAPI_URL_MAINNET_L2 */.Zm;
    } else {
      return constant/* OPENAPI_URL_TESTNET_L2 */.YL;
    }
  }
}
...
function useVersionInfo() {
  ...
  const currentVesion = constant/* VERSION */.xv;
  let skipped = false;
  let latestVersion = '';
  ...
  if (newVersion) {
    if ((0,compare_versions/* default */.Ay)(currentVesion, newVersion) >= 0) {
      skipped = true;
    } else {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $G: () => (/* binding */ accountActions),
/* harmony export */   Ay: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony export initialState */
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30038);
/* harmony import */ var _global_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4294);
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable no-unused-vars */
/* eslint-disable @typescript-eslint/no-unused-vars */
...
const slice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__/* .createSlice */ .Z0)({
  ...
  extraReducers: builder => {
    builder.addCase(_global_actions__WEBPACK_IMPORTED_MODULE_0__/* .updateVersion */ .G, state => {
      // todo
...
function Icon(props) {
  ...
  if (!icon) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
      onClick: onClick,
      style: Object.assign({}, {
        color: color ? _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T[color] : '#000',
        fontSizes: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_2__/* .fontSizes */ .G.icon,
        display: 'flex'
  ...
  if (iconImgList.includes(icon)) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("img", {
      ...
      style: Object.assign({}, $containerStyleOverride, {
        width: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_2__/* .fontSizes */ .G.icon,
        height: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_2__/* .fontSizes */ .G.icon
      })
    });
  }
  if (iconPath) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
        ...
        style: Object.assign({}, {
          ...
          width: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_2__/* .fontSizes */ .G.icon,
          height: size || _ui_theme_font__WEBPACK_IMPORTED_MODULE_2__/* .fontSizes */ .G.icon,
          backgroundColor: color ? _ui_theme_colors__WEBPACK_IMPORTED_MODULE_1__/* .colors */ .T[color] : '#000',
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $f: () => (/* binding */ useAppSummary),
/* harmony export */   FN: () => (/* binding */ useSetCurrentAccountCallback),
/* harmony export */   Fg: () => (/* binding */ useReloadAccounts),
/* harmony export */   KZ: () => (/* reexport safe */ _keyrings_hooks__WEBPACK_IMPORTED_MODULE_4__.KZ),
/* harmony export */   N1: () => (/* binding */ useAccountAddressL2),
/* harmony export */   N2: () => (/* binding */ useUserPrivateKey),
/* harmony export */   P0: () => (/* binding */ useFetchBalanceCallback),
/* harmony export */   PJ: () => (/* binding */ useAccountAddress),
/* harmony export */   S2: () => (/* binding */ useFetchKeyringsBalancesCallback),
/* harmony export */   Wv: () => (/* binding */ useKasPrice),
/* harmony export */   YL: () => (/* binding */ useCurrentAccount),
/* harmony export */   kg: () => (/* binding */ useUnreadAppSummary),
/* harmony export */   kw: () => (/* binding */ useAccountEthBalance),
/* harmony export */   lx: () => (/* binding */ useReadTab),
/* harmony export */   pc: () => (/* binding */ useAccountBalance),
/* harmony export */   qT: () => (/* binding */ useFetchBalancesCallback),
/* harmony export */   tb: () => (/* binding */ useReadApp)
/* harmony export */ });
...
/* harmony import */ var _shared_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(59577);
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13108);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(75049);
/* harmony import */ var _keyrings_hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36904);
/* harmony import */ var _keyrings_reducer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(89872);
/* harmony import */ var _settings_reducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(11167);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(43182);
/* harmony import */ var _background_krc20_l2__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3146);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2543);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(41442);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(95642);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(99770);
/* harmony import */ var _shared_constant__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(77093);
...
function useAccountsState() {
  return (0,_hooks__WEBPACK_IMPORTED_MODULE_3__/* .useAppSelector */ .G)(state => state.accounts);
}
...
async function useAccountEthBalance(address, networkType) {
  try {
    if (!ethers__WEBPACK_IMPORTED_MODULE_11__/* .isAddress */ .PW(address)) {
      throw new Error('Invalid Ethereum address');
    }
    const rpc = {
      [_shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Mainnet]: _shared_constant__WEBPACK_IMPORTED_MODULE_10__/* .OPENAPI_RPC_MAINNET_L2 */ .jy,
      [_shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Testnet]: _shared_constant__WEBPACK_IMPORTED_MODULE_10__/* .OPENAPI_RPC_TESTNET_L2 */ .Gj,
      [_shared_types__WEBPACK_IMPORTED_MODULE_1__/* .NetworkType */ .z1.Devnet]: _shared_constant__WEBPACK_IMPORTED_MODULE_10__/* .OPENAPI_RPC_DEVNET_L2 */ .nX
    }[networkType] || '';
    const providerUrl = rpc;
    const provider = new ethers__WEBPACK_IMPORTED_MODULE_12__/* .JsonRpcProvider */ .FR(providerUrl);
    const balanceWei = await provider.getBalance(address);
    const balance = ethers__WEBPACK_IMPORTED_MODULE_13__/* .formatEther */ .ck(balanceWei);
    return {
      balance,
      balanceWei
    };
  } catch (error) {
    throw new Error(`Failed to obtain the balance: ${error instanceof Error ? error.message : 'Unknown erro'}`);
  }
}
...
function useReadTab() {
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .useWallet */ .vT)();
  const dispatch = (0,_hooks__WEBPACK_IMPORTED_MODULE_3__/* .useAppDispatch */ .j)();
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async name => {
    ...
    if (name == 'app') {
      ...
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setAppSummary(appSummary));
    }
...
function useSetCurrentAccountCallback() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(account => {
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setCurrent(account));
  }, [dispatch]);
}
...
function useFetchBalanceCallback() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
    ...
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setBalance({
    ...
    if (cachedBalance.amount !== _accountBalance.amount) {
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.expireHistory());
    }
    const summary = await wallet.getAddressSummary(currentAccount.address);
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setAddressSummary(summary));
...
function useFetchBalancesCallback() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
    ...
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setBalances(balanceArray));
  }, [dispatch, wallet, accounts]);
}
function useFetchKeyringsBalancesCallback() {
  const dispatch = (0,_hooks__WEBPACK_IMPORTED_MODULE_3__/* .useAppDispatch */ .j)();
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .useWallet */ .vT)();
  const keyrings = (0,_keyrings_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useKeyrings */ .C3)();
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
    for (let i = 0; i < keyrings.length; i++) {
      ...
      dispatch(_keyrings_reducer__WEBPACK_IMPORTED_MODULE_5__/* .keyringsActions */ .kk.setKeyringBalanceKas({
        key: keyrings[i].key,
        balanceKas
      }));
    }
...
function useReloadAccounts() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
      ...
      await Promise.all(keyrings.map(async (keyring, i) => {
        ...
        if (keyring !== null && keyring !== void 0 && (_keyring$accounts = keyring.accounts) !== null && _keyring$accounts !== void 0 && _keyring$accounts.length) {
          const newAccounts = await Promise.all(keyring.accounts.map(async item => {
            if (!item.addressL2) {
              const privateKey = await wallet.getPrivateKeyAny(item);
              const result = await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_8__/* .eth_address */ .Zt)(`0x${privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex}`);
              return {
                ...item,
    ...
    dispatch(_keyrings_reducer__WEBPACK_IMPORTED_MODULE_5__/* .keyringsActions */ .kk.setKeyrings(keyrings));
    const currentKeyring = await wallet.getCurrentKeyring();
    dispatch(_keyrings_reducer__WEBPACK_IMPORTED_MODULE_5__/* .keyringsActions */ .kk.setCurrent(currentKeyring));
    ...
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setAccounts(_accounts));
    const account = await wallet.getCurrentAccount();
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.setCurrent(account));
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_7__/* .accountActions */ .$G.expireBalance());
    wallet.getWalletConfig().then(data => {
      dispatch(_settings_reducer__WEBPACK_IMPORTED_MODULE_6__/* .settingsActions */ .dr.updateSettings({
        walletConfig: data
      }));
    });
  }, [dispatch, wallet]);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ay: () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   fh: () => (/* binding */ globalActions)
/* harmony export */ });
/* unused harmony export initialState */
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30038);
/* harmony import */ var _global_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4294);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FI: () => (/* binding */ useIsUnlocked),
/* harmony export */   H: () => (/* binding */ useUnlockCallback),
/* harmony export */   Yb: () => (/* binding */ useCreateAccountCallback),
/* harmony export */   vI: () => (/* binding */ useCreateAccountByPrivateKeyCallback)
/* harmony export */ });
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(75049);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44241);




function useGlobalState() {
  return (0,_hooks__WEBPACK_IMPORTED_MODULE_2__/* .useAppSelector */ .G)(state => state.global);
}
function useTab() {
...
function useUnlockCallback() {
  const dispatch = (0,_hooks__WEBPACK_IMPORTED_MODULE_2__/* .useAppDispatch */ .j)();
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_1__/* .useWallet */ .vT)();
  const [, resolveApproval] = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_1__/* .useApproval */ .V9)();
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async password => {
    await wallet.unlock(password);
    dispatch(_reducer__WEBPACK_IMPORTED_MODULE_3__/* .globalActions */ .fh.update({
      isUnlocked: true
    }));
    resolveApproval();
  }, [dispatch, wallet]);
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            ...
            reject(new Error(`Failed to load file: ${path} (status: ${xhr.status})`));
          }
        }
      };
      xhr.send();
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === 'undefined') {
    module_or_path = new URL(/* asset import */ __webpack_require__(51357), __webpack_require__.b);
  }
  const imports = __wbg_get_imports();
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $A: () => (/* binding */ transactionsActions),
/* harmony export */   Ay: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony export initialState */
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30038);
/* harmony import */ var _global_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4294);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2543);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);
/* eslint-disable no-unused-vars */
...
const slice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__/* .createSlice */ .Z0)({
  name: 'transactions',
  initialState,
  reducers: {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  jX: () => (/* reexport */ contactBook),
  Ut: () => (/* reexport */ erc20List),
  Ru: () => (/* reexport */ i18n),
  zn: () => (/* reexport */ service_keyring),
  lY: () => (/* reexport */ notification),
  at: () => (/* reexport */ openapi),
  ps: () => (/* reexport */ permission),
  t3: () => (/* reexport */ preference),
  mB: () => (/* reexport */ session)
});
...
var storage = __webpack_require__(13569);
;// ./src/background/utils/persisitStore.ts
/* eslint-disable @typescript-eslint/ban-types */


const persistStorage = (name, obj) => {
  (0,debounce.debounce)(storage/* default */.Ay.set(name, obj), 1000);
};
const createPersistStore = async _ref => {
  ...
  if (fromStorage) {
    ...
    const storageCache = await storage/* default */.Ay.get(name);
    tpl = storageCache || template;
    if (!storageCache) {
      await storage/* default */.Ay.set(name, tpl);
    }
  }
...
// EXTERNAL MODULE: ./node_modules/koa-compose/index.js
var koa_compose = __webpack_require__(68287);
...
;// ./src/background/service/contactBook.ts
...
var browser_passworder = __webpack_require__(68840);
...
var kaspa = __webpack_require__(45989);
...
// EXTERNAL MODULE: ./src/shared/types.ts
var types = __webpack_require__(59577);
// EXTERNAL MODULE: ./node_modules/@metamask/obs-store/dist/index.js
var dist = __webpack_require__(1888);
// EXTERNAL MODULE: ./node_modules/@noble/hashes/esm/sha256.js + 1 modules
var sha256 = __webpack_require__(17663);
...
var esm = __webpack_require__(97883);
// EXTERNAL MODULE: ./node_modules/bitcoinjs-lib/src/index.js
var bitcoinjs_lib_src = __webpack_require__(21757);
;// ./src/background/utils/onekey/nobleSecp256k1Wrapper.ts





esm/* utils */.Wp.sha256Sync = function () {
  for (var _len = arguments.length, messages = new Array(_len), _key = 0; _key < _len; _key++) {
    messages[_key] = arguments[_key];
  }
  const bufs = messages.map(m => buffer.Buffer.isBuffer(m) ? m : buffer.Buffer.from(m));
  return bitcoinjs_lib_src/* crypto */.Et.sha256(buffer.Buffer.concat(bufs));
};
esm/* utils */.Wp.hmacSha256Sync = function (key) {
  const hash = hmac/* hmac */.w.create(sha256/* sha256 */.sc, buffer.Buffer.from(key));
...
const normalizePrivateKey = esm/* utils */.Wp._normalizePrivateKey;
...
function bytesToNumber(bytes) {
  return hexToNumber(esm/* utils */.Wp.bytesToHex(bytes));
}
...
const privateAdd = (privateKey, tweak) => {
  ...
  const add = esm/* utils */.Wp._bigintTo32Bytes(esm/* utils */.Wp.mod(p + t, esm/* CURVE */.aY.n));
  if (esm/* utils */.Wp.isValidPrivateKey(add)) return add;
  return null;
};
const privateNegate = privateKey => {
  const p = normalizePrivateKey(privateKey);
  const not = esm/* utils */.Wp._bigintTo32Bytes(esm/* CURVE */.aY.n - p);
  if (esm/* utils */.Wp.isValidPrivateKey(not)) return not;
  return null;
};
const pointAddScalar = (p, tweak, isCompressed) => {
  const P = esm/* Point */.bR.fromHex(p);
  const t = normalizeScalar(tweak);
  const Q = esm/* Point */.bR.BASE.multiplyAndAddUnsafe(P, t, 1n);
  if (!Q) throw new Error('Tweaked point at infinity');
  return Q.toRawBytes(isCompressed);
};
const pointMultiply = (p, tweak, isCompressed) => {
  const P = esm/* Point */.bR.fromHex(p);
  const h = typeof tweak === 'string' ? tweak : esm/* utils */.Wp.bytesToHex(tweak);
  const t = BigInt(`0x${h}`);
...
const nobleSecp256k1Wrapper_ecc = {
  ...
  isPrivate: d => esm/* utils */.Wp.isValidPrivateKey(d),
  ...
  pointFromScalar: (sk, compressed) => throwToNull(() => esm/* getPublicKey */.lG(sk, defaultTrue(compressed))),
  pointCompress: (p, compressed) => esm/* Point */.bR.fromHex(p).toRawBytes(defaultTrue(compressed)),
  ...
  pointAdd: (a, b, compressed) => throwToNull(() => {
    const A = esm/* Point */.bR.fromHex(a);
    const B = esm/* Point */.bR.fromHex(b);
  ...
  sign: (h, d, e) => esm/* signSync */.HU(h, d, {
    der: false,
    extraEntropy: e
  }),
  signSchnorr: function (h, d) {
    let e = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : buffer.Buffer.alloc(32, 0x00);
    return esm/* schnorr */.ko.signSync(h, d, e);
  },
  verify: (h, Q, signature, strict) => esm/* verify */.MX(signature, h, Q, {
    strict
  }),
  verifySchnorr: (h, Q, signature) => esm/* schnorr */.ko.verifySync(signature, h, Q)
};
...
function taggedHash(prefix, data) {
  ...
  const hash = sha256/* sha256 */.sc.create();
  hash.update(tagged);
  hash.update(data);
...
// EXTERNAL MODULE: ./node_modules/@brucelei/kaspacore/index.js
var kaspacore = __webpack_require__(43158);
// EXTERNAL MODULE: ./node_modules/@noble/hashes/esm/utils.js
var utils = __webpack_require__(4976);
;// ./src/background/service/keyringclass/simple-keyring.ts
/* eslint-disable @typescript-eslint/no-explicit-any */
// "use strict";
...
;// ./src/background/service/keyringclass/hd-keyring.ts
...
class HdKeyring extends SimpleKeyring {
  ...
  _onekeyPrivateKeyFromOriginPrivateKey(pri, pub) {
    ...
    return new kaspa.PrivateKey((0,utils/* bytesToHex */.My)(tweakedPrivateKey));
  }
  _addressFromIndex(i) {
    let dType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    ...
    if (!this._index2wallet[key]) {
      ...
      if (this.hdPath == "m/44'/972/0'") {
        ...
        const {
          privateKey
        } = HDWallet.deriveChild(`m/44'/972/0'/${dType}'/${i}'`);
        const {
          PrivateKey
        } = this.kaspaWasm;
      ...
      } else if (this.addressType && this.addressType == types/* AddressType */.RX.KASPA_ONEKEY_44_111111) {
        ...
        if (dType == 0) {
          ...
          const kaspaPrivateKeyBuf = buffer.Buffer.from(buffer.Buffer.from((0,utils/* hexToBytes */.aT)(kaspaReceivePrivateKey.toString())));
          const kaspaPublicKeyBuf = buffer.Buffer.from(buffer.Buffer.from((0,utils/* hexToBytes */.aT)(kaspaPubkey)));
          ...
          const kaspaPubkey = kaspaKeyPair.publicKey;
          const kaspaPrivateKeyBuf = buffer.Buffer.from(buffer.Buffer.from((0,utils/* hexToBytes */.aT)(kaspaChangePrivateKey.toString())));
          const kaspaPublicKeyBuf = buffer.Buffer.from(buffer.Buffer.from((0,utils/* hexToBytes */.aT)(kaspaPubkey)));
          const onekeyPrivateKey = this._onekeyPrivateKeyFromOriginPrivateKey(kaspaPrivateKeyBuf, kaspaPublicKeyBuf);
...
var eventBus = __webpack_require__(28652);
  ...
  constructor() {
    ...
    this.init = async () => {
      ...
      this.store = await persisitStore({
        ...
        template: {
          ...
          firstOpen: false,
          currency: 'USD',
          addressType: types/* AddressType */.RX.KASPA_44_111111,
          networkType: types/* NetworkType */.z1.Mainnet,
          rpcLinks: constant/* NETWORK_TYPES */.rg,
          keyringAlianNames: {},
          accountAlianNames: {},
          skippedVersion: '',
          appTab: {
      ...
      if (this.store.addressType === undefined || this.store.addressType === null) {
        this.store.addressType = types/* AddressType */.RX.KASPA_44_111111;
      }
      if (!this.store.networkType) {
        this.store.networkType = types/* NetworkType */.z1.Mainnet;
      }
    ...
    this.setCurrentAccount = account => {
      ...
      if (account) {
        ...
        eventBus/* default */.A.emit('accountsChanged', account);
      }
    };
    // popupOpen
    ...
    // isFirstOpen
    this.getIsFirstOpen = () => {
      if (!this.store.currentVersion || (0,compare_versions/* default */.Ay)(version, this.store.currentVersion)) {
...
class EmptyKeyring {
  constructor() {
    this.type = constant/* KEYRING_TYPE */.rK.Empty;
  } // todo
...
class KeyringService extends events.EventEmitter {
  constructor() {
    ...
    this.createKeyringWithMnemonics = async function (seed, hdPath, passphrase, addressType, activeIndexes) {
      ...
      //   throw new Error('account count must be greater than 0');
      // }
      if (!src/* validateMnemonic */.JB(seed)) {
    ...
    this.changeAddressType = async (keyringIndex, addressType) => {
      ...
      if (keyring.type === constant/* KEYRING_TYPE */.rK.HdKeyring) {
        const hdPath = constant/* ADDRESS_TYPES */.Ld[addressType].hdPath;
    ...
    this._restoreKeyring = async serialized => {
      ...
      if (type === constant/* KEYRING_TYPE */.rK.Empty) {
    ...
    this.getKeyringForAccount = async function (address, type, start, end) {
      ...
      loglevel_default().debug(`KeyringController - getKeyringForAccount: ${address}`);
    ...
    this.publicKeyToAddress = (pubkey, addressType, networkType) => {
      ...
      if (addressType == types/* AddressType */.RX.KASPA_TANGEM_44_111111) {
...
var randomstring = __webpack_require__(87879);
// EXTERNAL MODULE: ./src/ui/utils/index.ts + 2 modules
var ui_utils = __webpack_require__(13108);
// EXTERNAL MODULE: ./src/ui/features/browser/tabs.ts + 1 modules
var tabs = __webpack_require__(5579);
...
class OpenApiService {
  constructor() {
    ...
    this.init = async () => {
      ...
      this.store = await persisitStore({
        name: 'openapi',
        template: {
          host: constant/* OPENAPI_URL_MAINNET */._7,
          rpchost: constant/* OPENAPI_RPC_MAINNET */.aO,
      ...
      } else if (networkType === types/* NetworkType */.z1.Testnet) {
    ...
    this.rpc_connect = async () => {
      const networkType = preference.getNetworkType();
      if (networkType == types/* NetworkType */.z1.Devnet) {
        ...
        this.rpc = new kaspa.RpcClient({
          ...
          networkId: networkType === types/* NetworkType */.z1.Mainnet ? 'mainnet' : 'testnet-10'
        });
      }
    ...
    this.subscribeUtxosChanged = async address => {
      ...
      this.rpc.addEventListener('utxos-changed', event => {
        if (event && event.data) {
          eventBus/* default */.A.emit(constant/* EVENTS */.qY.broadcastToUI, {
    ...
    this.httpGet = async (route, params) => {
      ...
      headers.append('X-Version', constant/* VERSION */.xv);
      headers.append('x-address', this.clientAddress);
      headers.append('x-flag', this.addressFlag + '');
      headers.append('x-channel', constant/* CHANNEL */.s$);
  ...
  async getAddressesBalance(addresses) {
    ...
    balanceInfo.entries.forEach(entry => {
      const amount = (0,ui_utils/* sompiToAmount */._m)(Number(entry.balance));
  ...
  async getTxActivities(address) {
    ...
    const response = await fetch(`${API}/addresses/${address}/full-transactions?limit=10&resolve_previous_outpoints=light`);
    if (!response.ok) {
      throw new Error('Network response was not ok ' + response.statusText);
    }
    const data = await response.json();
    const trans = (0,ui_utils/* handleTransactions */.IU)(data, address);
    return trans;
  }
  ...
  async openDeployKrc20View() {
    return (0,tabs/* openExtensionInTab */._A)('#/depoly');
  }
  async openMintKrc20View() {
    return (0,tabs/* openExtensionInTab */._A)('#/mint');
  }
}
/* harmony default export */ const openapi = (new OpenApiService());
// EXTERNAL MODULE: ./node_modules/eth-rpc-errors/dist/index.js
var eth_rpc_errors_dist = __webpack_require__(12203);
// EXTERNAL MODULE: ./node_modules/eth-rpc-errors/dist/classes.js
var classes = __webpack_require__(32083);
...
class NotificationService extends (events_default()) {
  constructor() {
    ...
    this.rejectApproval = async function (err) {
      ...
      if (isInternal) {
        var _this$approval4;
        (_this$approval4 = _this.approval) === null || _this$approval4 === void 0 ? void 0 : _this$approval4.reject(eth_rpc_errors_dist/* ethErrors */.Ls.rpc.internal(err));
      } else {
        var _this$approval5;
        (_this$approval5 = _this.approval) === null || _this$approval5 === void 0 ? void 0 : _this$approval5.reject(eth_rpc_errors_dist/* ethErrors */.Ls.provider.userRejectedRequest(err));
      }
...
var lru_cache = __webpack_require__(69749);
var lru_cache_default = /*#__PURE__*/__webpack_require__.n(lru_cache);
;// ./src/background/service/permission.ts
...
class PermissionService {
  constructor() {
    ...
    this.touchConnectedSite = origin => {
      if (!this.lruCache) return;
      if (origin === constant/* INTERNAL_REQUEST_ORIGIN */.Px) return;
    ...
    this.hasPermission = origin => {
      if (!this.lruCache) return;
      if (origin === constant/* INTERNAL_REQUEST_ORIGIN */.Px) return true;
    ...
    this.isInternalOrigin = origin => {
      return origin === constant/* INTERNAL_REQUEST_ORIGIN */.Px;
    };
  }
}
...
;// ./src/background/service/erc20List.ts
...
/* harmony export */   uj: () => (/* binding */ KasAmountInput)
/* harmony export */ });
...
/* harmony import */ var _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74680);
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13108);
/* harmony import */ var _mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6757);
/* harmony import */ var react_i18next__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(13907);
/* harmony import */ var _ActionComponent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17508);
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43264);
/* harmony import */ var _Row__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(51942);
/* harmony import */ var _Text__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(20577);
...
const $baseInputStyle = Object.assign({}, _Text__WEBPACK_IMPORTED_MODULE_8__/* .$textPresets */ .MB.regular, {
  display: 'flex',
  flex: 1,
  borderWidth: 0,
  outlineWidth: 0,
...
function PasswordInput(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .A, {
    placeholder: (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isNull)(placeholder) ? 'Password' : placeholder,
    ...rest,
    endAdornment: type === 'password' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Icon__WEBPACK_IMPORTED_MODULE_6__/* .Icon */ .I, {
      icon: "eye-slash",
      style: {
        marginLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_3__/* .spacing */ .YK.tiny
      },
      onClick: () => setType('text'),
      color: "textDim"
    }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Icon__WEBPACK_IMPORTED_MODULE_6__/* .Icon */ .I, {
      icon: "eye",
      style: {
        marginLeft: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_3__/* .spacing */ .YK.tiny
      },
...
function AmountInput(props) {
  ...
  const $style = Object.assign({}, $baseInputStyle, $inputStyleOverride, disabled ? {
    color: _ui_theme_colors__WEBPACK_IMPORTED_MODULE_2__/* .colors */ .T.textDim
  } : {});
...
function KasAmountInput(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .A, {
    ...
    style: $style,
    disabled: disabled,
    startAdornment: inputAmountType && inputAmountType == 'usd' && Number(inputValue) > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
      text: "$",
      color: "textDim",
      style: {
        marginRight: _ui_theme_spacing__WEBPACK_IMPORTED_MODULE_3__/* .spacing */ .YK.tiny
      }
    }),
    endAdornment: inputAmountType && inputAmountType == 'kas' && Number(inputValue) > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
      text: "KAS",
      color: "textDim"
    }),
    ...rest
...
const AddressInput = props => {
  ...
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_4__/* .useWallet */ .vT)();
  const tools = (0,_ActionComponent__WEBPACK_IMPORTED_MODULE_5__/* .useTools */ .D)();
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    onAddressInputChange({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("input", {
        ...
        ...rest
      }), searching && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Row__WEBPACK_IMPORTED_MODULE_7__/* .Row */ .f, {
        full: true,
        mt: "sm",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
          preset: "sub",
          text: 'Loading...'
        })
      })]
    }), parseName ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_Row__WEBPACK_IMPORTED_MODULE_7__/* .Row */ .f, {
      mt: "sm",
      gap: "zero",
      itemsCenter: true,
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
        preset: "link",
        color: "yellow",
        text: 'More details',
        onClick: () => {
          (0,_ui_utils__WEBPACK_IMPORTED_MODULE_4__/* .openUrlLink */ .aj)('https://kaspa.org/');
        }
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
        preset: "sub",
        size: "sm",
    ...
    }) : null, parseError && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
      text: parseError,
      preset: "regular",
      color: "error"
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   k: () => (/* binding */ AddressBar)
/* harmony export */ });
/* harmony import */ var _ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43658);
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13108);
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(57046);
/* harmony import */ var react_i18next__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13907);
/* harmony import */ var _ActionComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17508);
/* harmony import */ var _Row__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(51942);
/* harmony import */ var _Text__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20577);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74848);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__]);
...
function AddressBar(_ref) {
  ...
  const tools = (0,_ActionComponent__WEBPACK_IMPORTED_MODULE_2__/* .useTools */ .D)();
  const addressL1 = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__/* .useAccountAddress */ .PJ)();
  const addressL2 = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_0__/* .useAccountAddressL2 */ .N1)();
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_Row__WEBPACK_IMPORTED_MODULE_3__/* .Row */ .f, {
    selfItemsCenter: true,
    itemsCenter: true,
    style: {
    ...
    onClick: e => {
      (0,_ui_utils__WEBPACK_IMPORTED_MODULE_1__/* .copyToClipboard */ .lW)((activeKey === null || activeKey === void 0 ? void 0 : activeKey.activeKey) === 'L2' ? addressL2 : addressL1).then(() => {
        tools.toastSuccess(t('Copied'));
      });
    },
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Text__WEBPACK_IMPORTED_MODULE_4__/* .Text */ .EY, {
      text: (0,_ui_utils__WEBPACK_IMPORTED_MODULE_1__/* .shortAddress */ .Dc)((activeKey === null || activeKey === void 0 ? void 0 : activeKey.activeKey) === 'L2' ? addressL2 : addressL1, 10),
      style: {
        color: 'rgba(10,36,99,0.65)',
        ...textStyle
      }
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_ant_design_icons__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
      style: iconStyle
    })]
  });
}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   E3: () => (/* binding */ RestoreWalletType),
/* harmony export */   H6: () => (/* binding */ WebsiteState),
/* harmony export */   RX: () => (/* binding */ AddressType),
/* harmony export */   mb: () => (/* binding */ LayerType),
/* harmony export */   z1: () => (/* reexport safe */ kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__.NetworkType),
/* harmony export */   zd: () => (/* binding */ TxType)
/* harmony export */ });
/* harmony import */ var kaspa_wasm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45989);
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable no-unused-vars */
...
"use strict";
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony import */ var antd_lib_message_style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34692);
...
/* harmony import */ var antd_lib_message__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(24146);
/* harmony import */ var antd_es_locale_en_US__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(15017);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5338);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2896);
/* harmony import */ var _background__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(75961);
/* harmony import */ var _ui_state_accounts_updater__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(93633);
/* harmony import */ var _ui_styles_global_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(84641);
/* harmony import */ var _ui_theme__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(84541);
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(78420);
/* harmony import */ var _components_ActionComponent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17508);
/* harmony import */ var _pages_MainRoute__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(88658);
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6249);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(13108);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(74353);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var dayjs_plugin_relativeTime__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(6279);
...
/* harmony import */ var _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(73689);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(74848);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_ui_state_accounts_updater__WEBPACK_IMPORTED_MODULE_4__, _pages_MainRoute__WEBPACK_IMPORTED_MODULE_8__, _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__]);
([_ui_state_accounts_updater__WEBPACK_IMPORTED_MODULE_4__, _pages_MainRoute__WEBPACK_IMPORTED_MODULE_8__, _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const resetAutoLockTimer = () => {
  ...
  autoLockTimer = setTimeout(() => {
    // 调用锁定钱包的方法
    if (_background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A && typeof _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A.lockWallet === 'function') {
      _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A.lockWallet().catch(error => {
...
const antdConfig = {
  locale: antd_es_locale_en_US__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .A
};
function Updaters() {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.Fragment, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_ui_state_accounts_updater__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A, {})
  });
}
const locale = 'en';
...
root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(react_redux__WEBPACK_IMPORTED_MODULE_2__/* .Provider */ .Kq, {
  store: _state__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A,
  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_mui_material_styles__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .A, {
    theme: _ui_theme__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A,
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_utils__WEBPACK_IMPORTED_MODULE_10__/* .WalletProvider */ .rh, {
      ...antdConfig,
      wallet: _background_controller_wallet__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)(_components_ActionComponent__WEBPACK_IMPORTED_MODULE_7__/* .ActionComponentProvider */ .T, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(Updaters, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_pages_MainRoute__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {})]
      })
    })
  })
}));
...
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./src/ui/components/BaseView/index.tsx
...
function BaseView(props) {
  ...
  const $baseViewStyle = Object.assign({}, justifyCenter ? {
    ...
    gap: spacing/* spacingGap */.IQ[gap]
  } : {}, px ? {
    paddingLeft: spacing/* spacingGap */.IQ[px],
    paddingRight: spacing/* spacingGap */.IQ[px]
  } : {}, py ? {
    paddingTop: spacing/* spacingGap */.IQ[py],
    paddingBottom: spacing/* spacingGap */.IQ[py]
  } : {}, pt ? {
    paddingTop: spacing/* spacingGap */.IQ[pt]
  } : {}, pb ? {
    paddingBottom: spacing/* spacingGap */.IQ[pb]
  } : {}, mt ? {
    marginTop: spacing/* spacingGap */.IQ[mt]
  } : {}, mb ? {
    marginBottom: spacing/* spacingGap */.IQ[mb]
  } : {}, mx ? {
    marginLeft: spacing/* spacingGap */.IQ[mx],
    marginRight: spacing/* spacingGap */.IQ[mx]
  } : {}, my ? {
    marginTop: spacing/* spacingGap */.IQ[my],
    marginBottom: spacing/* spacingGap */.IQ[my]
  } : {}, bg ? {
    backgroundColor: colors/* colors */.T[bg]
  } : {}, rounded ? {
    borderRadius: 5
  } : {}, roundedTop ? {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $n: () => (/* reexport safe */ _Button__WEBPACK_IMPORTED_MODULE_1__.$),
/* harmony export */   EY: () => (/* reexport safe */ _Text__WEBPACK_IMPORTED_MODULE_14__.EY),
/* harmony export */   In: () => (/* reexport safe */ _Icon__WEBPACK_IMPORTED_MODULE_8__.I),
/* harmony export */   PE: () => (/* reexport safe */ _Layout__WEBPACK_IMPORTED_MODULE_11__.P),
/* harmony export */   UC: () => (/* reexport safe */ _Content__WEBPACK_IMPORTED_MODULE_4__.U),
/* harmony export */   VP: () => (/* reexport safe */ _Column__WEBPACK_IMPORTED_MODULE_3__.V),
/* harmony export */   Y9: () => (/* reexport safe */ _Header__WEBPACK_IMPORTED_MODULE_7__.Y),
/* harmony export */   Zp: () => (/* reexport safe */ _Card__WEBPACK_IMPORTED_MODULE_2__.Z),
/* harmony export */   _V: () => (/* reexport safe */ _Image__WEBPACK_IMPORTED_MODULE_9__._),
/* harmony export */   fI: () => (/* reexport safe */ _Row__WEBPACK_IMPORTED_MODULE_13__.f),
/* harmony export */   fs: () => (/* reexport safe */ _TextArea__WEBPACK_IMPORTED_MODULE_15__.f),
/* harmony export */   k3: () => (/* reexport safe */ _AddressBar__WEBPACK_IMPORTED_MODULE_0__.k),
/* harmony export */   pd: () => (/* reexport safe */ _Input__WEBPACK_IMPORTED_MODULE_10__.pd),
/* harmony export */   wi: () => (/* reexport safe */ _Footer__WEBPACK_IMPORTED_MODULE_5__.w),
/* harmony export */   zI: () => (/* reexport safe */ _NodeStatus__WEBPACK_IMPORTED_MODULE_16__.z)
/* harmony export */ });
/* harmony import */ var _AddressBar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53228);
...
/* harmony import */ var _Content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(40851);
/* harmony import */ var _Footer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1090);
/* harmony import */ var _Grid__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(40083);
/* harmony import */ var _Header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(31640);
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(43264);
/* harmony import */ var _Image__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(39818);
/* harmony import */ var _Input__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(52377);
/* harmony import */ var _Layout__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(21918);
/* harmony import */ var _Logo__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(6926);
/* harmony import */ var _Row__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(51942);
/* harmony import */ var _Text__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(20577);
/* harmony import */ var _TextArea__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(18869);
/* harmony import */ var _NodeStatus__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(20925);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_AddressBar__WEBPACK_IMPORTED_MODULE_0__, _NodeStatus__WEBPACK_IMPORTED_MODULE_16__]);
([_AddressBar__WEBPACK_IMPORTED_MODULE_0__, _NodeStatus__WEBPACK_IMPORTED_MODULE_16__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony export WalletController */
/* harmony import */ var _background_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(51902);
/* harmony import */ var _shared_constant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77093);
/* harmony import */ var _shared_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(59577);
/* harmony import */ var _shared_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17712);
/* harmony import */ var kaspa_wasm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(45989);
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(25877);
/* harmony import */ var _background_krc20_l2__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3146);
/* provided dependency */ var Buffer = __webpack_require__(48287)["Buffer"];
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_background_krc20_l2__WEBPACK_IMPORTED_MODULE_4__]);
_background_krc20_l2__WEBPACK_IMPORTED_MODULE_4__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
/* eslint-disable no-unused-vars */
/* eslint-disable @typescript-eslint/no-unused-vars */
/* eslint-disable @typescript-eslint/no-explicit-any */
...
const stashKeyrings = {};
class WalletController extends _base__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A {
  constructor() {
    var _this;
    super(...arguments);
    _this = this;
    this.openapi = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at;
    /* wallet */
    this.boot = password => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.boot(password);
    this.isBooted = () => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.isBooted();
    this.getApproval = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .notificationService */ .lY.getApproval;
    this.resolveApproval = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .notificationService */ .lY.resolveApproval;
    this.rejectApproval = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .notificationService */ .lY.rejectApproval;
    this.hasVault = async () => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.hasVault();
    this.verifyPassword = password => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.verifyPassword(password);
    this.changePassword = (password, newPassword) => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.changePassword(password, newPassword);
    this.initAlianNames = async () => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.changeInitAlianNameStatus();
      const contacts = this.listContact();
      const keyrings = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getAllDisplayedKeyrings();
      keyrings.forEach(v => {
        v.accounts.forEach((w, index) => {
          this.updateAlianName(w.pubkey, `${_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .BRAND_ALIAN_TYPE_TEXT */ .LI[v.type]} ${index + 1}`);
        });
      });
    ...
    this.subscribeUtxosChanged = async () => {
      const currentAccount = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentAccount();
      if (currentAccount !== null && currentAccount !== void 0 && currentAccount.address) {
        await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.subscribeUtxosChanged(currentAccount.address);
      }
    };
    this.isReady = () => {
      if (_background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.store) {
        return true;
      } else {
        return false;
      }
    ...
    this.unlock = async password => {
      const alianNameInited = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getInitAlianNameStatus();
      const alianNames = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.listAlias();
      await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.submitPassword(password);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('unlock');
      if (!alianNameInited && alianNames.length === 0) {
        this.initAlianNames();
      }
    };
    this.isUnlocked = async () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.memStore.getState().isUnlocked;
    };
    this.lockWallet = async () => {
      await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.setLocked();
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('accountsChanged', []);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('lock');
      this.disconnectRpc();
    };
    this.setPopupOpen = isOpen => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setPopupOpen(isOpen);
    };
    this.getAddressBalance = async address => {
      const data = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAddressBalance(address);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.updateAddressBalance(address, data);
      return data;
    };
    this.getAddressesBalance = async addresses => {
      const data = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAddressesBalance(addresses);
      for (let i = 0; i < addresses.length; i++) {
        _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.updateAddressBalance(addresses[i], data[i]);
      }
      return data;
    };
    this.getMultiAddressAssets = async addresses => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getMultiAddressAssets(addresses);
    };
    this.findGroupAssets = async groups => {
      const scannedGroup = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.findGroupAssets(groups);
      return scannedGroup;
    };
    this.getAddressCacheBalance = address => {
      ...
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAddressBalance(address) || defaultBalance;
    };
    // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
    ...
    this.getAddressCacheHistory = address => {
      if (!address) return [];
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAddressHistory(address);
    };
    this.getExternalLinkAck = () => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getExternalLinkAck();
    };
    this.setExternalLinkAck = ack => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setExternalLinkAck(ack);
    };
    this.getLocale = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getLocale();
    };
    this.setLocale = locale => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setLocale(locale);
    };
    this.getCurrency = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrency();
    };
    this.setCurrency = currency => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setCurrency(currency);
    };
    /* keyrings */
    this.clearKeyrings = () => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.clearKeyrings();
    this.getPrivateKey = async (password, _ref) => {
      ...
      await this.verifyPassword(password);
      const keyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getKeyringForAccount(pubkey, type);
    ...
    this.getMnemonics = async (password, keyring) => {
      await this.verifyPassword(password);
      const originKeyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings[keyring.index];
    ...
    this.createKeyringWithPrivateKey = async (data, addressType, alianName) => {
      ...
      let originKeyring;
      try {
        originKeyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.importPrivateKey(data, addressType);
      } catch (e) {
        console.log(e);
        throw e;
      }
      ...
      const displayedKeyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.displayForKeyring(originKeyring, addressType, _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings.length - 1);
      const keyring = await this.displayedKeyringToWalletKeyring(displayedKeyring, _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings.length - 1);
      for (const j in keyring.accounts) {
        ...
        const l2Info = await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_4__/* .eth_address */ .Zt)(`0x${privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex}`);
    ...
    this.getPreMnemonics = function () {
      let wordCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 12;
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getPreMnemonics(wordCount);
    };
    this.generatePreMnemonic = function () {
      let wordCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 12;
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.generatePreMnemonic(wordCount);
    };
    this.removePreMnemonics = () => _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.removePreMnemonics();
    this.createKeyringWithMnemonics = async function (mnemonic, hdPath, passphrase, addressType, activeIndexes) {
      let activeChangeIndexes = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
      const originKeyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.createKeyringWithMnemonics(mnemonic, hdPath, passphrase, addressType,
      // accountCount,
      // startIndex
      activeIndexes, activeChangeIndexes);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.removePreMnemonics();
      const displayedKeyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.displayForKeyring(originKeyring, addressType, _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings.length - 1);
      const keyring = await _this.displayedKeyringToWalletKeyring(displayedKeyring, _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings.length - 1);
      for (const j in keyring.accounts) {
      ...
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setShowSafeNotice(false);
    };
    this.createTmpKeyringWithMnemonics = async function (mnemonic, hdPath, passphrase, addressType) {
      ...
      const originKeyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.createTmpKeyring('HD Key Tree', {
        mnemonic,
        activeIndexes,
      ...
      const displayedKeyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.displayForKeyring(originKeyring, addressType, -1);
    ...
    this.createTmpKeyringWithMnemonicsWithAddressDiscovery = async function (mnemonic, hdPath, passphrase, addressType) {
      ...
      for (let i = 0;; i = i + accountCount) {
        ...
        const dtype_arr = [];
        const index_arr = [];
        const networkType = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getNetworkType();
        receiveAddressObjArr.forEach(a => {
          const address = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.publicKeyToAddress(a.address, addressType, networkType);
    ...
    this.discoverAddressesWithBalance = async function (keyring) {
      ...
      const oKeyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings[keyring.index];
      ...
      for (let i = 0; i < address_arr.length;) {
        ...
        if (idDuplicated) {
          ...
          await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.addNewAccount(oKeyring, dtype_arr[i], index);
          i++;
        }
      }
      ...
      currentKeyringTemp.accounts.forEach(account => {
        if (address_arr.includes(account.address)) {
          _this.setAccountAlianName(account, `Discovery ${account.index}`);
        }
      });
      return group;
    };
    ...
    this.compoundUtxos = async accounts => {
      ...
      const entries = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getKASUtxos(addresses);
      const keyring = await this.getCurrentKeyring();
      if (!keyring) throw new Error('no current keyring');
      const _keyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings[keyring.index];
      if (!entries.length) {
        throw new Error(`No UTXOs found for address ${addresses}`);
      } else {
        // entries.sort((a, b) => a.amount > b.amount || -(a.amount < b.amount));
        try {
          const networkId = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getNetworkId();
          const generator = new kaspa_wasm__WEBPACK_IMPORTED_MODULE_6__.Generator({
            entries,
            outputs: [],
            priorityFee: (0,kaspa_wasm__WEBPACK_IMPORTED_MODULE_6__.kaspaToSompi)("0.001"),
            changeAddress: currentAccount.address,
            networkId
          });
          let pending;
          while (pending = await generator.next()) {
            ...
            const preSubmitPending = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.signTransaction(_keyring, pending, toSignInputs);
            // submit
            const txid = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.submitTransaction(preSubmitPending);
            return txid;
          }
        } catch (e) {
          console.log(e);
    ...
    this.createTmpKeyringWithPrivateKey = async (privateKey, addressType) => {
      const originKeyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.createTmpKeyring(_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.SimpleKeyring, [privateKey]);
      const displayedKeyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.displayForKeyring(originKeyring, addressType, -1);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setShowSafeNotice(false);
    ...
    this.removeKeyring = async keyring => {
      await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.removeKeyring(keyring.index);
    ...
    this.getKeyringByType = type => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getKeyringByType(type);
    };
    this.deriveNewAccountFromMnemonic = async (keyring, alianName) => {
      const _keyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings[keyring.index];
      const result = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.addNewAccount(_keyring);
    ...
    this.getAccountsCount = async () => {
      const accounts = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getAccounts();
      return accounts.filter(x => x).length;
    };
    this.changeKeyring = function (keyring) {
      let accountIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setCurrentKeyringIndex(keyring.index);
      ...
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setCurrentAccount(account);
      const flag = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAddressFlag(account.address);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.setClientAddress(account.address, flag);
    };
    this.getAllAddresses = (keyring, index) => {
      const networkType = this.getNetworkType();
      const addresses = [];
      const _keyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.keyrings[keyring.index];
      if (keyring.type === _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.HdKeyring) {
        const pathPubkey = {};
        _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .ADDRESS_TYPES */ .Ld.filter(v => v.displayIndex >= 0).forEach(v => {
          ...
          const address = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.publicKeyToAddress(pubkey, v.value, networkType);
          addresses.push(address);
        });
      } else {
        _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .ADDRESS_TYPES */ .Ld.filter(v => v.displayIndex >= 0 && v.isKaswareLegacy === false).forEach(v => {
    ...
    this.changeAddressType = async addressType => {
      ...
      const currentKeyringIndex = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentKeyringIndex();
      await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.changeAddressType(currentKeyringIndex, addressType);
      const keyring = await this.getCurrentKeyring();
      if (!keyring) throw new Error('no current keyring');
    ...
    this.signTransaction = async (type, from, psbt, inputs) => {
      const keyring = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getKeyringForAccount(from, type);
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.signTransaction(keyring, psbt, inputs);
    };
    ...
    this.signPsbt = async (psbt, toSignInputs, autoFinalized) => {
      ...
      psbt = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.signTransaction(_keyring, psbt, toSignInputs);
      if (autoFinalized) {
    ...
    this.signMessage = async text => {
      const account = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.signMessage(account.pubkey, text);
    };
    this.verifyMessage = async (text, signature) => {
      const account = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.verifyMessage(account.pubkey, text, signature);
    };
    this.signMessageL2 = async text => {
      ...
      return await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_4__/* .signMessage */ .lT)(text, `0x${privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex}`);
    };
    this.verifyMessageL2 = async (text, signature) => {
      const account = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      return await (0,_background_krc20_l2__WEBPACK_IMPORTED_MODULE_4__/* .verifyMessage */ .Ee)(text, signature, account.addressL2);
    };
    // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
    ...
    this.requestKeyring = function (type, methodName, keyringId) {
      ...
      if (keyringId !== null && keyringId !== undefined) {
        ...
        try {
          ...
          const Keyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getKeyringClassForType(type);
          keyring = new Keyring();
        }
      }
    ...
    this._getKeyringByType = type => {
      const keyring = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getKeyringsByType(type)[0];
      if (keyring) {
        return keyring;
      }
    ...
    this.addContact = data => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.addContact(data);
    };
    this.updateContact = data => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.updateContact(data);
    };
    this.removeContact = address => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.removeContact(address);
    };
    this.listContact = function () {
      let includeAlias = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      const list = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.listContacts();
      if (includeAlias) {
        return list;
      } else {
    ...
    this.getContactsByMap = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.getContactsByMap();
    };
    this.getContactByAddress = address => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.getContactByAddress(address);
    };
    this.addERC20Token = data => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .erc20ListService */ .Ut.updateERC20List(data);
    };
    this.getERC20ListByAddress = address => {
      console.log('getERC20ListByAddress', address);
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .erc20ListService */ .Ut.getERC20ListByAddress(address);
    };
    this._generateAlianName = (type, index) => {
      const alianName = `${_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .BRAND_ALIAN_TYPE_TEXT */ .LI[type]} ${index}`;
      return alianName;
    };
    ...
    this.getHighlightWalletList = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getWalletSavedList();
    };
    this.updateHighlightWalletList = list => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.updateWalletSavedList(list);
    };
    this.getAlianName = pubkey => {
      var _contactBookService$g;
      const contactName = (_contactBookService$g = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.getContactByAddress(pubkey)) === null || _contactBookService$g === void 0 ? void 0 : _contactBookService$g.name;
      return contactName;
    };
    this.updateAlianName = (pubkey, name) => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.updateAlias({
        name,
        address: pubkey
      });
    };
    this.getAllAlianName = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .contactBookService */ .jX.listAlias();
    };
    this.getInitAlianNameStatus = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getInitAlianNameStatus();
    };
    this.updateInitAlianNameStatus = () => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.changeInitAlianNameStatus();
    };
    this.getIsFirstOpen = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getIsFirstOpen();
    };
    this.updateIsFirstOpen = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.updateIsFirstOpen();
    };
    this.listChainAssets = async pubkeyAddress => {
      const balance = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAddressBalance(pubkeyAddress);
      const assets = [{
        name: _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .COIN_NAME */ ._Z,
        symbol: _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .COIN_SYMBOL */ .Rc,
    ...
    this.getRpcLinks = () => {
      const rpcLinks = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getRpcLinks();
      return rpcLinks;
    };
    this.getRpcStatus = () => {
      const status = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getRpcStatus();
      return status;
    };
    this.setNetworkType = async networkType => {
      console.log('setNetworkType', networkType);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setNetworkType(networkType);
      const rpcLinks = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getRpcLinks();
      if (networkType === _shared_types__WEBPACK_IMPORTED_MODULE_2__/* .NetworkType */ .z1.Mainnet) {
        this.openapi.setHost(_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .OPENAPI_URL_MAINNET */ ._7);
        this.openapi.setNetworkId('mainnet');
        this.openapi.setRpcHost(rpcLinks[0].url);
      } else if (networkType === _shared_types__WEBPACK_IMPORTED_MODULE_2__/* .NetworkType */ .z1.Testnet) {
        this.openapi.setHost(_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .OPENAPI_URL_TESTNET */ .lu);
        this.openapi.setNetworkId('testnet-10');
        this.openapi.setRpcHost(rpcLinks[1].url);
      } else if (networkType === _shared_types__WEBPACK_IMPORTED_MODULE_2__/* .NetworkType */ .z1.Devnet) {
        this.openapi.setHost(_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .OPENAPI_URL_DEVNET */ ._k);
        this.openapi.setNetworkId('devnet');
        this.openapi.setRpcHost(rpcLinks[2].url);
      }
      const network = this.getNetworkName();
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('networkChanged', {
        network
      });
      const currentAccount = await this.getCurrentAccount();
      const keyring = await this.getCurrentKeyring();
    ...
    this.setRpcLinks = async rpcLinks => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setRpcLinks(rpcLinks);
    };
    this.getNetworkName = () => {
      const networkType = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getNetworkType();
      return _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .NETWORK_TYPES */ .rg[networkType].name;
    };
    this.getKASUtxos = async () => {
      const account = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      const utxos = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getKASUtxos([account.address]);

      // if (openapiService.addressFlag == 1) {
      //   utxos = utxos.filter((v) => (v as any).height !== 4194303);
      // }

      const kasUtxos = (0,_shared_utils__WEBPACK_IMPORTED_MODULE_3__/* .getKaspaUTXOWithoutBigint */ .A0)(utxos);
      return kasUtxos;
    };
    this.getTxActivities = async () => {
      const account = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentAccount();
      if (!account) throw new Error('no current account');
      const trans = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getTxActivities(account.address);
      return trans;
    };
    ...
    this.sendKAS = async _ref3 => {
      ...
      try {
        ...
        // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
        const generator = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.createGenerator(sourceAddress, destinationAddress, changeAddress, moneySompi);
        const summary = await generator.estimate();
    ...
    this.sendAllKAS = async _ref4 => {
      ...
      const total = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAddressBalanceOfKas(sourceAddress);
    ...
    this.pushTx = async rawtx => {
      ...
      const entries = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getKASUtxos([sourceAddress]);
      if (!entries.length) {
        ...
        try {
          ...
          if (Number(total) == money) {
            ...
            generator = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.createGenerator(sourceAddress, destinationAddress, changeAddress, moneySompi, priorityFee);
          } else {
            const changeAddress = sourceAddress;
    ...
    this.displayedKeyringToWalletKeyring = async function (displayedKeyring, index) {
      ...
      for (let j = 0; j < displayedKeyring.accounts.length; j++) {
        ...
        const address = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.publicKeyToAddress(pubkey, addressType, networkType);
        const accountKey = key + '#' + j;
        const defaultName = _this.getAlianName(pubkey) || _this._generateAlianName(type, j + 1);
        const alianName = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAccountAlianName(accountKey, defaultName);
        const flag = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAddressFlag(address);
        const pubkeyL2 = '';
        const addressL2 = '';
        accounts.push({
          type,
      ...
      const hdPath = type === _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.HdKeyring ? displayedKeyring.keyring.hdPath : '';
      const alianName = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getKeyringAlianName(key, initName ? `${_shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPES */ .us[type].alianName} ${index + 1}` : '');
      const keyring = {
        index,
        key,
        type,
    ...
    this.getKeyrings = async () => {
      const displayedKeyrings = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getAllDisplayedKeyrings();
      const keyrings = [];
      for (let index = 0; index < displayedKeyrings.length; index++) {
        const displayedKeyring = displayedKeyrings[index];
        if (displayedKeyring.type !== _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.Empty) {
    ...
    this.getCurrentKeyring = async () => {
      let currentKeyringIndex = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getCurrentKeyringIndex();
      const displayedKeyrings = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getAllDisplayedKeyrings();
      ...
      if (!displayedKeyrings[currentKeyringIndex] || displayedKeyrings[currentKeyringIndex].type === _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.Empty || !displayedKeyrings[currentKeyringIndex].accounts[0]) {
        for (let i = 0; i < displayedKeyrings.length; i++) {
          if (displayedKeyrings[i].type !== _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .KEYRING_TYPE */ .rK.Empty) {
            currentKeyringIndex = i;
            _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setCurrentKeyringIndex(currentKeyringIndex);
            break;
          }
        }
      }
    ...
    this.getCurrentAccount = async () => {
      ...
      if (currentAccount) {
        currentAccount.flag = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAddressFlag(currentAccount.address);
        _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.setClientAddress(currentAccount.address, currentAccount.flag);
      }
      return currentAccount;
    };
    this.getEditingKeyring = async () => {
      const editingKeyringIndex = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getEditingKeyringIndex();
      const displayedKeyrings = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .keyringService */ .zn.getAllDisplayedKeyrings();
    ...
    this.setEditingKeyring = async index => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setEditingKeyringIndex(index);
    };
    this.getEditingAccount = async () => {
      const account = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getEditingAccount();
      return account;
    };
    this.setEditingAccount = async account => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setEditingAccount(account);
    };
    this.getAppSummary = async () => {
      const appTab = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getAppTab();
      try {
        const data = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAppSummary();
        ...
        _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setAppSummary(data);
        return data;
      } catch (e) {
    ...
    this.readTab = async () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setReadTabTime(Date.now());
    };
    this.readApp = async appid => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setReadAppTime(appid, Date.now());
    };
    this.getAddressUtxo = async address => {
      const data = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getKASUtxos([address]);
      return data;
    };
    this.getConnectedSite = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getConnectedSite;
    this.getSite = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getSite;
    this.getConnectedSites = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getConnectedSites;
    this.setRecentConnectedSites = sites => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.setRecentConnectedSites(sites);
    };
    this.getRecentConnectedSites = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getRecentConnectedSites();
    };
    this.getCurrentSite = tabId => {
      const {
        ...
        name,
        icon
      } = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.getSession(tabId) || {};
      if (!origin) {
        return null;
      }
      const site = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getSite(origin);
      if (site) {
        return site;
      }
      return {
        ...
        name,
        icon,
        chain: _shared_constant__WEBPACK_IMPORTED_MODULE_1__/* .CHAINS_ENUM */ .DN.KAS,
        isConnected: false,
        isSigned: false,
        isTop: false
      };
    ...
    this.getCurrentConnectedSite = tabId => {
      ...
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getWithoutUpdate(origin);
    };
    this.setSite = data => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.setSite(data);
      if (data.isConnected) {
        const network = this.getNetworkName();
        _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('networkChanged', {
          network
    ...
    this.updateConnectSite = (origin, data) => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.updateConnectSite(origin, data);
      const network = this.getNetworkName();
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('networkChanged', {
        network
      }, data.origin);
    ...
    this.removeAllRecentConnectedSites = () => {
      const sites = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.getRecentConnectedSites().filter(item => !item.isTop);
      sites.forEach(item => {
        this.removeConnectedSite(item.origin);
      });
    };
    this.removeConnectedSite = origin => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('accountsChanged', [], origin);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .permissionService */ .ps.removeConnectedSite(origin);
    };
    this.setKeyringAlianName = (keyring, name) => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setKeyringAlianName(keyring.key, name);
      keyring.alianName = name;
      return keyring;
    };
    this.setAccountAlianName = (account, name) => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setAccountAlianName(account.key, name);
      account.alianName = name;
      return account;
    };
    this.addAddressFlag = (account, flag) => {
      account.flag = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.addAddressFlag(account.address, flag);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.setClientAddress(account.address, account.flag);
      return account;
    };
    this.removeAddressFlag = (account, flag) => {
      account.flag = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.removeAddressFlag(account.address, flag);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.setClientAddress(account.address, account.flag);
      return account;
    };
    this.getFeeSummary = async () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getFeeSummary();
    };
    this.decodePsbt = psbtHex => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.decodePsbt(psbtHex);
    };
    this.createMoonpayUrl = address => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.createMoonpayUrl(address);
    };
    this.getWalletConfig = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getWalletConfig();
    };
    this.getSkippedVersion = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getSkippedVersion();
    };
    this.setSkippedVersion = version => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setSkippedVersion(version);
    };
    this.checkWebsite = website => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.checkWebsite(website);
    };
    // it's used for ori. ---from shawn
    this.getAddressSummary = async address => {
      const data = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAddressSummary(address);
      // preferenceService.updateAddressBalance(address, data);
      return data;
    };
    this.getShowSafeNotice = () => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getShowSafeNotice();
    };
    this.setShowSafeNotice = show => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setShowSafeNotice(show);
    };
    this.getVersionDetail = version => {
      return _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getVersionDetail(version);
    };
    this.isValidKaspaAddr = addr => {
      try {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars, no-unused-vars
        const addr2 = new kaspa_wasm__WEBPACK_IMPORTED_MODULE_6__.Address(addr);
        return true;
      } catch (e) {
        console.log(e);
        return false;
    ...
    this.openDeployKrc20View = async () => {
      return await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.openDeployKrc20View();
    };
    this.openMintKrc20View = async () => {
      return await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.openMintKrc20View();
    };
    // setLayerType = async (layerType: string) => {
    //   return await preferenceService.setLayerType(layerType);
    // }
    this.getLayer = () => {
      const layer = _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.getLayer();
      return layer;
    };
    this.setLayer = type => {
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .preferenceService */ .t3.setLayer(type);
      _background_service__WEBPACK_IMPORTED_MODULE_0__/* .sessionService */ .mB.broadcastEvent('layerChanged', {
        layer: type
      });
    };
    this.getBalanceByAddress = async sourceAddress => {
      const accountBalance = await _background_service__WEBPACK_IMPORTED_MODULE_0__/* .openapiService */ .at.getAddressBalance(sourceAddress);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new WalletController());
__webpack_async_result__();
} catch(e) { __webpack_async_result__(e); } });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IQ: () => (/* binding */ spacingGap),
...
/* harmony export */ });
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2896);

const useAppDispatch = () => (0,react_redux__WEBPACK_IMPORTED_MODULE_0__/* .useDispatch */ .wA)();
...
"use strict";
/* harmony import */ var _shared_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(77093);
/* harmony import */ var _shared_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17712);
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(51902);
/* harmony import */ var _webapi_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13569);
...
const {
  PortMessage
} = _shared_utils__WEBPACK_IMPORTED_MODULE_1__/* .Message */ .QB;
let appStoreLoaded = false;
async function restoreAppState() {
  console.log('restoreAppState', restoreAppState);
  const keyringState = await _webapi_storage__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay.get('keyringState');
  _service__WEBPACK_IMPORTED_MODULE_2__/* .keyringService */ .zn.loadStore(keyringState);
  _service__WEBPACK_IMPORTED_MODULE_2__/* .keyringService */ .zn.store.subscribe(value => _webapi_storage__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay.set('keyringState', value));
  await _service__WEBPACK_IMPORTED_MODULE_2__/* .keyringService */ .zn.initKapaWasm();
  await _service__WEBPACK_IMPORTED_MODULE_2__/* .preferenceService */ .t3.init();
  await _service__WEBPACK_IMPORTED_MODULE_2__/* .openapiService */ .at.init();
  await _service__WEBPACK_IMPORTED_MODULE_2__/* .permissionService */ .ps.init();
  await _service__WEBPACK_IMPORTED_MODULE_2__/* .contactBookService */ .jX.init();
  await _service__WEBPACK_IMPORTED_MODULE_2__/* .erc20ListService */ .Ut.init();
  // await initWebFuc();
...
if (_shared_constant__WEBPACK_IMPORTED_MODULE_0__/* .MANIFEST_VERSION */ .hh === 'mv3') {
  // Keep alive for MV3
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ Popover)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(47852);
...
const Popover = _ref => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      ...
      children: [onClose && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_Row__WEBPACK_IMPORTED_MODULE_1__/* .Row */ .f, {
        style: {
          position: 'absolute',
          top: 10,
          right: 10
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_ant_design_icons__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A, {})
      }), children]
    })
  });
};
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   B9: () => (/* binding */ OPENAPI_URL_DEVNET_L2),
/* harmony export */   DN: () => (/* binding */ CHAINS_ENUM),
/* harmony export */   Fw: () => (/* binding */ COIN_DUST),
/* harmony export */   GG: () => (/* binding */ RESTORE_WALLETS),
/* harmony export */   Gj: () => (/* binding */ OPENAPI_RPC_TESTNET_L2),
/* harmony export */   LI: () => (/* binding */ BRAND_ALIAN_TYPE_TEXT),
/* harmony export */   Ld: () => (/* binding */ ADDRESS_TYPES),
/* harmony export */   Px: () => (/* binding */ INTERNAL_REQUEST_ORIGIN),
/* harmony export */   Rc: () => (/* binding */ COIN_SYMBOL),
/* harmony export */   YL: () => (/* binding */ OPENAPI_URL_TESTNET_L2),
/* harmony export */   Zm: () => (/* binding */ OPENAPI_URL_MAINNET_L2),
/* harmony export */   _7: () => (/* binding */ OPENAPI_URL_MAINNET),
/* harmony export */   _Z: () => (/* binding */ COIN_NAME),
/* harmony export */   _k: () => (/* binding */ OPENAPI_URL_DEVNET),
/* harmony export */   aO: () => (/* binding */ OPENAPI_RPC_MAINNET),
/* harmony export */   hh: () => (/* binding */ MANIFEST_VERSION),
/* harmony export */   jy: () => (/* binding */ OPENAPI_RPC_MAINNET_L2),
/* harmony export */   lu: () => (/* binding */ OPENAPI_URL_TESTNET),
/* harmony export */   nX: () => (/* binding */ OPENAPI_RPC_DEVNET_L2),
/* harmony export */   qY: () => (/* binding */ EVENTS),
/* harmony export */   rK: () => (/* binding */ KEYRING_TYPE),
/* harmony export */   rY: () => (/* binding */ CHAINS),
/* harmony export */   rg: () => (/* binding */ NETWORK_TYPES),
/* harmony export */   s$: () => (/* binding */ CHANNEL),
/* harmony export */   us: () => (/* binding */ KEYRING_TYPES),
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59577);
/* eslint-disable no-unused-vars */
/* eslint-disable @typescript-eslint/no-non-null-assertion */
/* eslint-disable no-undef */
...
const ADDRESS_TYPES = [{
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111,
  label: 'KASPA Default',
  name: 'Default',
  ...
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_972,
  label: 'KASPA Legacy',
  name: 'Legacy',
  hdPath: "m/44'/972/0'",
  // bitcoin协议可以解析出私钥的必要参数
  ...
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_ONEKEY_44_111111,
  label: 'OneKey',
  name: 'Onekey',
  hdPath: "m/44'/111111'/0'",
  // bitcoin协议可以解析出私钥的必要参数
  ...
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_TANGEM_44_111111,
  label: 'Tangem',
  name: 'Tangem',
  hdPath: "m/44'/111111'/0'",
  displayIndex: 0,
...
const RESTORE_WALLETS = [{
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.KASWARE,
  name: 'KasKeeper',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.KASPIUM,
  name: 'Kaspium Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.KASPANET_WEB,
  name: 'Kaspanet Web Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_972]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.KDX,
  name: 'KDX Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_972]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.CORE_GOLANG_CLI,
  name: 'Core Golang Cli Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.OKX,
  name: 'OKX Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.LEDGER,
  name: 'Ledger Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_44_111111]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.ONEKEY,
  name: 'OneKey Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_ONEKEY_44_111111]
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .RestoreWalletType */ .E3.TANGEM,
  name: 'Tangem Wallet',
  addressTypes: [_types__WEBPACK_IMPORTED_MODULE_0__/* .AddressType */ .RX.KASPA_TANGEM_44_111111]
}];
...
const NETWORK_TYPES = [{
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .z1.Mainnet,
  label: 'Kaspa Mainnet',
  name: 'kaspa_mainnet',
  validNames: [0, 'kaspa_mainnet'],
  url: undefined
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .z1.Testnet,
  label: 'Kaspa Testnet 10',
  name: 'kaspa_testnet',
  validNames: ['kaspa_testnet'],
  url: undefined
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .z1.Devnet,
  label: 'Kaspa Devnet',
  name: 'kaspa_devnet',
  validNames: ['kaspa_devnet'],
  url: OPENAPI_RPC_DEVNET
}, {
  value: _types__WEBPACK_IMPORTED_MODULE_0__/* .NetworkType */ .z1.Simnet,
  label: 'Kaspa Simnet',
  name: 'kaspa_simnet',
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32818);
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33139);

// A custom theme for this app
const theme = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)({
  cssVariables: true,
  palette: {
    primary: {
      main: (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_1__/* .darken */ .e$)('#02DDA4', 0.1),
      contrastText: '#000'
    },
    secondary: {
      main: '#29FAC4',
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(47767);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(84976);
/* harmony import */ var _components_Loading__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1224);
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(93567);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(72260);
/* harmony import */ var _context_AccountContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21999);
/* harmony import */ var _state_accounts_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(43182);
/* harmony import */ var _state_global_hooks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(45825);
/* harmony import */ var _state_global_reducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44241);
/* harmony import */ var _state_hooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(75049);
/* harmony import */ var _state_settings_reducer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(11167);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(13108);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(84506);
/* harmony import */ var _components_AppLoading__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(54501);
...
const AddKeyringScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 8734).then(__webpack_require__.bind(__webpack_require__, 38734)));
const ContactBookScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(7915), __webpack_require__.e(247)]).then(__webpack_require__.bind(__webpack_require__, 95267)));
const CreateAccountScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(5720), __webpack_require__.e(1117)]).then(__webpack_require__.bind(__webpack_require__, 61117)));
const CreateContactScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 6764).then(__webpack_require__.bind(__webpack_require__, 26764)));
const CreateHDWalletScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(5720), __webpack_require__.e(5443), __webpack_require__.e(221), __webpack_require__.e(170)]).then(__webpack_require__.bind(__webpack_require__, 84841)));
const CreatePasswordScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5817).then(__webpack_require__.bind(__webpack_require__, 35817)));
const CreateSimpleWalletScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5643).then(__webpack_require__.bind(__webpack_require__, 15643)));
const SwitchAccountScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 2149).then(__webpack_require__.bind(__webpack_require__, 2149)));
const SwitchKeyringScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(111), __webpack_require__.e(1329), __webpack_require__.e(5699)]).then(__webpack_require__.bind(__webpack_require__, 35699)));
const UnlockScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 7043).then(__webpack_require__.bind(__webpack_require__, 77043)));
const ApprovalScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(8581), __webpack_require__.e(7459), __webpack_require__.e(497), __webpack_require__.e(1288), __webpack_require__.e(7579), __webpack_require__.e(8458)]).then(__webpack_require__.bind(__webpack_require__, 9965)));
const ConnectedSitesScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 2107).then(__webpack_require__.bind(__webpack_require__, 62107)));
const ActivitiesScrren = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(6592), __webpack_require__.e(5678), __webpack_require__.e(3613)]).then(__webpack_require__.bind(__webpack_require__, 73238)));

const AppTabScrren = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 6080).then(__webpack_require__.bind(__webpack_require__, 96080)));
const BoostScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 1729).then(__webpack_require__.bind(__webpack_require__, 71729)));
// import BoostScreen from './Main/BoostScreen';
const DiscoverTabScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 1734).then(__webpack_require__.bind(__webpack_require__, 81734)));
const SettingsTabScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5352).then(__webpack_require__.bind(__webpack_require__, 35352)));
const WalletTabScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(9001), __webpack_require__.e(7459), __webpack_require__.e(1874), __webpack_require__.e(8567)]).then(__webpack_require__.bind(__webpack_require__, 4784)));
const WelcomeScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5580).then(__webpack_require__.bind(__webpack_require__, 65580)));
const AddressTypeScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5080).then(__webpack_require__.bind(__webpack_require__, 5080)));
const ChangePasswordScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 2685).then(__webpack_require__.bind(__webpack_require__, 12685)));
const EditAccountNameScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(5720), __webpack_require__.e(1608)]).then(__webpack_require__.bind(__webpack_require__, 71608)));
const EditContactNameScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(111), __webpack_require__.e(1329), __webpack_require__.e(8105)]).then(__webpack_require__.bind(__webpack_require__, 48105)));
const EditNetworkUrlScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 1803).then(__webpack_require__.bind(__webpack_require__, 11803)));
const EditWalletNameScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(8581), __webpack_require__.e(5720), __webpack_require__.e(2952)]).then(__webpack_require__.bind(__webpack_require__, 72952)));
const ExportMnemonicsScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(5443), __webpack_require__.e(4673)]).then(__webpack_require__.bind(__webpack_require__, 24673)));
const ExportPrivateKeyScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(5443), __webpack_require__.e(8466)]).then(__webpack_require__.bind(__webpack_require__, 98466)));
const LanguageTypeScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 4588).then(__webpack_require__.bind(__webpack_require__, 84588)));
const NetworkTypeScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5918).then(__webpack_require__.bind(__webpack_require__, 95918)));
const UpgradeNoticeScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 2828).then(__webpack_require__.bind(__webpack_require__, 32828)));
const TestScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 7487).then(__webpack_require__.bind(__webpack_require__, 57487)));
const ToolScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 3586).then(__webpack_require__.bind(__webpack_require__, 83586)));
const ActivityTab = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(6592), __webpack_require__.e(4283)]).then(__webpack_require__.bind(__webpack_require__, 34283)));
const SelectToken = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(9001), __webpack_require__.e(2384)]).then(__webpack_require__.bind(__webpack_require__, 52384)));
const DeployScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(5485), __webpack_require__.e(4433), __webpack_require__.e(1288), __webpack_require__.e(7761)]).then(__webpack_require__.bind(__webpack_require__, 97761)));
const MintScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(1489), __webpack_require__.e(1288), __webpack_require__.e(6868)]).then(__webpack_require__.bind(__webpack_require__, 36868)));
const ChownScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(5485), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(7581)]).then(__webpack_require__.bind(__webpack_require__, 27337)));
const BlacklistIssueScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(5485), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(1362)]).then(__webpack_require__.bind(__webpack_require__, 97910)));
const IssueScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(5485), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(5167)]).then(__webpack_require__.bind(__webpack_require__, 51911)));
const BurnScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(5485), __webpack_require__.e(1288), __webpack_require__.e(2557)]).then(__webpack_require__.bind(__webpack_require__, 15943)));
const TokenScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(5678), __webpack_require__.e(6754)]).then(__webpack_require__.bind(__webpack_require__, 45925)));
const UTXOTab = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(6592), __webpack_require__.e(4996)]).then(__webpack_require__.bind(__webpack_require__, 24996)));
const FiatPayScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 1770).then(__webpack_require__.bind(__webpack_require__, 51770)));
const ReceiveScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(6520), __webpack_require__.e(5453)]).then(__webpack_require__.bind(__webpack_require__, 65430)));
const TxConfirmScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(111), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(8581), __webpack_require__.e(7459), __webpack_require__.e(497), __webpack_require__.e(1288), __webpack_require__.e(7579), __webpack_require__.e(7627)]).then(__webpack_require__.bind(__webpack_require__, 84536)));
const TxCreateScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(4340), __webpack_require__.e(6531), __webpack_require__.e(1207), __webpack_require__.e(6445), __webpack_require__.e(9001), __webpack_require__.e(6887), __webpack_require__.e(1288), __webpack_require__.e(6299), __webpack_require__.e(789)]).then(__webpack_require__.bind(__webpack_require__, 36946)));
const TxDetailScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 885).then(__webpack_require__.bind(__webpack_require__, 40885)));
const TxFailScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 990).then(__webpack_require__.bind(__webpack_require__, 30990)));
const TxSuccessScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 8433).then(__webpack_require__.bind(__webpack_require__, 28433)));
const UtxoDetailScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 5585).then(__webpack_require__.bind(__webpack_require__, 75585)));


const WebsiteTabScreen = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 9370).then(__webpack_require__.bind(__webpack_require__, 29370)));
const ImportERC20 = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/* import() */ 9407).then(__webpack_require__.bind(__webpack_require__, 69407)));
const routes = {
  BoostScreen: {
    path: '/',
    element:
    ...
    (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
      fallback: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_AppLoading__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A, {}),
  ...
  WelcomeScreen: {
    ...
    element: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
      fallback: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_Loading__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A, {}),
...
function useNavigate() {
  const navigate = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_13__/* .useNavigate */ .Zp)();
  ...
  }, [react_router_dom__WEBPACK_IMPORTED_MODULE_13__/* .useNavigate */ .Zp]);
}
const Main = () => {
  const wallet = (0,_utils__WEBPACK_IMPORTED_MODULE_9__/* .useWallet */ .vT)();
  const dispatch = (0,_state_hooks__WEBPACK_IMPORTED_MODULE_7__/* .useAppDispatch */ .j)();
  const isReady = true; // useIsReady();
  const isUnlocked = (0,_state_global_hooks__WEBPACK_IMPORTED_MODULE_5__/* .useIsUnlocked */ .FI)();
  ...
  const init = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async () => {
    try {
      if (!self.accountLoaded) {
        const currentAccount = await wallet.getCurrentAccount();
        if (currentAccount) {
          dispatch(_state_accounts_reducer__WEBPACK_IMPORTED_MODULE_4__/* .accountActions */ .$G.setCurrent(currentAccount));
          const accounts = await wallet.getAccounts();
          dispatch(_state_accounts_reducer__WEBPACK_IMPORTED_MODULE_4__/* .accountActions */ .$G.setAccounts(accounts));
      ...
      if (!self.settingsLoaded) {
        ...
        dispatch(_state_settings_reducer__WEBPACK_IMPORTED_MODULE_8__/* .settingsActions */ .dr.updateSettings({
          networkType,
          rpcLinks
        }));
      ...
      if (!self.summaryLoaded) {
        wallet.getAppSummary().then(data => {
          dispatch(_state_accounts_reducer__WEBPACK_IMPORTED_MODULE_4__/* .accountActions */ .$G.setAppSummary(data));
        });
      ...
      dispatch(_state_global_reducer__WEBPACK_IMPORTED_MODULE_6__/* .globalActions */ .fh.update({
        isReady: true
      }));
    } catch (e) {
  ...
  if (!isReady) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components__WEBPACK_IMPORTED_MODULE_2__/* .Layout */ .PE, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components__WEBPACK_IMPORTED_MODULE_2__/* .Content */ .UC, {
        justifyCenter: true,
        itemsCenter: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components__WEBPACK_IMPORTED_MODULE_2__/* .Icon */ .In, {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_context_AccountContext__WEBPACK_IMPORTED_MODULE_3__/* .AccountContextProvider */ .uz, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_15__/* .HashRouter */ .I9, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_13__/* .Routes */ .BV, {
        children: Object.keys(routes).map(v => routes[v]).map(v => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_13__/* .Route */ .qh, {
          path: v.path,
          element: v.element
        }, v.path))
      })
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ay: () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   kk: () => (/* binding */ keyringsActions)
/* harmony export */ });
/* unused harmony export initialState */
/* harmony import */ var _shared_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59577);
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30038);
/* harmony import */ var _global_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4294);
/* eslint-disable no-unused-vars */
/* eslint-disable @typescript-eslint/no-unused-vars */
...
const slice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__/* .createSlice */ .Z0)({
  ...
  extraReducers: builder => {
    builder.addCase(_global_actions__WEBPACK_IMPORTED_MODULE_1__/* .updateVersion */ .G, state => {
      // todo
    });
  }
});
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ AccountUpdater)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28652);
/* harmony import */ var _ui_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13108);
/* harmony import */ var _global_hooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(45825);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75049);
/* harmony import */ var _transactions_hooks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16039);
/* harmony import */ var _transactions_reducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(51195);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(43658);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(43182);
...
function AccountUpdater() {
  const dispatch = (0,_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useAppDispatch */ .j)();
  const wallet = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .useWallet */ .vT)();
  const currentAccount = (0,_hooks__WEBPACK_IMPORTED_MODULE_7__/* .useCurrentAccount */ .YL)();
  const isUnlocked = (0,_global_hooks__WEBPACK_IMPORTED_MODULE_3__/* .useIsUnlocked */ .FI)();
  const balance = (0,_hooks__WEBPACK_IMPORTED_MODULE_7__/* .useAccountBalance */ .pc)();
  const selfRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)({
    preAccountKey: '',
  ...
  const self = selfRef.current;
  const reloadAccounts = (0,_hooks__WEBPACK_IMPORTED_MODULE_7__/* .useReloadAccounts */ .Fg)();
  ...
  const fetchBalance = (0,_hooks__WEBPACK_IMPORTED_MODULE_7__/* .useFetchBalanceCallback */ .P0)();
  const fetchTxActivities = (0,_transactions_hooks__WEBPACK_IMPORTED_MODULE_5__/* .useFetchTxActivitiesCallback */ .cU)();
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const accountChangeHandler = account => {
      if (account && account.address) {
        dispatch(_reducer__WEBPACK_IMPORTED_MODULE_8__/* .accountActions */ .$G.setCurrent(account));
      }
    };
    _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.addEventListener('accountsChanged', accountChangeHandler);
    _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.addEventListener('utxosChangedNotification', () => {
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_8__/* .accountActions */ .$G.expireBalance());
      dispatch(_transactions_reducer__WEBPACK_IMPORTED_MODULE_6__/* .transactionsActions */ .$A.setIncomingTx(true));
      setTimeout(() => {
        fetchTxActivities();
        console.log('utxosChangedNotification true');
      }, 15000);
    });
    _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.addEventListener('processor-balance-event', event => {
      var _event$balance, _event$balance2, _event$balance3;
      const amount = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sompiToKas */ .Db)((_event$balance = event.balance) === null || _event$balance === void 0 ? void 0 : _event$balance.mature);
      const pending = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sompiToKas */ .Db)((_event$balance2 = event.balance) === null || _event$balance2 === void 0 ? void 0 : _event$balance2.pending);
      const outgoing = (0,_ui_utils__WEBPACK_IMPORTED_MODULE_2__/* .sompiToKas */ .Db)((_event$balance3 = event.balance) === null || _event$balance3 === void 0 ? void 0 : _event$balance3.outgoing);
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_8__/* .accountActions */ .$G.setBalance({
        address: currentAccount.address,
        amount: amount,
        kas_amount: amount,
        confirm_kas_amount: '0',
      ...
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_8__/* .accountActions */ .$G.expireHistory());
    });
    _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.addEventListener('eventbus-sink-blue-score-changed', event => {
      dispatch(_reducer__WEBPACK_IMPORTED_MODULE_8__/* .accountActions */ .$G.setBlueScore(event));
    });
    return () => {
      _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.removeEventListener('accountsChanged', accountChangeHandler);
      _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.removeEventListener('utxosChangedNotification', () => {
        // console.log('removed utxo changed');
      });
      _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.removeEventListener('processor-balance-event', () => {});
      _shared_eventBus__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.removeEventListener('eventbus-sink-blue-score-changed', () => {});
...
/******/ __webpack_require__.O(0, [5234], () => (__webpack_exec__(60369)));
