...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(36379);
...
const StyledButton = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Ay)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Button */ .$n)(_ref => {
  let {
    theme
  } = _ref;
  return {
...
function Deploy() {
  ...
  const [isIssue, setIsIssue] = (0,react__WEBPACK_IMPORTED_MODULE_15__.useState)(false);
  const {
    values,
    handleChange,
    handleBlur,
  ...
  const checkTickerValid = (0,react__WEBPACK_IMPORTED_MODULE_15__.useCallback)(async () => {
    ...
    setLoading(true);
    let result;
    if (currentNetworkType == kaspa_wasm__WEBPACK_IMPORTED_MODULE_20__.NetworkType.Mainnet) {
  ...
  const handleDeploy = async () => {
    ...
    const networkName = currentNetworkType === kaspa_wasm__WEBPACK_IMPORTED_MODULE_20__.NetworkType.Mainnet ? 'mainnet' : currentNetworkType === kaspa_wasm__WEBPACK_IMPORTED_MODULE_20__.NetworkType.Testnet ? 'testnet-10' : 'devnet';
    let result;
    console.log('isIssue', isIssue);
    if (isIssue) {
      result = await (0,_background_krc20_krc20action__WEBPACK_IMPORTED_MODULE_0__/* .krc20_deploy_issue */ .RX)(privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex, networkName, values.ticker, 2, refactorSupply, refactorPerMint, values.decimals, Number(refactorPremine));
    } else {
      result = await (0,_background_krc20_krc20action__WEBPACK_IMPORTED_MODULE_0__/* .krc20_deploy */ .xX)(privateKey === null || privateKey === void 0 ? void 0 : privateKey.hex, networkName, values.ticker, 2, refactorSupply, refactorPerMint, values.decimals, Number(refactorPremine));
    }
    if ((_result = result) !== null && _result !== void 0 && _result.status) {
      ...
      const rawtxinfo = {
        "to": address,
        "amountSompi": refactorSupply || parseInt((0,_ui_utils__WEBPACK_IMPORTED_MODULE_11__/* .parseUnits */ .XS)(refactorSupply, values.decimals)),
        "tick": values.ticker,
        "mode": isIssue ? "issue" : ''
      };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ .PE, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_ui_components__WEBPACK_IMPORTED_MODULE_1__/* .Header */ .Y9, {
      ...
      classname: "!px-4",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, {
        className: "space-y-4",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
          variant: "body2",
          color: "textSecondary",
          children: "It takes 1 KAS as commission and 1000 KAS as gasfee to deploy."
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_mui_material_Box__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, {
          className: "space-y-1",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            children: isIssue ? 'Name' : 'Ticker'
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_OutlinedInput__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, {
            type: "text",
            name: "ticker",
            ...
            onBlur: handleBlur,
            endAdornment: tickerValid ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_icons_material_CheckCircleOutline__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .A, {
              color: "primary"
            }) : loading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
              color: "primary",
              size: 20
            }) : 'Deployed',
            error: Boolean(values.ticker && !tickerValid || errors.ticker)
          }), errors.ticker ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            color: "error.main",
            className: "pl-4",
          ...
          }), errors.maxSupply ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            color: "error.main",
            className: "pl-4",
          ...
          }), errors.decimals ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            color: "error.main",
            className: "pl-4",
          ...
          }), errors.perMint ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            color: "error.main",
            className: "pl-4",
          ...
          }), errors.preMintAmount ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            color: "error.main",
            className: "pl-4",
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
            color: "text.secondary",
            children: "Issue Mode: "
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_26__/* ["default"] */ .A, {
            value: isIssue,
        ...
        endIcon: sending ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
          size: 20,
          color: "inherit"
        }) : null,
        children: btnText
