...
/* harmony import */ var _ui_state_hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3204);
/* harmony import */ var _ui_state_keyrings_hooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(60440);
...
function Mint() {
  ...
  const network = (0,_ui_state_settings_hooks__WEBPACK_IMPORTED_MODULE_8__/* .useNetworkType */ .qS)();
  const account = (0,_ui_state_keyrings_hooks__WEBPACK_IMPORTED_MODULE_7__/* .useCurrentKeyring */ .Ib)();
  const {
    privateKey
  } = (0,_ui_state_accounts_hooks__WEBPACK_IMPORTED_MODULE_5__/* .useUserPrivateKey */ .yK)();
  const dispatch = (0,_ui_state_hooks__WEBPACK_IMPORTED_MODULE_6__/* .useAppDispatch */ .A)();
        ...
        while (retryCount < maxRetries) {
          ...
          if (result.status) {
            ...
            dispatch(_ui_state_transactions_reducer__WEBPACK_IMPORTED_MODULE_9__/* .transactionsActions */ .C4.updateNativeTxs({
              ...
              info: {
                ...fetchedTicker,
                type: _ui_types__WEBPACK_IMPORTED_MODULE_10__/* .TXTypes */ .S.Mint,
